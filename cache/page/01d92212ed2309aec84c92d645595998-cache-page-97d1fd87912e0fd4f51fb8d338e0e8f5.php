<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71096:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/elasticsearch/how-to-install-elasticsearch" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-07T14:07:53-08:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How to install Elasticsearch - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/elasticsearch/how-to-install-elasticsearch" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-01', 3]);
	...
	<!-- cid:55ee0507beb5f4970675e291045ae21a -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/elasticsearch' itemprop='url'><span itemprop='title'>Elasticsearch<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/elasticsearch/creating-documents-in-elasticsearch'>Creating documents in Elasticsearch</a> (1985 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/elasticsearch/how-to-install-elasticsearch'>How to install Elasticsearch</a> (1842 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/elasticsearch/working-with-indexes-in-elasticsearch'>Working with indexes in Elasticsearch</a> (602 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to install Elasticsearch</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to install Elasticsearch									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,842</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 5, 2015'><span style='color:#606060;'>Published:</span> Jan 7, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Elasticsearch is an incredibly powerful search engine in which data can be stored and recalled in real-time.  Because of the speed and reliability of Elasticsearch, it is highly recommended if you are searching through large amounts of data on a regular basis.  Thanks to projects like ElasticPress, it can also be used easily within WordPress as a replacement for the default search.  In this article, we will show you how to install Elasticsearch on InMotion Hosting or any other CentOS/Red Hat based system.</p>
<div class="alert alert-warning">
  <p><strong>Note:</strong> You will need to have a VPS or dedicated server with <a href="http://www.inmotionhosting.com/support/website/cpanel-account-management/obtain-root-access">root access</a> to be able to install Elasticsearch.</p>
</div>
<h2>Installing Elasticsearch from the repository</h2>
<p>The easiest way to install Elasticsearch is from their repositories.  Doing so is not only simple to install, but will also allow you to easily keep Elasticsearch updated.</p>
<ol class="article_list">
  <li><p>First, <a href="http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh">SSH into your server</a> as root.</p></li>
  <li><p>Now, as Elasticsearch depends on Java to run, we will need to begin installing Java on the server.  To do so, first begin by updating the repositories:</p>
  <p class="code_block">yum update</p>
  <p>Now, install Java:</p>
  <p class="code_block">yum install java</p>
  <p>If all goes well, Java should now be installed on the server and you are ready to begin installing Elasticsearch.</p></li>
  <li><p>Next, we will add the Elasticsearch repository to the server.  Begin by adding the public signing key:</p>
  <p class="code_block">rpm --import https://packages.elasticsearch.org/GPG-KEY-elasticsearch</p></li>
  <li><p>Now, we need to add the actual repository.  Use the following to open a text editor and create a new file holding the Elasticsearch repository:</p>
  <p class="code_block">nano /etc/yum.repos.d/elasticsearch.repo</p>
  <p>Within the text editor, paste in the following:</p>
  <p class="code_block">[elasticsearch-1.4]<br>
name=Elasticsearch repository for 1.4.x packages<br>
baseurl=http://packages.elastic.co/elasticsearch/1.4/centos<br>
gpgcheck=1<br>
gpgkey=http://packages.elastic.co/GPG-KEY-elasticsearch<br>
enabled=1</p>
  <p>Once entered, press <strong>Ctrl+X</strong> and then the <strong>Y</strong> key to save changes.</p></li>
  <li><p>Not that the repository is all set up, Elasticsearch is ready to install.  To do so, enter the following:</p>
  <p class="code_block">yum install elasticsearch</p>
  <p>Elasticsearch will now be installed.  Once complete, if you want it to automatically start when the system is booted, follow the next section on setting ElasticSearch as a system service.</p></li>
</ol>
<h2>Setting ElasticSearch as a system service</h2>
<p>If you want Elasticsearch to automatically when the system is started, enter the following command to se it as a system service:</p>
<p class="code_block">chkconfig --add elasticsearch</p>.
<h2>Elasticsearch with WordPress</h2>
<p>In addition to Elasticsearch's many use cases, individuals can easily integrate Elasticsearch with WordPress.  For more information on doing so, take a look at our article on Elasticsearch in WordPress using ElasticPress.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/elasticsearch/how-to-install-elasticsearch&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/elasticsearch/how-to-install-elasticsearch'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjQmaWQ9MzQ4MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d9ef5ab485cd4ba2555a7ea3f92d5e0c" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/tools/elasticsearch-stops-running-by-itself?tsrc=rsbraq'>Elasticsearch stops running by itself</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fe2302e1310fef0b3f39fde45a917425?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fe2302e1310fef0b3f39fde45a917425'>Yashin</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-09 11:51 pm</div>
				                <div><p>Hello,</p>
...
<p>Can you please indicate what should be done next to get it running on the website?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21498);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 2:57 am</div>
				                <div><p>Hello,</p>
...
<p>Thanks anyway!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21511);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29617'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a95ff4bc98477b6e2e4ff95cc063a684?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a95ff4bc98477b6e2e4ff95cc063a684'>Dave</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-06 11:40 pm</div>
				                <div><p>This page needs updated, the URL for the repository is now packages.elastic.co. Also, newer versions exist beyond 1.4.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29617);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-07 9:58 am</div>
				                <div>Thank you for letting us know. We'll certainly review the article and update where necessary.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29629);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31905'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b776dcf7659b9b485c016177cef3711e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b776dcf7659b9b485c016177cef3711e'>Amit Kumar Ghosh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-14 5:49 am</div>
				                <div><p>Fix the tutorial Please !@!@&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31905);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-14 12:10 pm</div>
				                <div>Hello Amit,<br />
<br />
Thank you for contacting. We recently tested this article successfully, and everything seems to be working.<br />
<br />
What issues are you having with the guide?<br />
<br />
Are getting any errors? What are they?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31924);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
