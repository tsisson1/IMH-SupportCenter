<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51802:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/im-having-an-issue-accessing-cpanel-whm-the-message-i-see-is-in-order-to-access-the-interface-you-will-need-to-make-sure-that-the-software-license-on-this-server-is-active-and-installed-according-to-previous-questions-shown-on-your-site-it-looks-like-an-i" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Greg, and thanks for your question. Unfortunately it looks like the entire contents of your message was entered into the subject of your question ..." />
  <title>I'm having an issue accessing cPanel &amp; WHM.  The message I see is &quot;In order to access the interface, you will need to make sure that the software license on this server is active and installed.&quot;  According to previous questions shown on your site, it looks | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/im-having-an-issue-accessing-cpanel-whm-the-message-i-see-is-in-order-to-access-the-interface-you-will-need-to-make-sure-that-the-software-license-on-this-server-is-active-and-installed-according-to-previous-questions-shown-on-your-site-it-looks-like-an-i" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:31045dcc41a02fd5044c791977feda07 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.236.69.113']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I'm having an issue accessing cPanel &amp; WHM.  The message I see is &quot;In order to access the interface, you will need to make sure that the software license on this server is active and installed.&quot;  According to previous questions shown on your site, it looks</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/greg.factor.5/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/greg&per;factor'>greg.factor</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-17 10:31 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,666</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3565' id='upvote_answer_3565' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3565' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3565').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3565' id='downvote_answer_3565' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3565' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3565').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-07-18 10:53 am EST
                		        </div>
					
		                </div>

				Hello Greg, and thanks for your question.<br />
<br />
Unfortunately it looks like the entire contents of your message was entered into the subject of your question and so was cut off.<br />
<br />
It sounds like your cPanel licence needs to be either renewed or activated, you can simply submit a request for this to be done to &lt;a href=&quot;mailto:support@inmotionhosting.com&quot;&gt;support@inmotionhosting.com&lt;/a&gt; by including your server name, since it looks like the email address you've submitted this post under doesn't seem to be in our system so I can't find it.<br />
<br />
...
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3565').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3565' id='form_comment_on_answer_3565' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/im-having-an-issue-accessing-cpanel-whm-the-message-i-see-is-in-order-to-access-the-interface-you-will-need-to-make-sure-that-the-software-license-on-this-server-is-active-and-installed-according-to-previous-questions-shown-on-your-site-it-looks-like-an-i&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/im-having-an-issue-accessing-cpanel-whm-the-message-i-see-is-in-order-to-access-the-interface-you-will-need-to-make-sure-that-the-software-license-on-this-server-is-active-and-installed-according-to-previous-questions-shown-on-your-site-it-looks-like-an-i'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="6cecfeda48307d7485da58d5091e7e66" value="1" />	</div>
	</form>
<!-- <br />
