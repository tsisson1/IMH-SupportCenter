<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63297:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm/302-upgrade-php-using-easyapache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-07T16:11:59-08:00" />
  <meta name="keywords" content="php upgrade whm easyapache pci compliance compliant scan scans dss credit card cards" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss how you can upgrade your server's version of PHP using the EasyApache script in WHM." />
  <title>302: Upgrade PHP using EasyApache - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm/302-upgrade-php-using-easyapache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:85c0765a63aca400e52f77b3a5994318 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.80.248.14']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															302: Upgrade PHP using EasyApache									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,802</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 7, 2012'><span style='color:#606060;'>Published:</span> Nov 7, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss how you can upgrade your server's version of PHP using the EasyApache script in WHM (Web Host Manager). If you happen to have read our previous article on <a href="/support/edu/whm/301-upgrade-apache-using-easyapache">how to upgrade Apache using EasyApache</a>&nbsp;you'll notice we skipped over the PHP menu, in this article we'll go more in-depth into the available PHP settings you can set within EasyApache.</p>
<p>If you came here from our article on <a href="/support/website/website-troubleshooting/how-to-pass-pci-scans">how to pass PCI compliance scans</a>, outdated versions of PHP are a common thing that can cause your website to fail a PCI scan. So understanding how to update PHP on your own using EasyApache in WHM is great knowledge to have in order to help keep your website PCI compliant.</p>
<p>This process would require having <a href="/support/website/general-server-setup/root-access-faq">root access</a> on your VPS or dedicated server, most users would never need to change this on their own, but the option is available for advanced users.</p>
<ol class="article_list">
<li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into WHM</a>.</li>
<li>In the <strong>Find</strong> box at the top-left, type in&nbsp;<strong>Easy</strong>, then click on <strong>EasyApache</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-easyapache.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-easyapache.png" alt="whm-click-on-easyapache"  /></a></li>
<li>Leave the&nbsp;<strong>Previously Saved Config (** DEFAULT **)</strong> option selected, and click on&nbsp;<strong>Start customizing based on profile</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-start-customizing.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-start-customizing.png" alt="whm-click-on-start-customizing"  /></a></li>
<li>In most cases you'll be keeping the same version of Apache, so simply click&nbsp;<strong>Next Step</strong> on the Apache Version page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-apache-next-step.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-apache-next-step.png" alt="whm-click-on-apache-next-step"  /></a><br /><br /></li>
<li>In this example we have PHP&nbsp;<strong>5.2.17</strong>&nbsp;installed already, so you'll want to click on PHP <strong>5.3.18</strong>, and then click on <strong>Next Step</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-php-5-3-18.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-php-5-3-18.png" alt="whm-click-on-php-5-3-18"  style="width: 45%; float: left;" /></a><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-php-next-step.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-php-next-step.png" alt="whm-click-on-php-next-step"  style="width: 45%; float: right;" /></a></li>
<li style="clear: both;">On the&nbsp;<strong>Short Options List</strong> page you can set what options PHP will be compiled with. In this guide we are just talking about upgrading PHP, so you can simply scroll to the bottom of the page and click on&nbsp;<strong>Save and Build</strong>.</li>
<li style="clear: both;">A&nbsp;<strong>Confirm Action</strong> window will pop-up asking if you'd like to&nbsp;<strong>Recompile Apache and PHP now?</strong> go ahead and click&nbsp;<strong>Yes</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-recompile-apache-php-yes.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-recompile-apache-php-yes.png" alt="whm-click-recompile-apache-php-yes"  /></a></li>
<li>Next a&nbsp;<strong>Please ackowledge</strong> window will pop-up letting you know if the Apache build process is interrupted&nbsp;(you close your web-browser for instance), this could result in data loss. An Apache rebuild in some cases can take upwards of 45 minutes, so it's important to make sure that you'll have access to WHM for the entire duration. Once you understand these implications then click on&nbsp;<strong>I Understand</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-i-understand.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-i-understand.png" alt="whm-click-i-understand"  /></a></li>
<li>You should briefly see a build page that lists any errors if they were encountered, then after about 5 seconds it should automatically start the rebuild process and show you the status screen of this happening. The Apache rebuild can take upwards of 45 minutes so please be patient&nbsp;and be sure not to close your web-browser during the process.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-easyapache-build-progress.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-easyapache-build-progress.png" alt="whm-easyapache-build-progress"  /></a></li>
<li>After Apache and PHP are compiled a <b>Configure Suexec and PHP</b> window will pop-up, in this case we are simply going to leave the current configuration with our&nbsp;<strong>Default PHP Version (.php files)</strong> being set to&nbsp;<strong>5</strong><strong>,</strong> the&nbsp;<strong>PHP 5 Handler</strong> being set to&nbsp;<strong>suphp</strong>, and&nbsp;<strong>Apache suEXEC</strong> being set to on. So you can simply click on&nbsp;<strong>Close</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-configure-suexec-close.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-configure-suexec-close.png" alt="whm-click-on-configure-suexec-close"  /></a></li>
<li><span data-mce-bogus="1"><span data-mce-bogus="true">PHP should now be upgraded on your server, the easiest way to confirm this update is by <a href="/support/website/general-server-setup/create-phpinfo-page-to-see-php-settings">creating a&nbsp;<strong>phpinfo();</strong> info page to see PHP settings</a>.</span></span></li>
<li><span data-mce-bogus="1"><span data-mce-bogus="true">When you view your&nbsp;<strong>phpinfo();</strong> page you should now notice the PHP version is stating&nbsp;<strong>5.3.18</strong> which is what we selected to upgrade to, and your build date should reflect today's date.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/phpinfo-page-after-upgrade.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/phpinfo-page-after-upgrade.png" alt="phpinfo-page-after-upgrade"  /></a><br /></span></span></li>
</ol>
<p><span data-mce-bogus="1"><span data-mce-bogus="true">You should now understand how to upgrade your PHP version on your server utilizing EasyApache within WHM.</span></span></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: 302: Upgrade PHP using EasyApache</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/whm/301-upgrade-apache-using-easyapache'>301: Upgrade Apache using EasyApache</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/whm/303-install-and-configure-clamav'>303: Install and configure ClamAV plugin for cPanel</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/whm/302-upgrade-php-using-easyapache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/whm/302-upgrade-php-using-easyapache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NiZpZD0yNDE1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="630b61f388d843bb090199308c7e8a04" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/i-cant-update-my-php-on-a-dedicated-server?tsrc=rsbraq'>I can't update my php on a dedicated server</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/easy-apache-how-to-install?tsrc=rsbraq'>Easy Apache - How to install?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/whm/how-to-recompile-phpmysql-in-a-website?tsrc=rsbraq'>How to recompile php/mysql in a website?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fe07d2fd6e7701049b18b9eca14285f5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fe07d2fd6e7701049b18b9eca14285f5'>Jeannie Colson</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-17 3:48 pm</div>
				                <div><p>This easyapache is not in whm today. this article must be out of date.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25852);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-17 4:13 pm</div>
				                <div>Hello Jeannie,<br />
<br />
I just checked my own server that is running the latest versions and it is indeed in the WHM. As the article states, though, you must be logged in as root in order to have access to that feature. Give that a try and you should be fine.<br />
<br />
Note that if you want to customize the 'Default' build, there is no customize button any longer (it needs to be updated). To do so, click on the small gear icon to the right. That will take you to the customizer. The rest of the article should be more accurate.<br />
<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25853);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
