<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56268:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/you-have-reached-the-maximum-of-allowed-mysql-databases" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello BurcuKanat, The maximum number of MySQL databases is stated when you purchased the hosting plan. The only way to change that is to upgrade your ho..." />
  <title>You have reached the maximum of allowed MySQL databases | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/you-have-reached-the-maximum-of-allowed-mysql-databases" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6333b9afa5937ec2e346503c964efcac -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.85.139.246']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>You have reached the maximum of allowed MySQL databases</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/BurcuKanat'>BurcuKanat</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-05-14 3:18 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,284</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I cannot install WordPress from Fantastico, it gives the below error, but I just bought this domain so it can't be reached the limit. What is the solution? Could you please fix it?<br />
<br />
&quot;You have reached the maximum of allowed MySQL databases. Fantastico can not proceed with installations until you upgrade your account or reduce the number of used databases (for example by uninstalling a script).&quot;<br />
<br />
Thank you<br />
<br />
</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>cPanel problem: You are currently using the maximum number of MySQL databases<br />
</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/siddqui'>siddqui</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-08-19 09:19 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>cPanel problem: You are currently using the maximum number of MySQL databases please what is this and how to resolv it<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1020' id='upvote_answer_1020' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1020' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1020').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1020' id='downvote_answer_1020' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1020' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1020').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi BurcuKanat,<br />
<br />
WordPress (and most other applications) require a MySQL database.<br />
<br />
After reviewing your account, it appears you have the Starter Plan, which does not include any databases. In order to install WordPress, you will need to upgrade your account to the &lt;a href='http://www.inmotionhosting.com/cheap_hosting.html' target='_blank'&gt;Basic Plan&lt;/a&gt;, which is the lowest plan that offers a MySQL database. If you'd like more information on how to upgrade your account, please see:<br />
<br />
&lt;a href='http://www.inmotionhosting.com/support/website/general-server-setup/upgrade-downgrade-hosting-plan' target='_blank'&gt;How to Upgrade or Downgrade your Hosting Plan&lt;/a&gt;<br />
<br />
I hope this helps! If you have any follow up questions, feel free to post a comment at the bottom of this page.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1020').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1020' id='form_comment_on_answer_1020' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7938' id='upvote_answer_7938' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7938' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7938').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7938' id='downvote_answer_7938' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7938' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7938').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello BurcuKanat,<br />
<br />
The maximum number of MySQL databases is stated when you purchased the hosting plan.  The only way to change that is to <a href="http://www.inmotionhosting.com/support/website/amp/upgrade-downgrade-hosting-plan">upgrade your hosting plan</a>.   If you are on a specific hosting plan and you are within your limit, but you're getting this error, please <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">reach out to our live technical support team</a> to have it corrected.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7938').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7938' id='form_comment_on_answer_7938' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/you-have-reached-the-maximum-of-allowed-mysql-databases&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/you-have-reached-the-maximum-of-allowed-mysql-databases'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ca05b8ff3b6a253478d74ef6c4ca0b33" value="1" />	</div>
	</form>
<!-- <br />
