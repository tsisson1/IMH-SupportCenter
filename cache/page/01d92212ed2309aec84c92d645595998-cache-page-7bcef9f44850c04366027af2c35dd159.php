<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66603:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/changing-default-theme" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-26T16:35:46-08:00" />
  <meta name="keywords" content="Moodle 2.3  default theme Formal white set themes change changing template standard selector legacy mobile tablet current setting Afterburner Arialist Brick Fusion Magazine MyMobile Nimble Nonzero Overlay Sky High Splash" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="When installing and working with Moodle 2.3 for the first time, the default theme Formal white is set as the theme. This tutorial will explain how to change the default theme." />
  <title>Changing the default Standard theme in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/changing-default-theme" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f8db948947b1a1979c95b8f68db03eca -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '152.15.112.79']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the default Standard theme in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,480</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>When installing and working with Moodle for the first time, the default theme <strong>Standard</strong> is set as the theme or template for the site. To customize the look of the Moodle site, Moodle 2.3 included 12 different themes that can be used for free. The initial installation of Moodle 2.3 comes with the following themes:</p>
<table style="margin: 0px 20px 0px 20px;" border="0">
<tbody>
<tr>
<td>
<ul>
<li><strong>Afterburner</strong></li>
<li><strong>Arialist</strong></li>
<li><strong>Brick</strong></li>
</ul>
</td>
<td>
<ul>
<li><strong>Formal white</strong></li>
...
<td>
<ul>
<li><strong>MyMobile</strong></li>
<li><strong>Nimble</strong></li>
<li><strong>Nonzero</strong></li>
</ul>
</td>
<td>
<ul>
<li><strong>Overlay</strong></li>
<li><strong>Sky High</strong></li>
<li><strong>Splash</strong></li>
</ul>
</td>
</tr>
</tbody>
</table>
<p>Themes can be uploaded to the server as well. There are different sites that provide themes for Moodle and some themes can be purchased from software developers. In this tutorial, the themes that were included in Moodle will be discussed. Now lets change the default theme in Moodle to a more palatable theme.</p>
<h3>Changing the standard theme in Moodle</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-1-click.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="changing-themes-1-click-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-1-click.gif" title="Click here to view the larger image" width="200" /></a> Navigate to the <strong>Site administration</strong> &gt; <strong>Appearance</strong> &gt; <strong>Themes</strong> &gt; <strong>Theme selector</strong> in the Settings section on the left. <br style="clear: both;" />
<table class="article_table" border="0">
<tbody>
<tr><th colspan="3" style="background: #cccccc;" valign="top">Current Theme Device Types</th></tr>
<tr><th valign="top"><strong>Default</strong></th>
<td colspan="2" valign="top">The default theme is the standard theme for the Moodle site. This is what a user or student will see in a standard web browser like Internet Explorer, FireFox, or Safari.</td>
</tr>
<tr><th valign="top"><strong>Legacy</strong></th>
<td colspan="2" valign="top">The Legacy theme is designed to work in old <em>out of date</em> browsers.</td>
</tr>
<tr><th valign="top"><strong>Mobile</strong></th>
<td colspan="2" valign="top">This gives the Moodle site the ability to display in common Mobile devices like iPhones.</td>
</tr>
<tr><th valign="top"><strong>Tablet</strong></th>
<td colspan="2" valign="top">This theme Device type is designed to display the Moodle site specifically for tablets. This is good for sites that require less JavaScript.</td>
</tr>
</tbody>
</table>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-2-default.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="changing-themes-2-default-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-2-default.gif" title="Click here to view the larger image" width="200" /></a>In this tutorial, the standard theme will be changed. In the information column, click the <strong>Change Theme</strong> button for the standard default theme. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-3-select.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="changing-themes-3-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-3-select.gif" title="Click here to view the larger image" width="200" /></a>On the <strong>Select theme for default device</strong> page, select a theme from the list In this case the <strong>Afterburner</strong> theme will be selected. On the Information column, click the <strong>Use Theme</strong> button for the Afterburner theme.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-4-new.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="changing-themes-4-new-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-4-new.gif" title="Click here to view the larger image" width="200" /></a>On the <strong>New theme saved</strong> page, basic information about the new theme that was selected will be displayed. Click <strong>Continue</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-5-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="changing-themes-5-final-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/changing-default-theme/changing-themes-5-final.gif" title="Click here to view the larger image" width="200" /></a>Now when going to the <strong>theme selector</strong> page the new theme will display in place of the old theme. <br style="clear: both;" /></li>
</ol>
<p>Congratulations, the theme for your Moodle site was changed. This concludes the article on Changing the default theme in Moodle. Please check the next article on <a target="_blank" href="/support/edu/moodle/changing-appearance-moodle/change-logo-footer" title="Click here to view the next article">Changing the Logo and Footer in Moodle themes</a>. For more information about articles about Moodles appearance, please visit <a target="_blank" href="/support/edu/moodle/changing-appearance-moodle" title="Click here to view the courses">Changing the Appearance of Moodle</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Changing the default Standard theme in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/moodle/changing-appearance-moodle/change-logo-footer'>Changing the Logo and Footer in Moodle themes</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/changing-default-theme&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/changing-default-theme'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTQmaWQ9MTk4NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0f9c8822f738ad4e6414a5ee0628ed44" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Moodle Themes</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/dca8ddfc3ba401548fdd1400d73a00fe?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/dca8ddfc3ba401548fdd1400d73a00fe'>nelson</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-14 1:48 am</div>
				                <div><p>i did by looking at the picture</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17413);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
