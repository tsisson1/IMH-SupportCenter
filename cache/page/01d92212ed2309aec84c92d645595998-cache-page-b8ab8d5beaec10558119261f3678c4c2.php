<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:43961:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-language-doku-wiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="change language doku wiki dokuwiki" />
  <meta name="description" content="202: Changing the language in DokuWiki. This course is designed to explain how to change the language in DokuWiki." />
  <title>202: Changing the language in DokuWiki | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-language-doku-wiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:df819a0fd9e1e08b7bbffb57b282f59d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '180.232.87.18']);
...
<div class='page-header'>
	<h1>202: Changing the language in DokuWiki</h1>
</div>
<div class='section_listing'>
	<h1>DokuWiki 202: Changing the language</h1>
<p>Like other wiki software, DokuWiki has the capability of multi-language support. This course will explain how to work with different languages in DokuWiki.</p>
	<table>
	<tr><td colspan='3'><h2>Changing the Admin language</h2><div>This section will explain how to change your DokuWiki administrator language.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/change-language-doku-wiki/change-admin-language-doku'>How to change the DokuWiki admin language</a>
					<div>If you want to change your DokuWiki admin language, you can by editing the conf/dokuwiki.php file. This article will explain the steps on how.</div>
					<div class='smallgrey'>Hits: 1,307</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Configuring the Multilingual Plugin</h2><div>The following articles give step by step instructions for setting up the Multilingual Plugin.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/change-language-doku-wiki/installing-multi-language-plugin-doku'>Installing the Multilingual Plugin for DokuWiki</a>
					<div>To have DokuWiki support multi language pages you will need to use the Multilingual Plugin. View this article to learn how to install  the Multilingual Plugin.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/change-language-doku-wiki/configure-multilingual-plugin'>Configuring the Multilingual Plugin in DokuWiki</a>
					<div>After installing the MultiLingual plugin in DokuWiki, you will need to set up the namespaces. This article will explain how to set up your multilingual plugin.</div>
					<div class='smallgrey'>Hits: 1,674</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzMmaWQ9MzMzJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a614676d82cd1a26eef1aa2830b28340" value="1" />	</div>
	</form>
<!-- <br />
