<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56661:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phplist/working-with-users/unsubscribe-from-a-list-in-phplist" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-09T20:45:56-08:00" />
  <meta name="keywords" content="phplist unsubscribe stop mailings" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll cover how you can unsubscribe a user from a list in phpList so that they do not receive any further mailings from you." />
  <title>Unsubscribe from a list in phpList - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phplist/working-with-users/unsubscribe-from-a-list-in-phplist" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:26c12535f9a78bfd3ac5b63acde048a9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '200.89.75.238']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phplist' itemprop='url'><span itemprop='title'>phpList<span></a><div class='dropdown_2columns'><h2>phpList Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/phplist/getting-started'>101: Getting started with phpList</a></div><div><a href='/support/edu/phplist/working-with-lists'>102: Working with lists in phpList</a></div><div><a href='/support/edu/phplist/working-with-users'>103: Working with users in phpList</a></div><div><a href='/support/edu/phplist/sending-messages'>104: Sending messages with phpList</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phplist/working-with-users' itemprop='url'><span itemprop='title'>103: Working with users in phpList<span></a><div class='dropdown_3columns'><h2> Working with users in phpList</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/phplist/working-with-users/manually-add-a-user-to-phplist'>Manually add a user to phpList</a></div><div>2. <a style='display:inline;' href='/support/edu/phplist/working-with-users/import-users-into-phplist'>Import users into phpList</a></div><div>3. <a style='display:inline;' href='/support/edu/phplist/working-with-users/unsubscribe-from-a-list-in-phplist'>Unsubscribe from a list in phpList</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Unsubscribe from a list in phpLi...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Unsubscribe from a list in phpList									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,327</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 8, 2013'><span style='color:#606060;'>Published:</span> Jan 9, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll cover how you can unsubscribe a user from a list in phpList, so that they do not receive any further mailings from you.</p>
<p>We'll go over how your users can go ahead and unsubscribe themselves using the default unsubscribe page that should be included as a link in all of your mailings. We're also going to touch on how you can unsubscribe users yourself as the administrator.</p>
<h2>Users can unsubscribe themselves</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/user-self-unsubscribe.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/user-self-unsubscribe.png" alt="how users can unsubscribe"  style="width: 160px; margin-left: 10px; position: relative; bottom: 15px; float: right;" width="160px" /></a>By default every mailing that you send out with phpList will include an unsubscribe link that the individual user can simply click on to unsubscribe themselves from your mailings with.</p>
<p>Once they click on the unsubscribe link in the email you've sent them, they'll be taken to the unsubscribe page of your phpList installation.</p>
<p>From here they can fill out a reason why they're unsubscribing, and then simply click on&nbsp;<strong>Unsubscribe</strong> to remove themselves from your future mailings.</p>
<p>The user will then receive one final email letting them know that they've been successfully unsubscribed from your mailings, and provided a link to re-subscribe in case they had unsubscribed by accident.</p>
<h2>Unsubscribe a user as admin</h2>
<p>If for some reason you need to manually unsubscribe a user from your mailings yourself, this can be done from the admin dashboard by following these steps.</p>
<ol class="article_list">
<li><a href="/support/edu/phplist/getting-started/how-to-log-into-phplist-admin-dashboard" target="_blank">Login to your phpList admin dashboard</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/click-on-users.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/click-on-users.png" alt="click on users"  style="width: 160px; margin-left: 10px; position: relative; bottom: 15px; float: right;" /></a>From the menu on the right, click on <strong>users</strong>.</li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/click-on-user-you-wish-to-unsubscribe.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/click-on-user-you-wish-to-unsubscribe.png" alt="click on user you wish to unsubscribe"  style="width: 160px; margin-left: 10px; position: relative; bottom: 15px; float: right;" /></a>Then click on the user that you'd like to unsubscribe.</li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/weekly-newsletter-list-highlighted.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/weekly-newsletter-list-highlighted.png" alt="weekly newsletter list highlighted"  style="width: 160px; margin-left: 10px; position: relative; bottom: 15px; float: right;" /></a>Scroll to the bottom of that user's page, and you should see which lists they're subscribed to. In this case, this user is already subscribed to our <strong>weekly newsletter</strong> list.</li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/weekly-newsletter-list-un-checked.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/users/unsubscribe/weekly-newsletter-list-un-checked.png" alt="weekly newsletter list un checked"  style="width: 160px; margin-left: 10px; position: relative; bottom: 15px; float: right;" /></a>Now un-check the <strong>weekly newsletter</strong>, and click on <strong>Save Changes</strong>.
<p style="clear: both;">You should see a confirmation at the top of the page of <span style="color: red;">Information: Changes saved</span>.</p>
</li>
</ol>
<p>You should now know how users can unsubscribe themselves from your mailing lists, or how you can unsubscribe them yourself as the admin of that list.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phplist/working-with-users'>103: Working with users in phpList</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Unsubscribe from a list in phpList</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/phplist/working-with-users/import-users-into-phplist'>Import users into phpList</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phplist/working-with-users/unsubscribe-from-a-list-in-phplist&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phplist/working-with-users/unsubscribe-from-a-list-in-phplist'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjImaWQ9MjA5NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c92e88885ed68a94f9fcc1b20b99bcf8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/phplist/working-with-users?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with users in phpList</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/phplist/working-with-users/manually-add-a-user-to-phplist?tsrc=rsbedu'>Manually add a user to phpList</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/phplist/working-with-users/import-users-into-phplist?tsrc=rsbedu'>Import users into phpList</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/phplist/working-with-users/unsubscribe-from-a-list-in-phplist?tsrc=rsbedu'>Unsubscribe from a list in phpList</a></td>
                </tr>
          	</table>
