<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:111671:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/managing-files/how-to-edit-a-file" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-14T18:24:39-07:00" />
  <meta name="keywords" content="how to edit a file file manager ftp notepad++ notepad server codeHow do I edit a file on my server?" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="You can edit files on your server with the File manager, an ftp program or a program like Notepad++. This article will teach you how." />
  <title>How do I edit a file on my server? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/managing-files/how-to-edit-a-file" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3ba35e5dddb544411957eccd8815633a -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/managing-files' itemprop='url'><span itemprop='title'>Managing Files<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/managing-files/how-to-upload-files-server'>How do I upload a file to my server?</a> (45164 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/managing-files/how-to-edit-a-file'>How do I edit a file on my server?</a> (38484 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/managing-files/change-file-permissions'>Changing File Permissions in cPanel</a> (33696 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/managing-files/how-to-delete-a-file'>How do I delete a file on my server?</a> (15139 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/managing-files/how-to-manage-files-server'>How to manage your files on your server</a> (13193 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/managing-files/how-to-move-files-on-server'>How do I move files on my server?</a> (11923 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/managing-files/reset-wipe-clean-website-like-new'>How to reset / wipe clean the files on My Account?</a> (6098 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How do I edit a file on my server?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I edit a file on my server?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>38,484</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 31, 2013'><span style='color:#606060;'>Published:</span> Jul 14, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/thfzSKCva9o" frameborder="0" allowfullscreen></iframe>
<p>Many times, when you are configuring your website, you will need to edit a file on the server. There are many ways you can edit a file on your server. You can use the File Manager Code Editor, an FTP program, or a program like Notepad++ to edit your files. The following will explain the steps on how to edit a file on your server.</p>
<p class="alert"><strong>Important!</strong> When updating files on your server, you may need to clear your browser cache to see the changes. For more information on clearing your browser cache, please see the article on <a target="_blank" title="Click here for more info" href="/support/website/how-to/clear-browser-cache"><strong>How to clear your browser's cache</strong></a>.</p>
<a name="file-manager"></a><h2>Use the file manager in cPanel</h2>
<p>You can edit files directly on your server using the File Manager code editor. This is sometimes called "<em>Editing on the fly</em>". Editing on the fly is usually reserved for minor changes. When editing files directly on the server, the change takes effect immediately. The problem with editing files directly on the server is that you are editing the live copy. When editing the live copy, your site can break if a mistake happens and you cannot undo the change after its saved.&nbsp; In order to edit a backup copy of your files, you will want to use FTP to change the files. Below is a general step by step on how to edit files though the File Manager.</p>
<p class="alert"><strong>NOTE!!</strong> If you do not know where your files are located on the server, please see our article on <a target="_blank" title="Click here to learn What directory should I put my files in?" href="/support/website/getting-started-guides/where-to-upload-files">What directory should I put my files in?</a>.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a> and <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a> in cpanel. Select your directory and click Go.</li>
<li>Edit the file with the <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor">File Manager Code Editor.</a>
<p>Save the changes.</p>
<p>You can now view your live site and see the changes.</p>
</li>
</ol>
<h2>Using FTP to edit a file</h2>
<p>Files can be downloaded and uploaded using FTP. Below are the basic steps to edit a file using FTP. For more information on FTP, please see our <a target="_blank" href="/support/website/file-management/getting-started-guide-ftp">Getting Started Guide: FTP</a> article.</p>
<ol class="article_list">
<li>Connect with ftp.</li>
<li>Download the file</li>
<li>Edit the file on your computer with notepad or another code editor.</li>
<li>Re-upload the file to the server and overwrite the existing file.
<p>The changes should reflect now on your live site.</p>
</li>
</ol>
<h2>Connect with a program like Notepad++</h2>
<p>You can edit files directly on your server using Notepad++. NotePad++ is a Windows based program that has FTP capabilities. For information on on editing your files with Notepad++, please see the article on <a target="_blank" href="/support/website/file-management/connect-ftp-notepad-plus">Connecting to your server with Notepad++</a>. </p>

<p>To see other articles available on how to manage your files, please visit <a target="_self" title="How to manage your files on your server?" href="/support/website/how-to/how-to-manage-files-server">How to manage your files on your server?</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/managing-files/how-to-edit-a-file&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/managing-files/how-to-edit-a-file'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDYmaWQ9NTQ2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="1d5d49f11bb8117d4da4529309b2d52e" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh5.googleusercontent.com/-6s0V8a71aRY/AAAAAAAAAAI/AAAAAAAAB6U/QGTXrS0Yo0A/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/irenioskamoska'>irenioskamoska</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-26 7:18 pm</div>
				                <div>why does the code editor or the html editor won´t let me edit public_html ? is because it is a directory or is it because of it´s size?<br />
how can i edit public_html? (want to ad a favicon)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8424);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-12-04 6:10 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello irenioskamoska,<br />
<br />
The &lt;strong&gt;/public_html&lt;/strong&gt; directory can't be edited with a code-editor as it is a folder and not a file. You can read our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/how-to-create-a-favicon-for-your-website&quot; target=&quot;_blank&quot;&gt;how to create a favicon for your website&lt;/a&gt; for steps on setting up a favicon.<br />
<br />
Please let us know if you had any other comments or questions.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8463);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20180'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9b55792a643b57b451c42c6ed588c735?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9b55792a643b57b451c42c6ed588c735'>jamesmanion</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-30 5:23 pm</div>
				                <div><p>when i put the quicktime&nbsp;code in my microsoft front page source code area&nbsp; the writing appears on the htm page as well as the source page</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20180);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-30 5:28 pm</div>
				                <div>Hello James,<br />
<br />
...
<br />
<a href="https://www.apple.com/quicktime/what-is/" rel="nofollow" target="_blank">What is Quicktime?</a><br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20181);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20589'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d90cb960f541f688e5ae50d8f91fb72d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d90cb960f541f688e5ae50d8f91fb72d'>Amar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-12 12:38 am</div>
				                <div><p>I am newbee for PHP. I want to edit my website which was previously developed by a professional. I am trying to find the database file of my website in public_html. How to find it? Please help.. Thanks!!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20589);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-12 12:55 pm</div>
				                <div>Hello Amar,<br />
<br />
Thank you for your question. Your database information will be listed in your configuration file, which will differ based on the software you are using.<br />
<br />
You will need to locate your <a href="http://www.inmotionhosting.com/support/website/how-to/find-config-files">config</a> file, which will list your database name and user information.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20609);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23013'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5f092cc4afa112f0e42cc80c03ea7ed8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5f092cc4afa112f0e42cc80c03ea7ed8'>John</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-28 4:44 am</div>
				                <div><p>Hi,</p>
<p>Does notepad++ have the abilty to test the amended php before its uploade and over writes the php file on the sever?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23013);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Scott M</div>
		...
		<a name='comment-23393'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b13731bf59b78153d95da76770c52243?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b13731bf59b78153d95da76770c52243'>Alexandra P.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-13 7:40 pm</div>
				                <div><p>Is there a way to download or sync ALL folders &amp; files to FTP.</p>
<p>I am using Core&nbsp;FTP LE - which I believe is set up correctly, but it doesn't show all folders, only:</p>
<p style="text-align: center;"><strong>&lt;..&gt;</strong></p>
<p style="text-align: center;"><strong>..</strong></p>
<p style="text-align: center;"><strong>.ftpquata</strong></p>
<p style="text-align: center;">&nbsp;</p>
<p style="text-align: left;">Is my FTP set up incorrectly or am I missing something (mentally)?&nbsp;</p>
<p style="text-align: left;">Thank you so much, in advance!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23393);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-14 10:39 am</div>
				                <div>Hello Alexandra,<br />
<br />
Thank you for contacting us. When you <a href="http://www.inmotionhosting.com/support/website/ftp/create-delete-account">create an FTP account</a>, the <strong>Directory</strong>, and <strong>Quota</strong> are also set.<br />
<br />
It is limited to the directory you set there. To give them full access to your file system, just enter a forward slash, like this: /<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23406);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24168'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2cab5ca15faef907793c08a79d849eec?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2cab5ca15faef907793c08a79d849eec'>Brandi B.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-12 10:26 pm</div>
				                <div><p>Hi!</p>
<p>I am new to cPanel and php. &nbsp;I am wanting to make a few changes to some forms on our site. &nbsp;When I log on to the developer site and right click on the form element and select "inspect element" &nbsp;I can see html code in the console but when I go to the file manager in cPanel and click on the exact same file, the html tags arent' there. &nbsp;Should I be looking somewhere else? &nbsp;Help! lol</p>
<p>Sincerely, Brandi B.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24168);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-15 1:14 pm</div>
				                <div>Hello Brandi,<br />
<br />
Many Content Management Systems (CMSes) are written in PHP. PHP is then interpreted by the server and the output is HTML. This is why you see HTML in the browser and can see HTML code when you View Source or Inspect Elements. The actual files on the server, however, are PHP and look different.  You can still find the place in the PHP file that prints the HTML to the browser, but it is usually among other PHP code as well, so finding it is not as easy as with a normal HTML page.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24208);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25021'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b24f977f25bfff57487617d622a88a53?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b24f977f25bfff57487617d622a88a53'>Arundhati Reddy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-20 7:08 pm</div>
				                <div><p>Hello, &nbsp;Thanks for the video. &nbsp;It taught me soemthing, but I still am not able to figure out something in my website. &nbsp;I am asking around and people trying to make me pay for full redoing of my website and expecting me to pay monthly maintenance which, I can not afford. &nbsp;few months ago I could easily go into my cpanel and change the store hours, but surprisingly that has disappeared now. &nbsp;I forgot to change my passwords and the person who created still had access until recently and demanding more money to change it. &nbsp;Can you help? &nbsp;I don't see the contact page coding anywhere in the cpanel. &nbsp;Looks like it's been routed to different place to pick from and can't find it. &nbsp;Any help is really appreciated.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25021);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-21 7:46 am</div>
				                <div>Hello Arundhati,<br />
<br />
I would not mind taking a look, but there is no domain name given. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25036);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26949'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4f7d725bc998c110b74009f1ece3b4f9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4f7d725bc998c110b74009f1ece3b4f9'>Hamza</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-24 1:21 pm</div>
				                <div><p>Hello guys i new here and i want o edit my old php file suddenly i have lost some data and i want to add that back into my site's script that is a ptc sites script and countries are missing in that file so tell me how can i put countries in that file?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26949);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-24 1:49 pm</div>
				                <div>Hello Hamza,<br />
<br />
Thank you for contacting us. We are happy to help, but it is not clear what you are trying to accomplish.<br />
<br />
Please provide more detailed information into what you are trying to accomplish.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26951);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28081'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1adfde7e95cc6f6eec3fcc33001be000?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1adfde7e95cc6f6eec3fcc33001be000'>Developer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-01 1:41 pm</div>
				                <div><p><em>Okay we made a page for our site by a professional and we go a css.zip, bin.zip and a html page for our letter through our mail. &nbsp;Now d problem is that am confused on how to upload the page on c panel cause i was hoping to get a zip file so we could easily upload once but now am confused cause i want all pages to work fine &nbsp;</em></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28081);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-02 2:48 pm</div>
				                <div>Hello Developer,<br />
<br />
Thank you for contacting us. I'm not sure exactly what you are asking, but you can <a href="http://www.inmotionhosting.com/support/website/managing-files/how-to-upload-files-server">upload files</a> to your server at any time.<br />
<br />
You can also <a href="http://www.inmotionhosting.com/support/website/file-manager/compressing-uncompressing-files">zip/unzip files</a> on the server at any time.<br />
<br />
Let us know if you have any further questions.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28098);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28425'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a32d3627996d9e770865510d15a57656?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a32d3627996d9e770865510d15a57656'>Pedro</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-14 9:31 pm</div>
				                <div><p>I'm having an issue with seeing my updates take effect.&nbsp; Whether I try to update a file as shown in the video or upload and replace the file, my site does not load the changes.&nbsp; This is a frustrating issue I had a couple of months ago and noticed that I could only see the changes happen when I renamed all the files completlly and uploaded them.&nbsp; For example I uploaded some bmp images not knowing browsers didn't support it so I saved them as jpg uploaded them, and edited my code with the changes but when I loaded my site the images were still boken.&nbsp; Can someone please help me with this.&nbsp; I've tried clearing everything in my browser in case something is being cached but I'm having no luck and need this site up by Monday.&nbsp; Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28425);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 3:45 pm</div>
				                <div>Hello Pedro,<br />
<br />
Are you using some type of caching plugin? Have you tried different browsers? Different devices? It sounds as if it is some sort of caching somewhere.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28466);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28815'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4d1b2280be5302de55b9dd523ac4f75b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4d1b2280be5302de55b9dd523ac4f75b'>George</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-28 10:12 am</div>
				                <div><p>Hi - &nbsp;I recently started using InMotion and am building my site on my local Host before uploading - I already have a ModX site (Php5 and Mysql) running on another webserver that I would like to port over to InMotion - &nbsp;I see the Droopal and Jumula support on InMotion but am wondering whether there are any plans for InMotion to provide support for ModX Reolution in the future.</p>
<p>Thnaks in advance</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28815);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-30 6:18 pm</div>
				                <div>Hello George,<br />
<br />
You can always ask a question about Mod X if you run across an error or need assistance. There are no current plans to create a Mod X education channel or articles, however.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28851);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29983'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c58b0dd4dff94f0ba195162457eb71f2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c58b0dd4dff94f0ba195162457eb71f2'>ayan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 12:06 am</div>
				                <div><p>I edited my index.html file at file manager editor but why is it, it does not took effect. There is a link that I unlink and also an image i delete. But when i hit save and browse my site, it is still not changing. the link and the image is still there. what is the cause of this issue?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29983);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 3:03 pm</div>
				                <div>Hello ayan,<br />
<br />
Thank you for contacting us. You may have to <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">clear your browser cache</a> before testing, or test with a different browser to see the changes.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29998);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
