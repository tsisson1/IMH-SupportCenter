<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54091:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/340-find-db-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-22T17:30:53-07:00" />
  <meta name="keywords" content="find db database name OpenCart" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Need to find the database name for your OpenCart application? Learn how in this short tutorial." />
  <title>340: How to find your database name for OpenCart 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/340-find-db-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3733dc4d3d28b62430b1fec82552f28f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '95.10.110.26']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															340: How to find your database name for OpenCart 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,352</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 15, 2013'><span style='color:#606060;'>Published:</span> Apr 22, 2016</div>
...
<li>Once inside the cPanel, you will need to <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">enter the File Manager</a>.</li>
<li>After entering the <em>File Manager</em>, navigate to the root folder for your OpenCart store. In our example, the folder is named <em>opencart</em> and is under the <em>public_html</em> root folder. This makes the folder path <em>public_html/opencart.</em></li>
<li>Under the root folder for your OpenCart store, locate and enter the folder named <strong>admin</strong>.</li>
<li>Once inside the <em>admin</em> folder, look for the file named <strong>config.php</strong> file. To open the file, highlight it and click on the <strong>Edit</strong> icon located in the toolbar across the top.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/how-to/find-db-name/click-edit.png"><img  alt="click edit toolbar button" src="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/how-to/find-db-name/click-edit.png" /></a></li>
<li>Once you open the file you will see many settings. Look for the line of code with DB_DATABASE in it. You will see the database name in the right side of the code line. In our example, the database name would be <em>_opencrt1</em>. The prefix will always be your cPanel username, in this case it is <em>userna5.</em> You can see a sample line of code below: <br />
<div class="code_block">define('DB_DATABASE', 'userna5_opencrt1');</div>
</li>
<li>Be sure to write down the database name so you can remember it. Now you can locate the particular database to use for editing no matter how many you have in your account.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 21: 340: How to find your database name for OpenCart 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 20: <a href='/support/edu/opencart/341-disable-product-reviews-in-opencart'>341: Disable product reviews in OpenCart 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 22: <a href='/support/edu/opencart/339-how-to-reset-my-opencart-admin-password'>339: How to reset my OpenCart Admin Password</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/340-find-db-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/340-find-db-name'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OCZpZD0yNDYxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="6d7d26a17513f718750163276727ded5" value="1" />	</div>
	</form>
<!-- <br />
