<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47565:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/general-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="This phpBB course will highlight the General settings and how to use them." />
  <title>201: Working with General Settings in phpBB 3 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/general-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:907b80ecb86a9184bac0c75c69470eed -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '83.246.1.130']);
...
<div class='page-header'>
	<h1>201: Working with General Settings in phpBB 3</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/smtp-setup'>How to Setup SMTP Settings in phpBB</a>
					<div>This guide will walk you through the SMTP setup steps in phpBB.</div>
					<div class='smallgrey'>Hits: 2,786</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/modify-signature-settings'>How to adjust signature settings in phpBB 3.0</a>
					<div>Learn how to adjust the signature settings for your </div>
					<div class='smallgrey'>Hits: 3,493</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/attachment-settings'>How to manage attachments in phpBB 3.0</a>
					<div>Learn to manage attachment and image settings in this phpBB 3.0 article.</div>
					<div class='smallgrey'>Hits: 5,493</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/board-settings'>Managing board settings in phpBB 3.0</a>
					<div>Take a look at customizing your board using the board settings in your ACP.</div>
					<div class='smallgrey'>Hits: 1,298</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/avatar-settings'>Editing avatar settings in phpBB 3.0</a>
					<div>Learn to manage and customize avatar settings for your members in this phpBB 3.0 article.</div>
					<div class='smallgrey'>Hits: 4,070</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/private-message-settings'>How to configure private message settings in phpBB 3.0</a>
					<div>Learn to configure your private message settings for your phpBB 3.0 site.</div>
					<div class='smallgrey'>Hits: 2,984</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/post-settings'>How to manage post settings in phpBB 3.0</a>
					<div>This article instructs you on how to customize the behavior of posts in your phpBB 3.0 site.</div>
					<div class='smallgrey'>Hits: 3,899</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/syndication-feed-settings'>Editing syndication feed settings in phpBB 3.0</a>
					<div>This article for phpbb 3.0 discusses the different settings for syndication feeds.</div>
					<div class='smallgrey'>Hits: 1,588</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/user-registration-settings'>How to Configure User Registration Settings in phpBB 3.0</a>
					<div>This article explains the different settings found in phpBB for user registration.</div>
					<div class='smallgrey'>Hits: 9,231</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/spambot-countermeasures'>Managing spambot countermeasures in phpBB 3.0</a>
					<div>Spambot countermeasures are used to help determine that a human user is on your site. This article discusses the different settings and options for phpBB 3.0</div>
					<div class='smallgrey'>Hits: 2,437</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/change-footer'>How to edit a template footer in phpBB 3.0</a>
					<div>Want to add an image or a link to your footer? Learn how to edit your template footer in phpBB 3.0</div>
					<div class='smallgrey'>Hits: 5,337</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/change-title'>Modifying your header title in phpBB 3.0</a>
					<div>Editing your site title can help your forum stand out as well as helping with SEO. Learn how to edit your title in this phpBB 3.0 tutorial.</div>
					<div class='smallgrey'>Hits: 3,084</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/general-settings/change-language'>How to activate a new language in phpBB 3.0</a>
					<div>Want your site to be in a language other than English? Learn to change your default language in this phpBB 3.0 article.</div>
					<div class='smallgrey'>Hits: 3,089</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTImaWQ9MzEyJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="afb28b6d03ad4d3be64ad4b386827a10" value="1" />	</div>
	</form>
<!-- <br />
