<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49418:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/how-to-set-category-page-as-home-page-in-prestashop" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="While it does not appear there is a way to do it within the Prestashop admin, I was able to find some information on how to do so within your code itsel..." />
  <title>How to Set Category Page as Home Page in Prestashop | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/how-to-set-category-page-as-home-page-in-prestashop" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:0f4e53493d2ed5b76ab91301de576ff1 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to Set Category Page as Home Page in Prestashop</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-hH3b7WA14-c/AAAAAAAAAAI/AAAAAAAABTc/07L1hrHYZ2U/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/meghasyam'>meghasyam</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-26 1:14 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>4,480</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am having http://example.com/index.php as my home page. My Category Page url is http://example.com/index.php?id_category=10&amp;controller=category<br />
<br />
Now, I need to redirect my homepage to Category Page. I tried in Preferences &gt; SEO &amp; URL's &gt; Set Shop URL &gt; Base URI as index.php?id_category=10&amp;controller=category<br />
<br />
Now, the page is redirecting to my Category Url but page is not opening. the url is showing like this http://example.com/index.php?id_category=10&amp;controller=category/index.php?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4026' id='upvote_answer_4026' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4026' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4026').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4026' id='downvote_answer_4026' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4026' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4026').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-09-26 7:45 am EST
                		        </div>
					
		                </div>

				While it does not appear there is a way to do it within the Prestashop admin, I was able to find some information on how to do so within your code itself.  The following article I found should be able to help you out with that:<br />
<br />
&lt;a href=&quot;http://stackoverflow.com/questions/19012800/how-to-set-category-page-as-home-page-in-prestashop&quot;&gt;How to Set Category Page as Home Page in Prestashop&lt;/a&gt;<br />
<br />
For other possible methods or if this is not working for you, I recommend consulting with the &lt;a href=&quot;http://www.prestashop.com/forums/&quot;&gt;Prestashop forums&lt;/a&gt; as a developer on there should be able to help you out with that.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4026').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4026' id='form_comment_on_answer_4026' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/how-to-set-category-page-as-home-page-in-prestashop&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/how-to-set-category-page-as-home-page-in-prestashop'></div>
<script type='text/javascript'>
  (function() {
