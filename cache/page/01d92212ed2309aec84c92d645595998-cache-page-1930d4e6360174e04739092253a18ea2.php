<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56600:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/edu/joomla-3/307-generic-error-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-20T03:08:08-08:00" />
  <meta name="keywords" content="joomla 3.0 error page htaccess.txt .htaccess" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to setup Joomla to show custom error pages, rather than having default server error pages show." />
  <title>307: Why is Joomla 3.1 not showing a custom error page? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/307-generic-error-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a82356580658ea704e25a06925ab2677 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															307: Why is Joomla 3.1 not showing a custom error page?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,077</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 16, 2012'><span style='color:#606060;'>Published:</span> Feb 20, 2014</div>
...
<p>In our testing of Joomla 3.0, we noticed that when we caused a <a href="/support/website/error-numbers/404-error-not-found-pages">404 page</a> on purpose, the generic server <strong>error page</strong> appeared. We're quite familiar with Joomla, and are use to seeing a custom error page appear instead.</p>
<p>For example, you can see below the differences between a generic server error page and an error page generated by Joomla 3.0:</p>
<div>&nbsp;</div>
<table class="article_table">
<tbody>
<tr><th>Generic Server Error</th><th>Joomla Error Page</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/error-pages/generic-server-error.jpg"><img style="max-width: 240px;"  alt="generic-server-error" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/error-pages/generic-server-error.jpg" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/error-pages/joomla-error-page.jpg"><img style="max-width: 240px;"  alt="joomla-error-page" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/error-pages/joomla-error-page.jpg" /></a></td>
</tr>
<tr>
<td style="background: #fff;" valign='top'>
<h2>Not Found</h2>
<div style="clear: both;">&nbsp;</div>
<p>The requested URL /joomla3.0-blog-english/this-page-does-not-exist was not found on this server.<br /><br />Additionally, a 404 Not Found error was encountered while trying to use an ErrorDocument to handle the request.</p>
</td>
<td style="background: #fff;" valign='top'>
<h2>The requested page cannot be found.</h2>
<div style="clear: both;">&nbsp;</div>
<p>An error has occurred while processing your request.<br /><br /> You may not be able to visit this page because of:<br /><br /> an out-of-date bookmark/favourite<br /> a mistyped address<br /> a search engine that has an out-of-date listing for this site<br /> you have no access to this page<br /><br /> If difficulties persist, please contact the System Administrator of this site and report the error below.<br /> 404 Category not found<br /><br /> You may wish to search the site or visit the home page.</p>
</td>
</tr>
</tbody>
</table>
<p>In order for Joomla's custom error page to show, you must have the Joomla 3.0 <a href="/support/website/htaccess/what-is-the-htaccess-file-and-what-do-i-use-it-for">.htaccess file</a> enabled. If you don't enable the .htaccess file, the server's error page will return instead of the Joomla error page.</p>
<p>When <a href="/support/edu/joomla-3/getting-started/install-joomla-3">Joomla 3.0 is installed</a>, a file named htaccess.txt can be found in the top level directory. Simply rename htaccess.txt to .htaccess, and Joomla's error pages will begin to appear instead of the server's.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 36: 307: Why is Joomla 3.1 not showing a custom error page?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 35: <a href='/support/edu/joomla-3/308-redirect-manager'>308: Using the Redirect Manager in Joomla 3.1</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/edu/joomla-3/307-generic-error-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/edu/joomla-3/307-generic-error-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjQwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="64e183766f4c88f519a1056e34c4d8df" value="1" />	</div>
	</form>
<!-- <br />
