...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-25/how-to-change-the-font-size-and-color-of-article-title-in-joomla-25" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="First you guys need to download the desired font file(.ttf) and create a new folder (template/css/newfolder)and paste in to it, where the path of this f..." />
  <title>How to change the font size and color of article title in Joomla 2.5? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-25/how-to-change-the-font-size-and-color-of-article-title-in-joomla-25" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b0d1c33d1221041ddad4124698239744 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to change the font size and color of article title in Joomla 2.5?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/anyang'>anyang</a>
			<div>15 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-11-14 3:05 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>9,950</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1879' id='upvote_answer_1879' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1879' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1879').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1879' id='downvote_answer_1879' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1879' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1879').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello anyang,<br />
<br />
Thank you for your question. This can be done by editing the css, or by using the <a href="http://www.inmotionhosting.com/support/edu/joomla-25/articles/editor-for-joomla-25">Editor</a> in Joomla.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1879').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1879' id='form_comment_on_answer_1879' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_3263' id='upvote_answer_3263' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3263' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3263').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3263' id='downvote_answer_3263' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3263' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3263').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/renjurein'>renjurein</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-06-06 7:27 am EST
                		        </div>
					
		                </div>

				First you guys need to download the desired font file(.ttf) and create a new folder (template/css/newfolder)and paste in to it,  where the path of this file we need to call over there in the css code.. <br />
after open the stylesheet.css(i opened template.css) and paste the below code:   <br />
CODE:<br />
@font-face {<br />
font-family: &quot;Trebuchet MS&quot;, Arial, Helvetica, sans-serif; //(this is name of my chosen font to be changed)<br />
src: URL('font/Trebuchet MS.ttf') format ('ttf'); //(Which is the url path as we done just before)<br />
}<br />
body{ //(here we deciding where we need to change the font, i declared to do in the body of the site  ;) )<br />
       font-family: &quot;Trebuchet MS&quot;, Arial, Helvetica, sans-serif !important;<br />
...
feel the change :)
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3263').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3263' id='form_comment_on_answer_3263' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-25/how-to-change-the-font-size-and-color-of-article-title-in-joomla-25&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-25/how-to-change-the-font-size-and-color-of-article-title-in-joomla-25'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="b84716dc9bef27e1107a74d211e747ce" value="1" />	</div>
	</form>
<!-- <br />
