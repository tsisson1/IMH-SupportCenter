<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:82840:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/302-an-error-occurred-during-installation" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-25T19:54:41-07:00" />
  <meta name="keywords" content="PrestaShop Configure shop information an error occurred during installation" />
  ...
  <title>302: PrestaShop 1.5 - Configure shop information - an error occurred during installation - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/302-an-error-occurred-during-installation" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:346b95f5dd261dfde3fa8ee941f43b9f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.83.101.25']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															302: PrestaShop 1.5 - Configure shop information - an error occurred during installation									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,225</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 14, 2012'><span style='color:#606060;'>Published:</span> Jul 25, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>During our PrestaShop 1.5 testing, we came upon the following error <a href="/support/edu/prestashop-15/getting-started/manual-install">when attempting to install PrestaShop 1.5</a>:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/install-error/prestashop-an-error-occurred-during-installation.gif"><img  alt="prestashop-an-error-occurred-during-installation" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/install-error/prestashop-an-error-occurred-during-installation.gif" style="float: right; margin: 0px 0px 15px 15px;" /></a><strong>Configure shop information</strong><br /><br />An error occurred during installation<br /><br /><em>You can use the links on the left column to go back to the previous steps, or restart the installation process by clicking here.</em></p>
<div style="clear: both;"></div>
<p>In this file, install/error_log, we found the following error:</p>
<p class="code_block">[14-May-2012 13:54:30] PHP Warning:&nbsp; simplexml_load_string() [&lt;a href='function.simplexml-load-string'&gt;function.simplexml-load-string&lt;/a&gt;]: Entity: line 1: parser error : Space required after the Public Identifier in /home/userna5/prestashop.inmotiontesting.com/classes/LocalizationPack.php on line 41</p>
<p>Therefore, we reviewed this file - <strong>classes/LocalizationPack.php</strong> - and saw the problem was with the <strong>$file</strong> variable being passed here:</p>
<p class="code_block">public function loadLocalisationPack($file, $selection, $install_mode = false)<br /> {<br /> if (!$xml = simplexml_load_string($file))<br /> return false;</p>
<p>During our troubleshooting we emailed ourselves the <strong>$file</strong> variable (using the php mail function) and found out the problem was in this file - <strong>install/models/install.php</strong> - at line 401:</p>
<p class="code_block">$localization_file_content = @Tools::file_get_contents('http://api.prestashop.com/download/localization/'.$version.'/'.$data['shop_country'].'.xml');</p>
<p>What was happening is that <strong>$localization_file_content</strong> was set to <strong>http://api.prestashop.com/download/localization/15/us.xml</strong>, however that file did not exist. At the time of this writing, that URL was resulting in a <strong>404 error</strong>. To resolve this issue, we added the following line in <strong>install/models/install.php</strong>:</p>
<p class="code_block">$localization_file_content = @Tools::file_get_contents('http://api.prestashop.com/download/localization/'.$version.'/'.$data['shop_country'].'.xml');<br /><strong>unset($localization_file_content);</strong></p>
...
<p class="code_block">if (!$localization_file_content)<br /> {<br /> $localization_file = _PS_ROOT_DIR_.'/localization/default.xml';<br /> if (file_exists(_PS_ROOT_DIR_.'/localization/'.$data['shop_country'].'.xml'))<br /> $localization_file = _PS_ROOT_DIR_.'/localization/'.$data['shop_country'].'.xml';<br /> $localization_file_content = file_get_contents($localization_file);<br /> }</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 56: 302: PrestaShop 1.5 - Configure shop information - an error occurred during installation</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 55: <a href='/support/edu/prestashop-15/312-configure-1-click-upgrade'>312: How to configure the 1-click Upgrade module in PrestaShop 1.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/302-an-error-occurred-during-installation&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/302-an-error-occurred-during-installation'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0yMzc5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="70b7094878fe81bc8561a57d7b68eb03" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d3b9ecbe4b5cc1952f1c1d768ed6ea47?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d3b9ecbe4b5cc1952f1c1d768ed6ea47'>ABKA</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-14 3:13 pm</div>
				                <div><p>Shopping cart does not work. &nbsp;I am getting an error stating invalid address at line 359. Please let me know how to resolve this problem or please take care of it for me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16241);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-14 3:15 pm</div>
				                <div>Could you provide the exact and full error as well as the information that you have on that line and the surrounding lines?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16242);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19553'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0388c1193c2cdff4c63f3650092649b1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0388c1193c2cdff4c63f3650092649b1'>Sunil</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-15 2:07 am</div>
				                <div><p><span style="color: #ff0000; font-family: Arial, Helvetica, sans-serif;">I am installing through GODADDY. belo werror i have got STORE INSTALLTION Tab. could you please guide me.</span></p>
<p>&nbsp;</p>
<ol class="process_list" style="margin: 10px 0px 0px 20px; padding: 0px; list-style-type: none; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 18px;">
<li id="process_step_generateSettingsFile" class="process_step fail" style="margin: 0px 0px 5px; padding: 0px 0px 0px 18px; color: red; background: url(http://www.mclue.com/install/theme/img/pict_error.png) 0px 1px no-repeat scroll transparent;">Create settings.inc file</li>
</ol>
<div id="error_process" style="margin: 0px 0px 20px 37px; padding: 5px; border: 1px solid rgb(102, 102, 102); color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 18px; background-color: rgb(251, 232, 214);">
<h3 style="margin: 0px; padding: 0px 0px 20px; font-size: 16px; color: red;">An error occurred during installation...</h3>
<p style="margin: 0px 0px 0px 20px; padding: 0px 0px 20px;">You can use the links on the left column to go back to the previous steps, or restart the installation process by&nbsp;<a style="cursor: pointer; color: rgb(212, 25, 88); text-decoration: none; font-weight: bold;" href="http://www.mclue.com/install/index.php?restart=true">clicking here</a>.</p>
</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19553);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-15 10:47 am</div>
				                <div>Hello Sunil,<br />
<br />
Have you tried going back to the previous step and then retrying? Does it do the same? Are there any other issues with the install? Error messages? Have you tried this on a completely clean folder structure or are you trying to overwrite some files? Which specific version are you trying to install?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19565);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26819'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/373a0cd919f2a14c9c6ef34bf28e5801?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/373a0cd919f2a14c9c6ef34bf28e5801'>Naomi Solomon</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-21 4:41 am</div>
				                <div><p>Hello,</p>
<p>I keep getting this message: - An error occurred during installation... once i get to the 53% on installtion. Please help. I am using Prestashop 1.6.1.1</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26819);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-21 3:12 pm</div>
				                <div>Hello Naomi,<br />
<br />
Have you tried the fix described above?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26845);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/eeee33a9f27531da29268dcb71df32fe?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/eeee33a9f27531da29268dcb71df32fe'>Trish</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-20 11:49 pm</div>
				                <div><p>I was getting this error at store installation (45%) tried your fix and now it wont get past create default shop (23%)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27731);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-21 12:26 am</div>
				                <div><p>Also i'm not getting the error above in my error log.</p>
<p>&nbsp;</p>
<p>Mine says</p>
<p>/ssv3_installer_payload-cyE04EE2Az.php startup/ssv3_installer_payload-ZMfmBDB2If.php startup/ssv3_installer_payload-8crYgRD7v9.php startup</p>
<p>&nbsp;</p>
<p>I also tried Mojos one-click install and that doesn't work either</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27732);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-21 11:53 am</div>
				                <div>Hello Trish,<br />
<br />
I'm sorry you're having problems with the installation of PrestaShop.  We need a little more information in order to determine what's happening.  What version of PrestaShop are you loading? Are you hosting with InMotion Hosting, or are you trying to load this elsewhere?  If you're not hosting with us, please make sure you meet the minimum installation requirements. When you're reviewing your <a href="https://www.prestashop.com/en/system-requirements" rel="nofollow" target="_blank">system configuration for the installation requirements</a>, please make sure that you match with the installation type (on a computer, or to a server on the internet).  We are hosting company and support the server hosted on the internet type of installation.  <br />
<br />
If you could please provide us this information then we can investigate the issue in more depth.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27743);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-21 3:05 pm</div>
				                <div><p>Hi Arnel</p>
<p>&nbsp;</p>
<p>My server information is:</p>
...
<p>&nbsp;</p>
<p>Hosted by ipage.&nbsp; I assume this is acceptable otherwise why do they offer PrestaShop script via Mojo one-click installs?</p>
<p>&nbsp;</p>
<p>Anyway, Mojo couldn't install it (but that's nothing new, Mojo often crashes on installs) So I also downloaded PrestaShop v1.6.1.1from your website and uploaded it via ftp.</p>
...
&nbsp;
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27752);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-21 8:14 pm</div>
				                <div>Hello Trish,<br />
<br />
Sorry for the problems with the installation. I'm guessing it should be okay on iPage.  I couldn't tell you why it would be crashing there as that is not our hosting environment and we do not have access to them.   PrestaShop offers a very complete installation guide that you can find here: <a href="http://doc.prestashop.com/display/PS15/Installing+PrestaShop" rel="nofollow" target="_blank">Installing PrestaShop</a>.  If you continue to have installation problems, please contact iPage technical support or provide more specific error details at the time of the crash so that we can investigate the issue further.  You can also always post installation issues directly on the PrestaShop support forums page.  Many of users would be happy to help.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27755);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
