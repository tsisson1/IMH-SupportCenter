<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63816:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/jevents-calendar/create-event-menu-item" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-19T18:02:14-08:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="After installing JEvents for Joomla 3, your next step is to create a page where users can add events to your Calendar." />
  <title>Creating an Add Event JEvents menu item in Joomla 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/jevents-calendar/create-event-menu-item" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f50161c0c811436675555fa4660d8351 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating an Add Event JEvents menu item in Joomla 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 14, 2014'><span style='color:#606060;'>Published:</span> Feb 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that you've <a href="/support/edu/joomla-3/jevents-calendar/install">installed the JEvents Joomla 3 calendar component</a>, the next thing to do is allow users to add events. In this tutorial, we are going to show you how to create a link on your site called <strong>Add an event</strong>. When users click this menu link, they'll be taken to a form where they can then add an event.</p>

<ol class='article_list'>
  
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3 dashboard</a></li>

<li>In the top menu, hover over <strong>Menus</strong>, hover over the menu you want to add the JEvents link to, and then click <strong>Add New Menu Item</strong></li>
  
  <li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/jevents/create-jevents-menu-item.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/jevents/create-jevents-menu-item.jpg"  style='float:right; margin:0px 0px 15px 15px;' /></a>
    <p>Next to <strong>Menu Title</strong>, enter a title for this page. We used, <em>Add an event</em></p>
  </li>
  

<li>Next to <strong>Menu Item Type</strong>, click <strong>Select</strong></li>

<li>Find <strong>jevents</strong> in the list, and then click on it</li>



<li>When the list expands under <em>jevents</em>, click <strong>Create JEvents</strong></li>

<li>
  <p>In the top left of the page, click <strong>Save</strong></p>
  ...
  <p>As you can see in the screenshot to the right, in our top menu we have a link that says <em>Add an event</em>. In our text tutorial, we'll show you how users can click that link and <a href="/support/edu/joomla-3/jevents-calendar/add-new-event">add an event</a> to our Joomla 3 calendar!</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Creating an Add Event JEvents menu item in Joomla 3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/jevents-calendar/install'>Installing the JEvents Calendar in Joomla 3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/jevents-calendar/add-new-event'>How to add an event in Joomla 3 using JEvents Calendar</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/jevents-calendar/create-event-menu-item&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/jevents-calendar/create-event-menu-item'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTYmaWQ9MzEwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Events</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4e57e79c5b01729c798de177eb88d7c6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4e57e79c5b01729c798de177eb88d7c6'>Don</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-12 9:35 pm</div>
				                <div>(be sure you are using   create menu ITEM)   and NOT  &quot;Create_a_MENU&quot;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12693);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18879'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ae07e847c05992b44a9e72a7b4db22f3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ae07e847c05992b44a9e72a7b4db22f3'>seraph</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-26 1:44 am</div>
				                <div><p>i create as per above instructions. but when i go to the front end and log in, the add new event is not appearing in the menu i selected. i have created a user specifically assigned to create these type of new events.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18879);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-26 11:01 am</div>
				                <div>Hello Seraph,<br />
<br />
Can you provide the domain that should have this link showing up? Does your user have the correct permissions to access the link? Has the menu been added to your page via a module? <br />
<br />
Kindest Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18891);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
