<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60365:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-index-files" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:18:37-07:00" />
  <meta name="keywords" content="wordpress hack index restore" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you need to restore WordPress index files from backup, it may not be as difficult as you may think." />
  <title>Restoring WordPress index files - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-index-files" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cee40d1e68a84188b717350cf3d48395 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Restoring WordPress index files</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Restoring WordPress index files									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,686</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 14, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>A common technique for hackers is to target index files, such as index.php or index.html. Because <a href="/support/website/getting-started-guides/where-to-upload-files">index files usually load first</a> when a website is visited, a hacked index file gives hackers a higher probability of their message / malicious code being loaded most often.</p>
<p>If you're attempting to restore your WordPress site after a recent hack and need to restore your index files, it may not be as hard as you think. Most index files in WordPress are either:</p>
<ol>
<li>core WordPress files</li>
<li>theme files</li>
</ol>
<p>If you're missing any core WordPress files, such as example.com/index.php, you can simply download a copy of the version of WordPress you're running and <a href="/support/website/file-management/getting-started-guide-ftp">upload</a> that index.php file to your account.</p>
<p>If you're missing an index.php file from your theme, you can reinstall your theme again.</p>
<p>If you've made any changes to your index.php files, these techniques will not work for you. The average user however will not ever edit WordPress php files directly, so restoring hacked index.php files should be a simple procedure.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/wordpress-index-files&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/wordpress-index-files'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0yOTcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="738b278176fce2e7b5584902ff3f937e" value="1" />	</div>
	</form>
<!-- <br />
