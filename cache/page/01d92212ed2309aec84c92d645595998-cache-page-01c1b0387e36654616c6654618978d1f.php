<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50206:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/menus" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Your Joomla 2.5 website is heavily driven by menus. If users are not searching your website, they're most likely browsing it using links in your menus. We'll show you what you need to know about Joomla 2.5 menus in this tutorial series." />
  <title>106: Create and Configuring Joomla 2.5 Menus | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/menus" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1c1567c55c48f1c5e01381e8d0031734 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '200.87.234.38']);
...
<div class='page-header'>
	<h1>106: Create and Configuring Joomla 2.5 Menus</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/changing-menu-order'>Joomla Menu Re-Ordering</a>
					<div>How to change your menu order in Joomla.</div>
					<div class='smallgrey'>Hits: 3,697</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/intro-to-joomla-menus'>An Introduction to Joomla 2.5 Menus</a>
					<div>Joomla 2.5 menus create the basic navigation structure of your website. In this article we'll give you a brief introduction to Joomla menus.</div>
					<div class='smallgrey'>Hits: 12,660</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>In this tutorial, we'll walk you through the basic steps of creating a new Joomla 2.5 menu and menu module.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/category-list-vs-category-blog'>Joomla 2.5 Menu Items - Category List vs. Category Blog</a>
					<div>In this article, we'll show you the differences between a Joomla 2.5 Category List and Category Blog menu item.</div>
					<div class='smallgrey'>Hits: 24,266</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/list-all-categories-options'>Joomla 2.5 List All Categories - Categories Options</a>
					<div>When setting up a Joomla 2.5 List All Categories menu item, there are quite a few categories options you can configure. We'll discuss each of these settings in this Joomla 2.5 tutorial.</div>
					<div class='smallgrey'>Hits: 19,929</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>Using css, you can easily create horizontal menus in Joomla 2.5</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/list-all-categories'>Joomla 2.5 Menu Items - List All Categories</a>
					<div>In this Joomla 2.5 tutorial, we'll show you how to create a List All Categories menu item.</div>
					<div class='smallgrey'>Hits: 23,700</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/menu-items-in-new-tab'>Forcing Joomla 2.5 menu items to open in a new window</a>
					<div>In this Joomla 2.5 tutorial, we'll walk you through the steps for configuring menu items to open either in new window or new tab.</div>
					<div class='smallgrey'>Hits: 8,253</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/star-in-menu'>Why in Joomla 2.5 is there a star next to a menu item?</a>
					<div>What does the star mean in the Joomla 2.5 Menus dropdown? We'll answer that question for you in this Joomla 2.5 tutorial.</div>
					<div class='smallgrey'>Hits: 2,604</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/how-to-link-to-an-article-in-a-menu'>How to link to an Article in a Joomla 2.5 Menu</a>
					<div>In this tutorial, we'll show you how to add a menu item to a Joomla 2.5 menu that links to an article.</div>
					<div class='smallgrey'>Hits: 13,791</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/menus/how-to-add-a-category-menu-item'>How to link to a Category in a Joomla 2.5 Menu</a>
					<div>In this tutorial, we'll show you how to link to a Joomla 2.5 category using a menu.</div>
					<div class='smallgrey'>Hits: 16,595</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODYmaWQ9MTg2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="bc39f222c72c97cbc719cb60f9cbecdc" value="1" />	</div>
	</form>
<!-- <br />
