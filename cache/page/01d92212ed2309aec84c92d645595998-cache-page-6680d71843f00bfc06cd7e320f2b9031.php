<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61961:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/htaccess/force-download-htaccess" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-16T19:53:11-07:00" />
  <meta name="keywords" content=".htaccess file download force view htaccess" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/htaccess/force-download-htaccess" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ce9e373ceb1b6caceeb6fc7f61c6f083 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '177.103.228.219']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Forcing a file to download in a browser via htaccess 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 1, 2012'><span style='color:#606060;'>Published:</span> Aug 16, 2013</div>
...
<li>You are now in the text editor. Place the following code into your htaccess so that it forces the visitor to download that type of file. You will need to have a line of code for each type of file. It is usually best to place this code at the top of the file.<br /><br />In the example below, we will give an example for two types of files. The only difference between the lines of code will be the file extension. In our example, we want the visitor to have to download videos with the .mov extension and documents with the .pdf extension. <br />
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/htaccess/force-download-htaccess&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/htaccess/force-download-htaccess'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTMmaWQ9NDM2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
