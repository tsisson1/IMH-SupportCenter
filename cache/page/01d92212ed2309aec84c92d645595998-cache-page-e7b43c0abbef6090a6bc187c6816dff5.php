<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61495:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/product-description" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-22T11:22:24-07:00" />
  <meta name="keywords" content="prestashop 1.5 product description" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to enter descriptions for your products." />
  <title>Adding a PrestaShop 1.5 Product Description - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/product-description" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6ce2f82c9138fe555b66e8652f3eb12d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.244.56.211']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding a PrestaShop 1.5 Product Description									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,959</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 21, 2012'><span style='color:#606060;'>Published:</span> Aug 22, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When <a href="/support/edu/prestashop-15/add-products-categories/add-product">adding a new product</a> in PrestaShop 1.5, you have the option to add a <strong>product description</strong>. Naturally, this product information tells your customers all the details they want to know about the product they're looking at.</p>
<p>A product description is not required when adding a product. In this tutorial, we'll show you have to add a new product description to an existing product.</p>
<p><strong>To add a product description in PrestaShop 1.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 Dashboard</a></li>
<li>In the top menu, hover over <strong>Catalog</strong> and click <strong>Products</strong></li>
<li>In the list of products, locate the product you want to edit. To the far right of the product, <strong>click the edit icon</strong> (<em>pencil icon</em>).</li>
<li>In the left menu, you will see several tabs listed. The tab you need to be on is the <strong>Information</strong> tab, which is the default tab.<br /><br />On this page, enter a <strong>Short Description</strong> and a <strong>Description</strong> for your product. PrestaShop 1.5 gives the following explanations to explain the difference between these two descriptions:<br /><br /> 
<table class="article_table">
<tbody>
<tr>
<th>Short Description</th> <th>Description</th>
</tr>
<tr>
<td>appears in the product lists and on the top of the product page</td>
<td>appears in the body of the product page</td>
</tr>
</tbody>
</table>
<p>After entering your descriptions, click the <strong>Save</strong> button in the top right menu.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/add-product/where-is-description.gif"><img  alt="where-is-description" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/add-product/where-is-description.gif" /></a>
<p>As you can see in the screenshot above, the <strong>Description</strong> will show under the <strong>More info</strong> tab, while the <strong>Short Description</strong> shows next to the product's image and under the <strong>New Products</strong> feature.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: Adding a PrestaShop 1.5 Product Description</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/prestashop-15/images-and-descriptions/removing-product-images'>Removing product images in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/prestashop-15/images-and-descriptions/change-short-description-max-length'>Changing the max length of the short description in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/product-description&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/product-description'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTMmaWQ9MTcwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0f66e60536c1fd4b9f2f61bbffecbd72" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Product Descriptions</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>6.</td>
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/cant-upload-images-product-description?tsrc=rsbraq'>I can't upload images in product description</a>
                                </div>
