...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/databases/find-mysql-version" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:15:03-08:00" />
  <meta name="keywords" content="find mysql version number cpanel telnet" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking for your MySQL version number? Check this article out for the answer." />
  <title>How to determine your MySQL version number - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/databases/find-mysql-version" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ee033df0ab10b68ff999408303a5aba5 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to determine your MySQL version number									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<p>When working your <a href="/support/website/database-setup/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel">phpMyAdmin</a> and php, you will often work with a language called SQL, which is the way your program will talk to the database. This language talks through an engine called MySQL to update, create and delete information from the program's databases. At times, you may end up troubleshooting various errors such as syntax errors for MySQL within your php code or phpMyAdmin tool. It can be helpful to understand which version of MySQL you are using. Below is a quick guide on finding the MySQL version in use on your hosting servers.</p>

<h2>Finding your MySQL version via phpMyAdmin</h2>

<ol class="article_list">
<li>Log into your cPanel admin dashboard.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mysql/find-version/1-phpmyadmin.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click on phpMyAdmin icon" src="//cdn.inmotionhosting.com/support/images/stories/edu/mysql/find-version/1-phpmyadmin.png" title="Click here to view the larger image" width="200" /></a>From the main cpanel area, look for the <em>Databases</em> catagory. Find and click on the <strong>phpMyAdmin</strong> icon to activate the tool.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mysql/find-version/2-phpmyadmin-page.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="software version in right hand panel" src="//cdn.inmotionhosting.com/support/images/stories/edu/mysql/find-version/2-phpmyadmin-page.png" title="Click here to view the larger image" width="200" /></a>From the main phpMyAdmin page, look to the far right side of the page. There is a block entitled "Database Server". Look for the field named <em>Software version</em>. Next to that label is a number. That is your MySQL version number.<div style="clear:both;"></div></li>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/databases/find-mysql-version&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/databases/find-mysql-version'></div>
	<script type='text/javascript'>
	  (function() {
