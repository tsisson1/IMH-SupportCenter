<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51126:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-category-page-header-image" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Bruce, Thanks for the question about editing the background image of your custom theme. If you are not familiar with where the elements of this theme..." />
  <title>Prestashop category page header image. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-category-page-header-image" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b896e4186141387501b2a05272c32570 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '79.156.204.132']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Prestashop category page header image.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-02-17 10:18 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>282</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>http://pawsandclawspetsupply.com<br />
Please refer to:  breadcrumbs-bg.png file in themes/jms_food folder<br />
<br />
This a a stock image that the theme developer placed in to appear at the top of all the product pages, please see:<br />
http://pawsandclawspetsupply.com/pillow-beds/9-bumper-dog-bed.html<br />
<br />
Please walk me through how I change that image into one of my pet product images.  I don't want to mess it up.  I notice that there is not an edit option.  For example, my image is on my laptop, don't I have to put it somewhere in order for bg file to pull from.<br />
<br />
r,<br />
<br />
Bruce</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6564' id='upvote_answer_6564' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6564' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6564').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6564' id='downvote_answer_6564' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6564' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6564').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Bruce,<br />
<br />
Thanks for the question about editing the background image of your custom theme.  If you are not familiar with where the elements of this theme must be changed, then you will need to make sure that you review all the pages where this image appears, and then note how the BG (background) file is referenced.  In the URL that you provided, it is coming from a<b> GLOBAL.CSS</b> file that is found within the specific theme directory that you are using (<i>/themes/jms_food/css/global.css</i>).  I use Chrome's option to inspect the page elements to find this reference.  You can do this by right-clicking on the item you want to inspect, then select "Inspect Element".  In this case, I could tell, that the BG image was being referenced through CSS.  Using the Element Inspector in Chrome also gives me the dimensions of the image as it appears in the browser, though you can also find that information by simply loading the image file into a tool like Photoshop. <br />
<br />
Once I identified the file and where it was being referenced, I looked for the CSS file (global.css) and the actual image file itself.  The IMG file (as identified by the path provided by Chrome's Inspect Element) was in the image files directory in the THEME folder that was being used.  So, in this case, the BG file was located in <i>public_html/themes/jms_food/breadcrumbs-bg.png</i>.  Now, you can change the graphic by simply renaming the old one and replacing it with a duplicate file using the SAME name.  Then you don't have to make any changes anywhere in the CSS files to make the graphic change.  If you want to change the graphic reference, then you would need to find the <b>GLOBAL.CSS</b> file and modify it to use the new graphic for the BG. <br />
<br />
I hope all of this makes sense to you!  It's really a simple change, but the actual change to the theme will depend on how you make the change.  Remember that the graphic you use should match the dimensions of the original file, as this file was created to fit the existing theme.<br />
<br />
Hope that helps!  Let us know if you have any further questions.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6564').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6564' id='form_comment_on_answer_6564' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-category-page-header-image&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-category-page-header-image'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="4af448d3eaae777f8ba0618d56f7fe53" value="1" />	</div>
	</form>
<!-- <br />
