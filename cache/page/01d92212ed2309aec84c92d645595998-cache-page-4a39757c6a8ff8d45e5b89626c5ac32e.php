<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58255:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.info/support/edu/joomla-25/database/database-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-28T23:07:58-07:00" />
  <meta name="keywords" content="joomla 2.5 database name" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you forget your Joomla 2.5 database name, you can find it within your configuration.php file. It will be labeled as $db, which is next to your Joomla 2.5 database username and password as well." />
  <title>What is my Joomla 2.5 database name? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/database/database-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b2fe7471b4640c55460fa958d31d74be -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.249.65.15']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What is my Joomla 2.5 database name?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,308</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>When you initially installed Joomla 2.5, you were required to enter a database name, username, and password. It is rare, but there may be times that you need to interact directly with the Joomla 2.5 database. For example, you will need to know your Joomla 2.5 database name if you will be<a href="/support/edu/joomla-25/users/reset-user-password"> resetting a Joomla 2.5 user password directly within the database.</a> If you forgot what your Joomla 2.5 database name is or someone else besides yourself installed Joomla 2.5, you can find the Joomla 2.5 database name within your Joomla 2.5 configuration.php file.</p>
<p><strong>To find your Joomla 2.5 database name within Joomla's configuration.php file:</strong></p>
<ol class="article_list">
<li>In the top level of all your Joomla 2.5 files, find and view the file named <strong>configuration.php</strong></li>
<li>Find the database name, which will be listed next to public <strong>$db</strong>, as in:
<p class="code_block">public $db = '<strong>userna5_j25</strong>';</p>
In the above example, the Joomla 2.5 database name is userna5_j25.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: What is my Joomla 2.5 database name?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-25/database/which-databases-are-available'>Which databases can be used with Joomla 2.5?</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.info/support/edu/joomla-25/database/database-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.info/support/edu/joomla-25/database/database-name'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDAmaWQ9MTMxNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="9af478670c471aa08b9c9182824ca867" value="1" />	</div>
	</form>
<!-- <br />
