<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61335:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/version/which-version-of-php" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-28T23:12:55-07:00" />
  <meta name="keywords" content="which joomla 2.5 php version" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article, we'll walk you through the steps for finding out which version of PHP your Joomla 2.5 server is running. This is important to know when installing Joomla 2.5 extensions, as some of them may require higher versions of PHP other than the Joomla 2.5 minimum of PHP 5.2.4." />
  <title>Which version of PHP does my Joomla 2.5 server run? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/version/which-version-of-php" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:52a2fc5cc1e2bc697d553cd4c12daed2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '81.36.247.214']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Which version of PHP does my Joomla 2.5 server run?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,631</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 22, 2012'><span style='color:#606060;'>Published:</span> Sep 28, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>The minimum PHP version number Joomla 2.5 needs to run is PHP 5.2.4. You may want to <a href="/support/edu/joomla-25/extensions/how-to-install-a-joomla-25-component">install certain Joomla 2.5 extensions</a> however that require a higher version of PHP. In those cases, you'll need to know which version of PHP your hosting server is running. In this Joomla 2.5 tutorial, we'll walk you through the steps for finding out which version of PHP your Joomla 2.5 server is running.</p>
<p><strong>To find out which version of PHP your Joomla 2.5 hosting server is running:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla 2.5 admin screen</a></li>
<li>In the top menu, hover over <strong>Site</strong> and click <strong>System Information</strong></li>
<li>if you're not on the System Information tab, click the <strong>System Information</strong> tab. On this page you'll see a setting labeled at PHP Version:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/which-php-version/joomla-25-php-version.gif"><img  alt="joomla-25-php-version" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/which-php-version/joomla-25-php-version.gif" /></a><br /><br />As you can see from the screenshot above, our Joomla 2.5 server is currently running:<br /><strong>PHP Version 5.2.17</strong></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/version'>209: Joomla 2.5 Configuration - Which version questions</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Which version of PHP does my Joomla 2.5 server run?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-25/version/which-version-of-joomla'>Which version of Joomla 2.5 am I running?</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/version/which-version-of-php&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/version/which-version-of-php'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xOTcmaWQ9MTM0NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="fbc44a4b73c5396941bc922127a33174" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/version?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 2.5 Configuration - Which version questions</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/version/which-version-of-joomla?tsrc=rsbedu'>Which version of Joomla 2.5 am I running?</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/version/which-version-of-php?tsrc=rsbedu'>Which version of PHP does my Joomla 2.5 server run?</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f3c3aa356822bf661be8efce8eb2b565?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f3c3aa356822bf661be8efce8eb2b565'>Ramesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 2:55 am</div>
				                <div><p>but if i want to upgard the php version is it possible.</p>
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14692);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 8:17 am</div>
				                <div>Hello Ramesh,<br />
<br />
Yes, you would simply <a href="http://www.inmotionhosting.com/support/website/php/how-to-change-the-php-version-your-account-uses">change the php version</a> on your hosting account.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14700);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
