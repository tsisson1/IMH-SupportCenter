<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60394:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/moodle-site-security/force-ssl-login" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:41:47-07:00" />
  <meta name="keywords" content="Moodle 2.3 force HTTPS logins login forcing SSL encrypt secure logging login security" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to make Moodle 2.3 force HTTPS logins." />
  <title>Setting the Moodle login to work over HTTPS - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/moodle-site-security/force-ssl-login" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2f109798710f33f8cf82effe19eddfde -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting the Moodle login to work over HTTPS									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,209</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 29, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When loging into Moodle by default, the login information is transmitted over an HTTP connection. <strong>HTTP connections are not secure connections</strong> and a perpetrator could snoop on the network connection and potentially gain access to your username and password. To prevent this, the HTTPS connection can be used. <strong>HTTPS is an encrypted connection that encrypts the data in transit over the network</strong>, preventing the data from being read by hackers. Moodle 2.3 has a setting that enables the HTTPS connection for the login, while keeping the rest of the website HTTP.</p>
<p class="alert"><strong>VERY IMPORTANT!</strong> Before you set the Login to work on HTTPS, the server that hosts your Moodle site will need to be able to access through an SSL connection. <strong>If there is no SSL connection, the <strong>LOGIN WILL BREAK</strong></strong>, locking you out of your Moodle software. To find out if your server has an ssl connection, visit your site by going to:<br /> <br /> https://example.com<br /> <br />You will need to change example.com to your domain where your moodle site is installed. If the server does not have an SSL installed, there will be an error when visiting the site like the following snapshots.
<table border="0">
<tbody>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-connection-failed.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="force-ssl-login-connection-failed-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-connection-failed.gif" title="Click here to view the larger image" width="150" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-untrusted.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="force-ssl-login-untrusted-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-untrusted.gif" title="Click here to view the larger image" width="150" /></a></td>
</tr>
</tbody>
</table>
</p>
<p>For more information on SSL and HTTPS connections, please<a href="/support/website/ssl/what-is-ssl-and-why-is-it-important" target="_blank" title="Click here for more info"> click here</a>. Now that the details are explained, we can&nbsp; go through the steps of setting up Moodle for logging in on an HTTPS / SSL connection.</p>
<h3>Forcing HTTPS login</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="force-ssl-login-1-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-1.gif" title="Click here to view the larger image" width="200" /></a> Navigate to <strong>Site administration</strong> &gt; <strong>Security</strong> &gt; <strong>HTTP security</strong> in the Settings section. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-2-security.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="force-ssl-login-2-security-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-2-security.gif" title="Click here to view the larger image" width="200" /></a> On the HTTP security page, select the <strong>Use HTTPS for logins</strong> and <strong>Secure cookies only </strong>check boxes.
<p><strong>Click Save Changes</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-3-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="force-ssl-login-3-final-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/201/force-ssl-login/force-ssl-login-3-final.gif" title="Click here to view the larger image" width="200" /></a> Now when going to the Moodle login the site will go to HTTPS instead of HTTP. If the HTTPS is working correctly, the data will transmit securely.</p>
<br style="clear: both;" /></li>
</ol>
<p>This concludes the article for Setting the Moodle login to work over HTTPS.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/moodle/moodle-site-security'>201: Moodle site security and server settings</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Setting the Moodle login to work over HTTPS</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/moodle/moodle-site-security/forcing-ssl-sitewide'>Forcing Moodle 2.3 to work over SSL</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/moodle-site-security/force-ssl-login&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/moodle-site-security/force-ssl-login'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTgmaWQ9MjAyNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5e85b151a764a3305d3ab8ff73dfdf43" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/moodle/moodle-site-security?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Moodle site security and server settings</h3></a>
		<table><tr><td colspan='2'><h4>Site Security</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/moodle/moodle-site-security/force-ssl-login?tsrc=rsbedu'>Setting the Moodle login to work over HTTPS</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/moodle/moodle-site-security/forcing-ssl-sitewide?tsrc=rsbedu'>Forcing Moodle 2.3 to work over SSL</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/moodle/moodle-site-security/block-ips?tsrc=rsbedu'>Blocking IP's in the Moodle Site administrator</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/moodle/moodle-site-security/clamav-anti-virus?tsrc=rsbedu'>Setting up ClamAV AntiVirus for Moodle file uploads</a></td>
                </tr>
        <tr><td colspan='2'><h4>Server settings</h4></td></tr>  <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/moodle/moodle-site-security/maintenance-mode-moodle?tsrc=rsbedu'>Enable / Disable maintenance mode in Moodle</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b950cae3b6129391705984152bfa7b94?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b950cae3b6129391705984152bfa7b94'>jean</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-15 9:05 pm</div>
				                <div><p>after switching to HTTPS no longer appears the login screen, openssl active ta ... resolving to return HTTP</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15082);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
