...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-25T22:03:26-08:00" />
  <meta name="keywords" content="login reset admin password change email PhpMyAdmin TikiWiki tiki wiki resetting administrator changing forgot forgotten logging log in passwords e-mail users_users [gs]" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to login, reset the admin password, and change the admin email in PhpMyAdmin for TikiWiki." />
  <title>Logging into TikiWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c904ae57ad2686c388a9741451b7a10e -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,958</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 13, 2012'><span style='color:#606060;'>Published:</span> Feb 25, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The first step in managing your TikiWiki site is to know how to login. Login into TikiWiki is simple. There are no special url's you need to go to. You simply visit the site and the login link is on the website. This is accessible to anyone on the internet. This article will explain how to do log into TikiWiki.</p>
<h2>How do I log into TikiWiki?</h2>
<p>The starting place for managing the TikiWiki site is to login to the administrator section of TikiWiki. This section will explain how to log into your TikiWiki site.</p>
<ol class="article_list">
<li>
<p><strong>Navigate to your TikiWiki site.<br /></strong></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/login-tikiwiki-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="login-tikiwiki-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/login-tikiwiki-1.gif" title="Click here to view the larger image" width="100" /></a>Hover over the Login link at the right of the TikiWiki site.
<p>Enter the username and password and <strong>click Log in</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/login-tikiwiki-2.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="login-tikiwiki-2" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/login-tikiwiki-2.gif" title="Click here to view the larger image" width="100" /></a>Once you are logged in, when hovering over the log out link towards the top right, the username will appear in the list. This shows what user you are logged in as.<br style="clear: both;" /></p>
  <p class="alert"><strong>Note!</strong> If you are unable to login for whatever reason, please see the next article on <a href="http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help" target="_blank">how to reset your TikiWiki password</a>.</p>
</li>
</ol>
<p style="margin-top: 15px;">This concludes the article on how to log into TikiWiki. For more information visit our <a href="http://www.inmotionhosting.com/support/edu/tiki-wiki" target="_blank">TikiWiki education channel</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Logging into TikiWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help'>My TikiWIki login is not working</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDUmaWQ9MjA3NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Logging in and managing Tiki users</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
