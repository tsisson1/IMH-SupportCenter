<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66645:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/setting-up-payment-gateways/setting-up-payment-modules-in-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-18T03:14:30-08:00" />
  <meta name="keywords" content="payment module gateway options opencart paypal" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial you'll learn how to set up PayPal to process payments from your OpenCart website. " />
  <title>Setting up Payment Modules in OpenCart - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/setting-up-payment-gateways/setting-up-payment-modules-in-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2437d658e2fb16f1f9ba905c1e2a91bc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '93.54.82.92']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up Payment Modules in OpenCart									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>22,733</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 28, 2011'><span style='color:#606060;'>Published:</span> Dec 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>By now your OpenCart website should have your own <a href="/support/edu/opencart/installing-opencart-and-adding-products/adding-new-products-to-opencart">products installed</a> and your <a href="/support/edu/opencart/installing-opencart-and-adding-products/editing-the-information-pages-in-the-footer-of-opencart">store’s information pages customized</a>. Your next step would be to set up your payment modules so your customers have options when ordering from you. This is easily achieved in your OpenCart Dashboard. There are multiple payment options available to use so for this tutorial we’re going to show you how to configure PayPal. If you are looking at using another payment processing method, you'll want to contact them directly to learn more on how to set up OpenCart to process payments through their services.&nbsp;</p>
<ol>
...
<li>Go to <strong>Extensions &gt; Payments</strong></li>
<p><strong><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_payment_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_payment_1.jpg" alt="opencart_payment_1"  /></a></strong></p>
<p>You’ll notice a large list of options on the payment screen</p>
<li>Select the payment method you want by clicking the desired action on the right side. Since we’re using PayPal, select the “<strong>PayPal Standard</strong>” and click “<strong>Install</strong>”</li>
<li>Once the module has installed click on “<strong>Edit</strong>” in the right column</li>
<li>Fill in the fields on the screen. The only required field is “<strong>E-mail</strong>”. This is the email address you use for your PayPal account</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_payment_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_payment_2.jpg" alt="opencart_payment_2"  /></a></p>
<li>When finished click “<strong>Save</strong>”</li>
</ol>
<p>Congratulations! You’ve now configured your OpenCart shopping cart to receive payments. If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p>
<p>Need a hosting solution for OpenCart? Go to <a href="/support/../opencart-hosting.html" target="_blank">OpenCart Hosting Accounts with InMotion Hosting</a>!</p>
<p>&nbsp;</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/opencart/setting-up-payment-gateways'>103: Setting up a Payment Gateway</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Setting up Payment Modules in OpenCart</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/opencart/setting-up-payment-gateways/reward-points'>Working with Reward Points in OpenCart 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/opencart/setting-up-payment-gateways/how-to-enable-ssl-connection-in-opencart'>How to enable SSL connection in OpenCart</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/setting-up-payment-gateways/setting-up-payment-modules-in-opencart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/setting-up-payment-gateways/setting-up-payment-modules-in-opencart'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTImaWQ9MTA5OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="47530662e1541ef98dc8d59110764b7f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/opencart/setting-up-payment-gateways?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Setting up a Payment Gateway</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/opencart/setting-up-payment-gateways/reward-points?tsrc=rsbedu'>Working with Reward Points in OpenCart 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/opencart/setting-up-payment-gateways/setting-up-payment-modules-in-opencart?tsrc=rsbedu'>Setting up Payment Modules in OpenCart</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/opencart/setting-up-payment-gateways/how-to-enable-ssl-connection-in-opencart?tsrc=rsbedu'>How to enable SSL connection in OpenCart</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/0b9f8b475a60c1978a5c7753831f6e1b'>I did enable  PayPal but don&#039;t seem to become available as a option on chec</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-12 10:25 am</div>
				                <div><p>I did enable the PayPal option but don't seem to become available as a option on checkout ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10563);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-12 1:14 pm</div>
				                <div>Hello,<br />
<br />
Thanks for the question.  The Paypal module may not be appearing for many reasons.  Since you have given us basically no information on your website or your settings, we can only give you a general overview on possible causes:<br />
<br />
<ul><br />
<li>Make sure the Status is set to ENABLED- it's easy to miss as it's at the bottom of the module page</li><br />
<li>Make sure that TOTAL isn't set to some very high amount</li><br />
<li>Make sure that the Geo zone is NOT restricted in the settings</li><br />
</ul><br />
<br />
This is also discussed in the <a href="http://forum.opencart.com/viewtopic.php?t=61278" rel="nofollow" target="_blank">OpenCart forums</a>. There, the issue is related to currency.  They provide a couple of solutions as well.  Check out the posts if you continue to have the problem.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10578);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13938'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/45904a9e35c7b17edd4d74f8ebf3840e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/45904a9e35c7b17edd4d74f8ebf3840e'>stephanie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-13 1:45 am</div>
				                <div>I like to change my payment gateway from Authorize.net to Elavon.<br />
This article does not direct me there.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13938);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29092'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a9f9fe27954659a6b3dac0adbcac3322?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a9f9fe27954659a6b3dac0adbcac3322'>iulian</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-09 4:22 am</div>
				                <div><p>When redirecting to paypal to pay,in the header is the name websites,i want to change with another name,how can i change from opencart?Thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29092);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-09 9:16 am</div>
				                <div>You can't. Simply put the header shown on the PayPal page is related to the PayPal account you are connecting to. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29098);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
