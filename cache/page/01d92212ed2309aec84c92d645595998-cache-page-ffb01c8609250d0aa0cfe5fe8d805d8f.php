<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49676:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/put-and-delete-request-methods-blocked" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="The PUT and DELETE functions are not enabled on shared servers due to the secrity flaws involved with these functions. If you are on a VPS, you may cont..." />
  <title>PUT and DELETE request methods blocked | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/put-and-delete-request-methods-blocked" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:6c3927546c037d8eff6eeefaeb9b2898 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '202.131.106.50']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>PUT and DELETE request methods blocked</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/gregorymaggio@gmail&per;com'>gregorymaggio@gmail.com</a>
			<div>15 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-11-18 9:11 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,283</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>On the TailsHigh.org website, I have several REST services exposed (some through admin and others not). Since moving to inmotion hosting, I have not been able to use these methods (POST and GET work). I have tried several suggestions from the internet with no success. Is there something that you can do to enable PUT and DELETE methods, or is there a magic .htaccess configuration I can drop into my public_html folder?<br />
<br />
Thanks,<br />
Greg<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4235' id='upvote_answer_4235' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4235' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4235').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4235' id='downvote_answer_4235' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4235' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4235').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-11-18 10:18 am EST
                		        </div>
					
		                </div>

				The PUT and DELETE functions are not enabled on shared servers due to the secrity flaws involved with these functions.  If you are on a VPS, you may &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;contact technical support&lt;/a&gt; to have this enabled for you, however, please be aware that these functions can be potentially exploted to cause unauthorized changes to your site.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4235').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4235' id='form_comment_on_answer_4235' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/put-and-delete-request-methods-blocked&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/put-and-delete-request-methods-blocked'></div>
<script type='text/javascript'>
  (function() {
