<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52764:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/create-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="In this tutorial series, we will show you how to develop a Joomla 2.5 Content Plugin. We include lots of sample code to help get you started." />
  <title>215: Joomla 2.5 Content Plugin Development | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/create-plugin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:169521e7941884f315d1e6c8e7084db3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '37.58.168.242']);
...
<div class='page-header'>
	<h1>215: Joomla 2.5 Content Plugin Development</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/hello-world'>How to create a Hello World content plugin for Joomla 2.5</a>
					<div>In this first tutorial, we'll show you how to create and install a Joomla 2.5 plugin. In future tutorials, we'll describe what the plugin does in more detail.</div>
					<div class='smallgrey'>Hits: 30,502</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/change-plugin-name'>How to change the name of a Joomla 2.5 Plugin</a>
					<div>In this Joomla 2.5 tutorial, we'll show you how to change the name of a plugin. Most often the plugin name is shown in the Joomla 2.5 Admin</div>
					<div class='smallgrey'>Hits: 5,439</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/change-install-description'>How to change a Joomla 2.5 plugin installation description</a>
					<div>When you install a Joomla 2.5 plugin, a description about the plugin is shown after successful installation. In this tutorial, we'll show you how to change this installation message.</div>
					<div class='smallgrey'>Hits: 3,147</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/add-parameter'>How to add a parameter to a Joomla 2.5 plugin</a>
					<div>By adding parameters to your plugin, you can allow the user to change how your plugin works. In this tutorial, we'll allow someone to print alternative text, something else besides Hello World.</div>
					<div class='smallgrey'>Hits: 14,548</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/fieldsets'>Understanding Joomla 2.5 plugin parameter fields</a>
					<div>There are several attributes within Joomla 2.5 plugin parameters. For example, you should set a label, description, and type. We'll go over these attributes in this Joomla 2.5 tutorial.</div>
					<div class='smallgrey'>Hits: 4,936</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/where-values-stored'>Where is Joomla 2.5 plugin information stored?</a>
					<div>Joomla 2.5 parameter data is stored in the _extensions table. In this creating a plugin tutorial we'll show you how a plugin is stored in the database.</div>
					<div class='smallgrey'>Hits: 11,888</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/parameter-types'>Basic parameter types in a Joomla 2.5 plugin</a>
					<div>When creating Joomla 2.5 plugin parameters, the most common input types are text, radio, and lists. In this tutorial we'll give you example usage of each of these.</div>
					<div class='smallgrey'>Hits: 6,363</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/fieldset-names'>Using fieldsets to separate plugin paramenters in Joomla 2.5</a>
					<div>Using fieldsets, you can separate your plugin parameters into Basic Options and Advanced Options. We'll go over fieldset names more in this plugin tutorial.</div>
					<div class='smallgrey'>Hits: 9,940</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/spacers'>Using Spacers to separate plugin parameters in Joomla 2.5</a>
					<div>You can use spacers in a Joomla 2.5 plugin's xml file to separate parameters. We'll show you how to use spacers in this plugin tutorial.</div>
					<div class='smallgrey'>Hits: 3,707</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/html-and-links'>Inserting HTML and links in a Joomla 2.5 plugin settings page</a>
					<div>Usage a spacer field type, you can add HTML and links within a plugin's settings page in Joomla 2.5</div>
					<div class='smallgrey'>Hits: 4,985</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/content-plugin-events'>Joomla 2.5 content plugin events</a>
					<div>Your Joomla 2.5 content plugin's PHP code can be executed at different points in the article setup. You can run your code before the article is printed, and at certain points during and after the content is printed to the screen.</div>
					<div class='smallgrey'>Hits: 12,751</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/variables'>Joomla 2.5 content plugin variables</a>
					<div>When writing a Joomla 2.5 content plugin, you have access to all of the article's details. In this tutorial we'll go into more detail about the variables and objects passed to your plugin functions.</div>
					<div class='smallgrey'>Hits: 6,131</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/changing-text-using-oncontentprepare'>Use onContentPrepare to change Article text in a Joomla 2.5 plugin</a>
					<div>Within a onContentPrepare content plugin function, you can access an article's text and introtext and change it.</div>
					<div class='smallgrey'>Hits: 11,786</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/add-stylesheet'>How to add a css StyleSheet to a Joomla 2.5 content plugin</a>
					<div>You can use the addStyleSheet document function to add external css stylesheets to your Joomla 2.5 plugin.</div>
					<div class='smallgrey'>Hits: 17,951</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-plugin/add-javascript'>How to add external js javascript files to a Joomla 2.5 plugin</a>
					<div>Using the addScript function, you can setup your Joomla 2.5 plugins to include external js files in your document's header.</div>
					<div class='smallgrey'>Hits: 15,651</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTcmaWQ9MjE3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="38dab85a8c4f76f31d1c5bf43b482483" value="1" />	</div>
	</form>
<!-- <br />
