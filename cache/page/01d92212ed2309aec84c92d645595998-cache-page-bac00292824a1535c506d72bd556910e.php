<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:77916:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/removing-branded-logo" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-11T12:40:33-07:00" />
  <meta name="keywords" content="Moodle 2.3 themes branded logo  bottom  remove brand link  theme disable delete removing deleting disabling" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="In most Moodle 2.3 themes, the Moodle branded logo is shown at the bottom of each page. This article will explain how to remove the branded Moodle link at the bottom of a theme." />
  <title>Removing the branded Moodle image from a theme footer - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/removing-branded-logo" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:518e9db543330c0e64231efa227b3fbe -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '104.251.107.218']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Removing the branded Moodle image from a theme footer									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,258</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 28, 2012'><span style='color:#606060;'>Published:</span> Jun 11, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In most <a href="/support/edu/moodle/changing-appearance-moodle">Moodle themes</a>, the Moodle branded logo is shown at the bottom of each page. When making a Moodle site for a college or another professional setting, the logo is typically not wanted at the bottom of the page. The logo can be removed from the theme. </p>
<p>Depending on the type of theme, the logo can be removed either through the Moodle Site administration section or through the code on the server. This article will explain how to remove the Moodle branded logo from 2 different themes: <strong>Formal White</strong> (Done through the Site Administrator) and <strong>Afterburner</strong> (Done through the code).</p>

<h3>Removing the Moodle brand logo through the Theme properties</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-1-with.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="remove-branding-1-with-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-1-with.gif" title="Click here to view the larger image" width="200" /></a> Many themes have the option to edit the theme properties through the Moodle Site administration section. In the <strong>Appearance</strong> &gt; <strong>themes section</strong>, the theme can be selected and edited through the dashboard. In this case, the <strong>Formal White</strong> theme will be used as an example.</p>
<p>The image to the right shows what the Theme looks like with the Moodle link at the bottom of the page. There are many reasons to remove the link. This link can be removed through the Moodle site administration.<br style="clear: both;" /></p>
<h3>Steps to edit in the Moodle Site administration</h3>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/moodle/new-to-moodle/moodle-login-administrator" title="Click for more information">Log into the Moodle Dashboard</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-2-select.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-2-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-2-select.gif" title="Click here to view the larger image" width="200" /></a><strong>Select</strong> <strong>Site administration</strong> &gt; <strong>Appearance</strong> &gt; <strong>Themes</strong> &gt; <strong>Formal white</strong> in the <strong>Settings</strong> on the left. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-3-never.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-3-never-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-3-never.gif" title="Click here to view the larger image" width="200" /></a> On the theme properties page, <strong>Select never</strong> from the <strong>Display credits to moodle.org</strong> box. <strong>Save changes</strong>.<br style="clear: both;" />
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-4-clear-cache.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-4-clear-cache-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-4-clear-cache.gif" title="Click here to view the larger image" width="200" /></a>Next, make sure the theme cache is cleared for the changes to show on the site. Go to <strong>Site administration</strong> &gt; <strong>Appearance</strong> &gt; <strong>Themes </strong>&gt; <strong>Theme selector</strong>.
<p><strong>Click Clear theme caches</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-5-without.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-5-without-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-5-without.gif" title="Click here to view the larger image" width="200" /></a> Now the Moodle brand logo will not display at the bottom of the theme any more.</p>
<br style="clear: both;" /></li>
</ol>
<h3>Removing the Moodle brand logo through the code</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-6-afterburner.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-6-afterburner-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-6-afterburner.gif" title="Click here to view the larger image" width="200" /></a>Another way to remove the Moodle branded link in the theme is to <a href="/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code">comment them out through the code</a> on the server. An example of a theme that does not have the ability to remove the Moodle branded link at the bottom of the template is the <strong>Afterburner</strong> theme.</p>
<p>The image to the right shows the Moodle logo at the bottom of the Afterburner theme. This cannot be removed through the Moodle Site administrator. Because the option is not in the Moodle dashboard, the code will need to be edited on the server. Simply commenting out the line of code will cause the image to not display in the site.<br style="clear: both;" /></p>
<h3>Steps to edit the code</h3>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for more information">Log into cPanel</a>. Navigate to the theme in the file manager on the server. The file to edit is:
<p>theme/afterburner/layout/default.php</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-7-foot.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-7-foot-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-7-foot.gif" title="Click here to view the larger image" width="200" /></a><strong>Navigate to the lines where the footer is located.</strong>In this case its on line 117. Moodle will show where the footer begins with the following comment:
<pre>&lt;!-- START OF FOOTER --&gt;</pre>
The code to Comment out is highlighted in the image to the right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-8-comment.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-8-comment-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-8-comment.gif" title="Click here to view the larger image" width="200" /></a> Comment the lines similar to the snapshot to the right. HTML comments have: &lt;!-- (before the code) and --&gt; (After the code).
...
<p><strong>Save the changes</strong>.</p><br style="clear: both;" /></li>
<li>Next, makes sure the theme cache is cleared for the changes to show on the site. Go to <strong>Site administration</strong> &gt; <strong>Appearance</strong> &gt; <strong>Themes</strong> &gt; <strong>Theme selector</strong>.
<p><strong>Click Clear theme caches</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-9-gone.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-branding-9-gone-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/removing-branded-logo/remove-branding-9-gone.gif" title="Click here to view the larger image" width="200" /></a> Now the Moodle brand logo will not display at the bottom of the <strong>Afterburner</strong> theme any more.</p>
<br style="clear: both;" /></li>
</ol>
<p>Congratulations, the link to Moodle at the bottom was removed from the theme. This concludes the article for Removing the Moodle branded logo from the bottom of a theme.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Removing the branded Moodle image from a theme footer</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/moodle/changing-appearance-moodle/manual-theme-install'>Manually installing a theme for Moodle 2.3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/moodle/changing-appearance-moodle/change-theme-font'>Changing the default font in the Moodle Standard theme</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/removing-branded-logo&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/removing-branded-logo'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTQmaWQ9MjAxOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d186c496782274568e5a3904081965a2" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/77c701e5afeaa1e6daf27e433811a588?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/77c701e5afeaa1e6daf27e433811a588'>moodletheme</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 3:23 am</div>
				                <div><p>very nice.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11688);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12493'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/465b3ef1fa4eed021fbf0072b4013ab0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/465b3ef1fa4eed021fbf0072b4013ab0'>David Jumeau</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 11:45 am</div>
				                <div>I removed the logo by commenting out the following PHP code found in the php files in the &quot;layout&quot; folder:<br />
/* echo $OUTPUT-&gt;home_link(); */</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12493);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17105'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/94c28f10e41ac866b9119b9d66f228e1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/94c28f10e41ac866b9119b9d66f228e1'>banjole</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-05 4:34 am</div>
				                <div><p>Thank you David!!! That's it!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17105);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22630'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b63923e07c92d4cac132f049d9a5c448?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b63923e07c92d4cac132f049d9a5c448'>Scotty</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-14 2:54 am</div>
				                <div><p>Finding the code is sometimes hard for people, but this is a nice way of getting rid of the other things like the login info.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22630);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24193'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8badb950808556eba8564e36d153d251?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8badb950808556eba8564e36d153d251'>PJ</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-14 11:46 am</div>
				                <div><p>I don't follow the instructions in moodle 2.9 I don't see the formal white in the admin under themes and in the file manager I don't see the file Themes/afterburner</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24193);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-15 3:00 pm</div>
				                <div>Hello PJ,<br />
<br />
Those two themes are not required, but were used for demonstration purposes.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24228);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
