<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60415:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/installing-dokuwiki-manually" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:44:49-07:00" />
  <meta name="keywords" content="install DokuWiki manually installing manual set up setting setup" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This tutorial will explain how to install DokuWiki on your server manually." />
  <title>Installing DokuWiki Manually - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/installing-dokuwiki-manually" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:da54cb79ae6578e220a68d587aac246e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '141.171.134.30']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing DokuWiki Manually									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,261</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 7, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>DokuWiki is an open source software designed to bring wiki based software with less server tasking capabilities. What this means is, DokuWiki has less processes required to run the software that allow the server to run faster and more efficient. The major benefit to DokuWiki is the fact that all the files that run DokuWiki are saved in PHP files, instead of storing the content in a Database.</p>
<h3>Manually installing DokuWiki</h3>
<ol class="article_list">
<li>To get started installing DokuWiki on your server, <strong>download the software from the DokuWiki site</strong> at the following URL. you will need to <strong>select the dokuwiki-2012-10-13.tgz “Adora Belle”</strong> link on the "<em>This is the last “stable” version of DokuWiki</em>" section.
<div style="margin-left: 20px;">
<p><a href="http://www.splitbrain.org/projects/dokuwiki" title="Download DokuWiki" target="_blank"><strong>Download DokuWiki</strong></a></p>
</div>
<p>Once the DokuWiki site files are downloaded, the file should be named the following:</p>
<div style="margin-left: 20px;">
<p><strong>dokuwiki-2012-10-13.tgz</strong></p>
</div>
<p>After downloading the DokuWiki files, you can upload and install the program on your server. Let's set up DokuWiki on your server now.</p>
</li>
<li>If you are not installing DokuWiki on the main domain or an Addon domain, <a href="/support/website/cpanel/how-do-i-create-a-subdomain-in-my-control-panel-cpanel" target="_blank" title="click here for How to create a subdomain">Create a subdomain</a> for the DokuWiki site.</li>
<li><a href="/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel" target="_blank" title="Click here for how to upload in File Manager">Upload the dokuwiki-2012-10-13.tgz</a> file through the cPanel and <a href="/support/website/cpanel/compressing-uncompressing-files" target="_blank" title="Click here for how to extract a zip file in File Manager">extract the file to the server</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="install-dokuwiki-manually-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-1.gif" title="Click here to view the larger image" width="100" /></a>Next, visit the domain that DokuWiki was uploaded to in your browser. The url for the installation is:
<p>yoursiteshere.com/install.php</p>
<p>Replacing example.com with the domain you set up for DokuWiki.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-dokuwiki-manually-2" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-2.gif" title="Click here to view the larger image" width="100" /></a>On the <strong>DokuWiki installer </strong>page, fill in the Administrative login information.<br style="clear: both;" />
<table>
<tbody>
<tr><th colspan="2">Admin login specifications</th></tr>
<tr>
<td><strong>Wiki Name:</strong></td>
<td>This is the site name for your wiki.</td>
</tr>
<tr>
<td><strong>Superuser:</strong></td>
<td>Administrator username for login.</td>
</tr>
<tr>
<td><strong>Real Name:</strong></td>
<td>The name that will display on the website when writing articles.</td>
</tr>
<tr>
<td><strong>E-mail:</strong></td>
<td>The email that will receive contact form submittals and other notifications.</td>
</tr>
<tr>
<td><strong>Password:</strong></td>
<td>This is the password for the DokuWiki admin login.</td>
</tr>
<tr>
<td><strong>Initial ACL policy:</strong></td>
<td>This can be open, closed, or public. Select Open Wiki.</td>
</tr>
<tr>
<td><strong>License type:</strong></td>
<td>Leave the default, CC Attribution-Share Alike 3.0 Unported.</td>
</tr>
</tbody>
</table>
<p><strong>Click Save</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-dokuwiki-manually-3" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-3.gif" title="Click here to view the larger image" width="100" /></a>Now the DokuWiki installer will display "<strong>The configuration was finished successfully.</strong>"
<p><strong>Click the "<em>your new DokuWiki</em>" link</strong>.</p>
<p>Go to your server folder where DokuWiki was installed and <strong>delete the install.php file</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-4.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-dokuwiki-manually-4" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/install-dokuwiki-manually/install-dokuwiki-manually-4.gif" title="Click here to view the larger image" width="100" /></a>Now when visiting the domain DokuWiki was installed on, The site will look like the snapshot to the right.
<p>Congratulations, your new DokuWiki site was installed successfully.</p>
<br style="clear: both;" /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Installing DokuWiki Manually</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/dokuwiki/geting-started-dokuwiki/install-dokuwiki-softaculous'>Installing DokuWiki with Softaculous</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki'>How to log into DokuWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/installing-dokuwiki-manually&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/installing-dokuwiki-manually'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDQmaWQ9MjA2MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
