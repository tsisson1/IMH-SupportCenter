<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:86686:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/getting-started-guides/unlimited-disk-space-and-bandwidth" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="unlimited diskspace disk space bandwidth policy" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="You get unlimited disk space and bandwidth with your shared-hosting account, but it's important to know what you can store on the server under this policy." />
  <title>Unlimited Disk Space and Bandwidth - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/getting-started-guides/unlimited-disk-space-and-bandwidth" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6309636384924510846eb81706c44979 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '202.58.99.21']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Unlimited Disk Space and Bandwidth									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,404</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 3, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>All InMotion Hosting <a href="http://www.inmotionhosting.com/business-hosting" target="_blank">business hosting</a> accounts come with <strong>unlimited disk space and bandwidth</strong>. The term <strong>unlimited</strong> as it relates to your hosting account is mentioned in our <a href="http://www.inmotionhosting.com/terms-of-service" target="_blank">terms of service</a> as the following:</p>

<p><em>"While IMH does not meter disk space &amp; bandwidth, the purpose of an IMH hosting account is to host web sites. Using a hosting account primarily for online file storage or archiving electronic files is prohibited.</em></p>

<p><em>IMH Personal &amp; Business Class hosting are shared hosting environments, so to ensure fast &amp; reliable service to all of our clients, accounts that adversely affect server or network performance must correct these issues or will be asked to upgrade to a virtual or dedicated server."</em></p>

<h2>What files can I store on the web-server?</h2>

<p>As long as your files tie directly into your website, are legal under US law, and are linked to and displayed on your website, then you can store them on your account.</p>

<p>Where possible issues arise is when one user attempts to offload all of their storage needs onto the web-server. It's important to realize that a web-server, and our hosting network is optimized to handle website related files.</p>

<p>For instance if you have a folder with <strong>25GB</strong> worth of pictures you've taken with your camera over the years. simply uploading these thousands upon thousands of images to your <strong>/public_ftp</strong> directory for storage is not related to your website. At that point you'd simply be utilizing the web-server as a file repository.</p>

<h2>Why don't I want to store everything on the web-server?</h2>

<p>One important factor why you don't want to cluter up your web-hosting account with un-related files is that our <a href="http://www.inmotionhosting.com/support/website/backup-and-restore/automatic-remote-backup-service" target="_blank">automatic remote backup service</a> is only free on accounts <strong>under 10GB</strong> in size.</p>

<p>As a shared-hosting customer you share the total web-server resources such as disk space with other customers. As such if everyone decided to upload all of their home photos to the web-server, things could quickly fill up, and you might not have room for store logos, or actual website related content.</p>

<p>Also last but not least, there are storage services available online where the specific purpose of those networks are to store mass volumes of backup data. Offloading your online storage needs to these types of services is generally easier to manage and keep track of than managing your files over FTP.</p>

<h2>Online file storage services</h2>

<p>If you spend a few minutes searching online you can find a ton of great online storage services that specialize in allowing you to upload non-website related files onto their networks. Here are a few we've heard customers use:</p>

<table class="article_table">
<tr>
    <th>Storage Service</th>
    <th>Free storage</th>
    <th>Upgraded storage</th>
</tr>
<tr>
    <td><a href="https://www.google.com/settings/storage" target="_blank">Google Drive</a></td>
    <td>15GB</td>
    <td>100GB $4.99/month</td>
</tr>
<tr>
    <td><a href="https://www.dropbox.com/upgrade" target="_blank">Dropbox</a></td>
    <td>15GB</td>
    <td>100GB $9.99/month</td>
</tr>
<tr>
    <td><a href="https://www.box.com/pricing/" target="_blank">Box</a></td>
    <td>10GB</td>
    <td>100GB $5/month</td>
</tr>
</table>
...
<p>If you have a lot of traffic to your website, having your static content like <strong>images</strong>, and <strong>videos</strong> hosted on a <strong>CDN</strong> or <strong>Content Delivery Network</strong> can help ensure that your website loads faster for visitors, by loading this content from a closer geographical location to them.</p>

<p>Here are a few popular CDNS we've seen customers use:</p>
...
<tr>
    <td><a href="http://aws.amazon.com/cloudfront/" target="_blank">Amazon CloudFront</a></td>

</tr>
<tr>
    <td><a href="https://www.cloudflare.com/features-cdn" target="_blank">CloudFlare</a></td>
</tr>
<tr>
    <td><a href="http://www.cachefly.com/" target="_blank">CacheFly</a></td>
</tr>
<tr>
    <td><a href="http://www.maxcdn.com/" target="_blank">MaxCDN</a></td>
</tr>
<tr>
    <td><a href="http://www.edgecast.com/" target="_blank">EdgeCast</a></td>
</tr>
</table>

<p style="margin-top: 15px;">Hopefully you now have a clearer understanding of what files you can store on your account, and at times when you might need to seek out a 3rd party service for further online storage needs.</p>

<p>If you have any good or bad experiences from any of the services listed above, or have used one we don't mention here, please comment below and share your experiences with us!</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/getting-started-guides/unlimited-disk-space-and-bandwidth&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/getting-started-guides/unlimited-disk-space-and-bandwidth'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MiZpZD0zMDE2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="ecade973cfda98c36945107f8e87e2d4" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/resources/bandwidth-overuse?tsrc=rsbraq'>What happens if I go over bandwidth limits?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b4b0e2e2f8a15499752aba70f1aa433e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b4b0e2e2f8a15499752aba70f1aa433e'>Mark</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-11 10:47 am</div>
				                <div><p>CDN is a gaff, in the sense that you pay a about 1,000 to 5,000 times your normal hosting fee for some service you can only hope is helping. CD is sketchy at the best of times. At home, my PC publishing machine opens my InMotion site in 0.5 seconds. Same room, same network cable, my Mac takes 30 seconds. Wander across street to Stabucks and load time is almost two minutes. Same ISP company and service provisions, three different access devices.</p>
<p>InMotion support was very helpful in getting a grip on such disparity. InMotion pointed me to GTmetrix.com where my overall speed result is A, but&nbsp;a&nbsp;few&nbsp;of my scores are F's. Must be that rotten download times correspond with&nbsp;access where local environmental factors cull&nbsp;'F'&nbsp;score server behaviors, thus resulting poor&nbsp;download speed. Factors that no CDN can control.</p>
<p>Given a specfifc device on a specific connection, connection speeds are more stable than ever before. Still, CDN can never account for extrinsic local environmental factors that so obviously govern download speed. Becuase quite simply, no one&nbsp;yet understands even what those factors are. Let alone, have the ability to&nbsp;control their influence.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11400);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-28 3:58 am</div>
				                <div>Hello Mark,<br />
<br />
A CDN can be very useful if you have visitors from all around the globe. They help distribute your content to datacenters that are closer geographically to where a visitor is requesting your site from, and they also reduce the need for a single web-server to handle all content requests.<br />
<br />
Local network speed is always going to be a big factor with how quickly your website is loaded, but a CDN can help greatly in normalizing the server to client response time the average visitor to your website achieves.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12101);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-06 4:44 pm</div>
				                <div><p>Jacob, Yes, I was short-sighted. I guess it stand to reason that if they are lamenting their Starbuck&nbsp;250Kb connection, they would prefer all websites to use CDN!&nbsp;</p>
<p>Yet, CDN has limitations. For example, if we want to "edge" the CDN (create a dedicated site where all content is optimized, we immediately limit service to IE8+ browsers. Whishs in the real world means IE9+ on Windows Pro. However, the edged platform delivers four (4) times as fast. Which makes our Stabuck visitors feel like they are connecting at 2mbps. 2007 cable Internet connection speed!</p>
<p>Another important limitation is lack of streaming service. In response to the globle economic downturn, CDN services&nbsp;have&nbsp;stopped providing&nbsp;"edge" hosting as a standard service.&nbsp;So CDN fees dropped $40 a month. Now visitors and&nbsp;their Server Support staff have to look after the CDN storage headaches.</p>
<p>Edge is still available, but that puts your cost right back up. Oh, don't forget that to host edge service for the CDN, you need a security certificate from your web server, or for about a hundred CDN will both certify your security and host your goods.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17170);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-18 11:50 am</div>
				                <div>am having problems with my amazon cloudfront</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16447);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-19 9:34 pm</div>
				                <div>Hello Iamkingsleyf,<br />
<br />
Thank you for your question. We are happy to help, but need more detailed information to really assist you.<br />
<br />
What problems are you having?<br />
<br />
Are you getting errors? What errors are they?<br />
<br />
Can you provide a link to the error?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16466);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26803'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5b192b63b7840ff493865e225788757c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5b192b63b7840ff493865e225788757c'>Robert</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-20 4:38 am</div>
				                <div><p>Is there any way for the backup to selectively target only what's needed?&nbsp; For example, if I'm running a photo-heavy site that has a total of 35Gb but 30 of that is the photos that are static and don't really need to be backed up (since I have copies on my PC or a cloud storage service), can the other 5Gb still be backed up?</p>
<p>For that matter, would that 35Gb going to run afoul of the "unlimited" limit, even if it's all part of the web site?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26803);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-21 2:28 pm</div>
				                <div>Hello Robert,<br />
<br />
The server backup system backs up the entire account, it cannot separate sections. You may be able to code one that does, however.  The total size of the account is what is included when looking to the backup limit. So 35GB would be 25GB above the 10GB 'free' limit. This would require purchasing 30GB of backups (10GB free + 25GB of additional).<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26835);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/shawnhar'>shawnhar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-28 11:59 am</div>
				                <div>I have 2 domains and 2 sites an the power plan, one will use very little bandwidth or storage, the other could exceed 30 gig and have large downloads, probably only 20 people tops would ever download the files and not all at once, and I am not worried about the backup, but is there any chance the one with 30 gigs and large downloads could affect the smaller one? I mean if by some chance I have 200 gigs of data for download on the big one, is there any scenario where it could cause the smaller website to go down or be offline due to my heavy usage of the big one?<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27952);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-28 12:26 pm</div>
				                <div>Hello Shawnhar,<br />
<br />
...
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27955);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='/support/images/avatars/default_avatar.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/brianleejackson'>brianleejackson</a></div>
						<div><a href='https://twitter.com/brianleejackson' target='_blank'><img src='//www.inmotionhosting.com/img/icon-twitter.png' style='width:20px;' /></a><a href='https://www.facebook.com/brianleejackson/' target='_blank'><img src='//www.inmotionhosting.com/img/icon-facebook.png' style='width:20px;' /></a></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-05 2:36 pm</div>
				                <div>I would highly recommend adding KeyCDN to this list. One of the first providers to support HTTP/2 and also Let's Encrypt integration. Plus they have lowest global cost at $0.04/GB.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29575);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
