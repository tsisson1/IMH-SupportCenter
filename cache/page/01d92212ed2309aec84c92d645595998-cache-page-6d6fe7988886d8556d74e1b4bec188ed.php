<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61077:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/blogging/install-enable" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-11T15:29:12-08:00" />
  <meta name="keywords" content="drupal 8 blog set up enable install" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Blogging has changed slightly in Drupal 8, learn how to get it set up with this tutorial." />
  <title>Installing and Enabling the blog module in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/blogging/install-enable" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9df74d54295871fc73f107a9eed779f9 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/drupal-8' itemprop='url'><span itemprop='title'>Drupal 8<span></a><div class='dropdown_4columns'><h2>Drupal 8 Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/drupal-8/news'>100: Drupal 8 News</a></div><div><a href='/support/edu/drupal-8/getting-started'>101: Getting Started with Drupal 8</a></div><div><a href='/support/edu/drupal-8/create-content'>102: Managing Content in Drupal 8</a></div><div><a href='/support/edu/drupal-8/homepage'>103: Working with your Drupal 8 homepage</a></div><div><a href='/support/edu/drupal-8/menus'>104: Working with Menus in Drupal 8</a></div><div><a href='/support/edu/drupal-8/themes'>105: Managing and working with Drupal 8 themes</a></div><div><a href='/support/edu/drupal-8/users'>106: Managing users in Drupal 8</a></div><div><a href='/support/edu/drupal-8/comments'>107: Working with Comments in Drupal 8</a></div><div><a href='/support/edu/drupal-8/108-managing-images-in-drupal-8'>108: Managing Images in Drupal 8</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/drupal-8/modules'>201: Working with Modules in Drupal 8</a></div><div><a href='/support/edu/drupal-8/forums'>202: Working with forums in Drupal 8</a></div><div><a href='/support/edu/drupal-8/contact-form'>203: Managing contact forms in Drupal 8</a></div><div><a href='/support/edu/drupal-8/blogging'>204: Blogging in Drupal 8</a></div><div><a href='/support/edu/drupal-8/common-settings'>205: Managing common settings in Drupal 8</a></div><div><a href='/support/edu/drupal-8/rss-feed'>205: Working with RSS Feeds in Drupal 8</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/drupal-8/blogging' itemprop='url'><span itemprop='title'>204: Blogging in Drupal 8<span></a><div class='dropdown_3columns'><h2> Blogging in Drupal 8</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/drupal-8/blogging/install-enable'>Installing and Enabling the blog module in Drupal 8</a></div><div>2. <a style='display:inline;' href='/support/edu/drupal-8/blogging/create-entry'>Creating a blog entry in Drupal 8</a></div><div>3. <a style='display:inline;' href='/support/edu/drupal-8/blogging/create-comment-section'>Creating a comment section for your blog posts.</a></div><div>4. <a style='display:inline;' href='/support/edu/drupal-8/blogging/disable-comment-single-entry'>Disabling comments for specific blog entries in Drupal 8</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Installing and Enabling the blog module ...</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Installing and Enabling the blog module in Drupal 8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,445</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 11, 2013'><span style='color:#606060;'>Published:</span> Nov 11, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Blogging is one of the more popular online activities and the main reason some people create a website. For Drupal 8, however, the <em>Blog</em> module was removed from the core files. This in no way means that blogging is disabled or cannot be done within Drupal 8. You can find the <em>Blog</em> module at <em>http://drupal.org/project/blog</em> and can install and enable it in your website. Follow the instructions below as we guide you on how to install and enable the <em>Blog</em> module in Drupal 8.</p>

<h2>Installing the Blog module</h2>

<ol class="article_list">
<li>First, you want to find the <em>Blog</em> module. This is located at <a href="http://drupal.org/project/blog">http://drupal.org/project/blog</a>. <div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/1-blog-module-page.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/1-blog-module-page.png" title="Click here to view the larger image" width="200" /></a>Look to the lower section of the page, under the <em>Downloads</em> section. Locate the version you want to install. Currently, there is only one available, the development release. Hover over your choice of download, in our case we will choose the zip version. Right click on the link and choose the <strong>Copy Link Location</strong> link. Your browser may have a different wording, but make sure you save the link location as  you will be using that URL later. <div style="clear:both;"></div></li>

<li>Once you have the link safely stored on your clipboard memory, <a href="/support/edu/drupal-8/getting-started/admin-login">log into your Drupal 8 admin interface</a>.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png" title="Click here to view the larger image" width="200" /></a>From the the topmost  menu bar, select <strong>Menu</strong><div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-extend.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-extend.png" title="Click here to view the larger image" width="200" /></a>Next, click on the the <strong>Extend</strong> link from the second menu bar that appears.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/2-click-install-button.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/2-click-install-button.png" title="Click here to view the larger image" width="200" /></a>You are now on the <em>Extend</em> page where available modules are listed. Since the <em>Blog</em> module is not listed, we need to install it. Look to the top of the page and click the <strong>Install new module</strong> button.
<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/3-enter-url.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/3-enter-url.png" title="Click here to view the larger image" width="200" /></a>This is the installation screen. Since you have the specific URL of the blog module file, enter it into the field labeled <strong>Install from a URL</strong>. Once entered, click the <strong>Install</strong> button at the bottom of the screen. This will install the module to your extensions list.<div style="clear:both;"></div></li>
</ol>


<h2>Enable the blog module</h2>
<p>Now that the <em>Blog</em> module has been installed into your Drupal 8 site, it is now time to enable it so you can begin to create blog specific content.</p>

<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-extend.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-extend.png" title="Click here to view the larger image" width="200" /></a>As previously, click on the the <strong>Extend</strong> link from the second menu bar at the top of the screen.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/4-enable-blog.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/4-enable-blog.png" title="Click here to view the larger image" width="200" /></a>Once again we are on the <em>Extend</em> page for available modules. This time, scroll down past the <em>Core</em> list of modules and you will see a section labeled <em>Other</em>. Here you will see the <strong>Blog</strong> module. Click on the checkbox to the left of the module to enable it.<div style="clear:both;"></div></li>
<li>Once checked, click on the <strong>Save configuration</strong> button to save the setting and activate the module. This will now allow a <em>Blog page</em> content type to be available when creating new nodes.

<table class="article_table">
<tr><th>Before</th><th>After</th><tr>
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/before.png"><img  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/before.png" title="Click here to view the larger image" width="200" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/after.png"><img  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/204/install-enable-blog/after.png" title="Click here to view the larger image" width="200" /></a></td></tr>
</table>
 ...
 <div style="clear:both;"></div></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-8/blogging'>204: Blogging in Drupal 8</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Installing and Enabling the blog module in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-8/blogging/create-entry'>Creating a blog entry in Drupal 8</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/blogging/install-enable&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/blogging/install-enable'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NzUmaWQ9Mjk1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7ceb8ec8952699cf1d9c5801a3f800b8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-8/blogging?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Blogging in Drupal 8</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-8/blogging/install-enable?tsrc=rsbedu'>Installing and Enabling the blog module in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-8/blogging/create-entry?tsrc=rsbedu'>Creating a blog entry in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-8/blogging/create-comment-section?tsrc=rsbedu'>Creating a comment section for your blog posts.</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-8/blogging/disable-comment-single-entry?tsrc=rsbedu'>Disabling comments for specific blog entries in Drupal 8</a></td>
                </tr>
          	</table>
