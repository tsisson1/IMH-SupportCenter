<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:83354:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/author" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-12T15:01:59-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>@author - Joomla DocBlock headers - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/author" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2014-06', 3]);
	...
	<!-- cid:21a3eb523d8f730e589d5ebfb0a3fb5f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '157.55.39.124']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															@author - Joomla DocBlock headers									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>108</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 12, 2014'><span style='color:#606060;'>Published:</span> Jun 12, 2014</div>
...
<ul>
  <li>This article is supporting documentation for our tutorial, <a href='/support/edu/joomla-3/docblocks'>using DocBlocks in Joomla</a>.</li>
  <li>There is <a href='http://joomla.github.io/coding-standards/?coding-standards/chapters/docblocks.md' target='_blank'>official documentation</a> that references what headers to use in your DocBlocks (such as @copyright and @license), but documentation is missing that outlines what values to use for each header.</li>
  <li class='alert alert-success'>In an effort to learn what values to use per each header, we have scanned the Joomla code and pulled out how each header is used. The idea behind this page is to show you how the <strong>@author</strong> tag has been used in the past within the Joomla code so learn how to use it in your future documentation.</li>
</ul>


  <h2>Value Count</h2>
  <p>The following table shows the various different values for <strong>@author</strong>, and how many times each value has been used.</p>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#549c660a54048a304ccf55c8589dcdd3'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#67c7322cac543cec18c41afe9288e680'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#8509848e4fb81e65fae1575c9486d3bd'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#fa7e3c5cc067c58f5dcdb56ad861aaf8'>
      * @author Andy Prevost
    </a>
  </td>
  <td>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#85600812569b70ce98ad298a4b5202b6'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#409ac694425ddb23bc840b7a8e7a6bb2'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#f1ac33405ce43a698ce6eda753b1c9d6'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#aa9f5470a77721bf50e9278072120787'>
      * @author Rouven We&Atilde;�ling &lt;me [at] rouvenwessling.de&gt;
    </a>
  </td>
  <td>
    3
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#4329994a204d1981202b20bda2232af2'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#3f6c8f9f11b2a371e11819d36c6c4580'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#a72fac36018dfcaa0e81cb879ce07024'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#40e56b7449ec226a940ca0eea2d47487'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#8c7011d9bee968353477a9abbca18f0c'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#cf5e3d96b635f0aeb7cad4913bd01799'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#1eaa60217b4f4f2e66694a3c333ef053'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#5e29920bf0eba722cb5da5c790c079f9'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#c9a300dbf4f54176db9f457fe5ca654d'>
      * @author Matthias Sommerfeld, &lt;mso@phlylabs.de&gt;
    </a>
  </td>
  <td>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#315cd831a94d957eb5d5555f79661e37'>
      * @author Matthias Sommerfeld  &lt;mso@phlyLabs.de&gt;
    </a>
  </td>
  <td>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#9572e438961b579156fa8abec3a8ac30'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#1cd8f614ff83d986f045741103ff82b9'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#ddd11c7832824d508a1a495949fff4b5'>
      * @author Nicholas
    </a>
  </td>
  <td>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#599130524f664cddaa28b66cc5c90651'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#350ac68cde440cbefc07fe540468a65f'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#f935870ac27511a0f4ed89edc614645f'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#f6ddaceceed9535fd31cc409faee3c9f'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#fb3de7a74a8059836523a220cb70f6b5'>
      * @author Chris Ryan
    </a>
  </td>
  <td>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#2fa46549f9feb052b6293fc392bb842e'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#12adf302d22f2924ef4989273dc4db3f'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#cbfaeb5f0f9d3d6c368b57ca05b99683'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#3a67a6bbd18028c99314f919f4ca2bf2'>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#4db617fd69ba192fa6566ad40097d775'>
      * @author Ryan Parman
    </a>
  </td>
  <td>
...
<tr>
  <td style="font-family:'Courier New', Courier, monospace">
    <a href='#b2eed24cb8500506be17cdb0b4c0911b'>
  ...
  <td>
    ...
    <a name='549c660a54048a304ccf55c8589dcdd3'></a>
    <h3>Andreas Gohr &lt;andi@splitbrain.org&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Andreas Gohr &lt;andi@splitbrain.org&gt;</span><br />
has been used a total of 7 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phputf8/utils/specials.php:* @author Andreas Gohr &lt;andi@splitbrain.org&gt;
libraries/phputf8/utils/ascii.php:* @author Andreas Gohr &lt;andi@splitbrain.org&gt;
libraries/phputf8/trim.php:* @author Andreas Gohr &lt;andi@splitbrain.org&gt;
libraries/phputf8/trim.php:* @author Andreas Gohr &lt;andi@splitbrain.org&gt;
libraries/phputf8/trim.php:* @author Andreas Gohr &lt;andi@splitbrain.org&gt;
libraries/phputf8/native/core.php:* @author Andreas Gohr &lt;andi@splitbrain.org&gt;
libraries/phputf8/native/core.php:* @author Andreas Gohr &lt;andi@splitbrain.org&gt;
</pre>
  
    <a name='67c7322cac543cec18c41afe9288e680'></a>
    <h3>Fabien Potencier &lt;fabien@symfony.com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Fabien Potencier &lt;fabien@symfony.com&gt;</span><br />
has been used a total of 7 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/framework/Symfony/Component/Yaml/Parser.php: * @author Fabien Potencier &lt;fabien@symfony.com&gt;
libraries/framework/Symfony/Component/Yaml/Yaml.php: * @author Fabien Potencier &lt;fabien@symfony.com&gt;
libraries/framework/Symfony/Component/Yaml/Dumper.php: * @author Fabien Potencier &lt;fabien@symfony.com&gt;
libraries/framework/Symfony/Component/Yaml/Inline.php: * @author Fabien Potencier &lt;fabien@symfony.com&gt;
libraries/framework/Symfony/Component/Yaml/Exception/DumpException.php: * @author Fabien Potencier &lt;fabien@symfony.com&gt;
libraries/framework/Symfony/Component/Yaml/Exception/ParseException.php: * @author Fabien Potencier &lt;fabien@symfony.com&gt;
libraries/framework/Symfony/Component/Yaml/Exception/ExceptionInterface.php: * @author Fabien Potencier &lt;fabien@symfony.com&gt;
</pre>
  
    <a name='8509848e4fb81e65fae1575c9486d3bd'></a>
    <h3>&lt;hsivonen@iki.fi&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author &lt;hsivonen@iki.fi&gt;</span><br />
has been used a total of 5 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phputf8/utils/unicode.php:* @author &lt;hsivonen@iki.fi&gt;
libraries/phputf8/utils/unicode.php:* @author &lt;hsivonen@iki.fi&gt;
libraries/phputf8/utils/bad.php:* @author &lt;hsivonen@iki.fi&gt;
libraries/phputf8/utils/validation.php:* @author &lt;hsivonen@iki.fi&gt;
libraries/joomla/string/string.php:   * @author  &lt;hsivonen@iki.fi&gt;
</pre>
  
    <a name='fa7e3c5cc067c58f5dcdb56ad861aaf8'></a>
    <h3>Andy Prevost</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Andy Prevost</span><br />
has been used a total of 4 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phpmailer/phpmailer.php: * @author Andy Prevost
libraries/phpmailer/smtp.php: * @author Andy Prevost
libraries/phpmailer/pop3.php: * @author Andy Prevost
libraries/phpmailer/pop3.php: * @author Andy Prevost
</pre>
  
    <a name='85600812569b70ce98ad298a4b5202b6'></a>
    <h3>Chris Smith&lt;chris@jalakai.co.uk&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Chris Smith&lt;chris@jalakai.co.uk&gt;</span><br />
has been used a total of 4 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phputf8/utils/position.php:* @author Chris Smith&lt;chris@jalakai.co.uk&gt;
libraries/phputf8/utils/position.php:* @author Chris Smith&lt;chris@jalakai.co.uk&gt;
libraries/phputf8/utils/position.php:* @author Chris Smith&lt;chris@jalakai.co.uk&gt;
libraries/phputf8/native/core.php:* @author Chris Smith&lt;chris@jalakai.co.uk&gt;
</pre>
  
    <a name='409ac694425ddb23bc840b7a8e7a6bb2'></a>
    <h3>Jim Jagielski</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Jim Jagielski</span><br />
has been used a total of 4 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phpmailer/phpmailer.php: * @author Jim Jagielski
libraries/phpmailer/smtp.php: * @author Jim Jagielski
libraries/phpmailer/pop3.php: * @author Jim Jagielski
libraries/phpmailer/pop3.php: * @author Jim Jagielski
</pre>
  
    <a name='f1ac33405ce43a698ce6eda753b1c9d6'></a>
    <h3>Harald Kirschner &lt;mail [at] digitarald.de&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Harald Kirschner &lt;mail [at] digitarald.de&gt;</span><br />
has been used a total of 3 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>media/system/css/modal.css: * @author    Harald Kirschner &lt;mail [at] digitarald.de&gt;
media/system/js/modal.js: @author    Harald Kirschner &lt;mail [at] digitarald.de&gt;
media/system/js/modal-uncompressed.js: * @author    Harald Kirschner &lt;mail [at] digitarald.de&gt;
</pre>
  
    <a name='aa9f5470a77721bf50e9278072120787'></a>
    <h3>Rouven We&Atilde;�ling &lt;me [at] rouvenwessling.de&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Rouven We&Atilde;�ling &lt;me [at] rouvenwessling.de&gt;</span><br />
has been used a total of 3 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>media/system/css/modal.css: * @author    Rouven We&Atilde;�ling &lt;me [at] rouvenwessling.de&gt;
media/system/js/modal.js: @author    Rouven We&Atilde;�ling &lt;me [at] rouvenwessling.de&gt;
media/system/js/modal-uncompressed.js: * @author    Rouven We&Atilde;�ling &lt;me [at] rouvenwessling.de&gt;
</pre>
  
    <a name='4329994a204d1981202b20bda2232af2'></a>
    <h3>Matthias Sommerfeld &lt;mso@phlylabs.de&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Matthias Sommerfeld &lt;mso@phlylabs.de&gt;</span><br />
has been used a total of 3 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/simplepie/idn/idna_convert.class.php: * @author  Matthias Sommerfeld &lt;mso@phlylabs.de&gt;
libraries/simplepie/idn/idna_convert.class.php:* @author  Matthias Sommerfeld &lt;mso@phlylabs.de&gt;
libraries/idna_convert/idna_convert.class.php: * @author  Matthias Sommerfeld &lt;mso@phlylabs.de&gt;
</pre>
  
    <a name='3f6c8f9f11b2a371e11819d36c6c4580'></a>
    <h3>Marcus Bointon</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Marcus Bointon</span><br />
has been used a total of 3 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phpmailer/phpmailer.php: * @author Marcus Bointon
libraries/phpmailer/smtp.php: * @author Marcus Bointon
libraries/phpmailer/pop3.php: * @author Marcus Bointon
</pre>
  
    <a name='a72fac36018dfcaa0e81cb879ce07024'></a>
    <h3>Geoffrey Sneddon</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Geoffrey Sneddon</span><br />
has been used a total of 2 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/simplepie/simplepie.php: * @author Geoffrey Sneddon
libraries/simplepie/simplepie.php:   * @author Geoffrey Sneddon
</pre>
  
    <a name='40e56b7449ec226a940ca0eea2d47487'></a>
    <h3>Anthony Ferrara &lt;ircmaxell@php.net&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Anthony Ferrara &lt;ircmaxell@php.net&gt;</span><br />
has been used a total of 2 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/compat/password/lib/version_test.php: * @author Anthony Ferrara &lt;ircmaxell@php.net&gt;
libraries/compat/password/lib/password.php: * @author Anthony Ferrara &lt;ircmaxell@php.net&gt;
</pre>
  
    <a name='8c7011d9bee968353477a9abbca18f0c'></a>
    <h3>Matthew Lewinski &lt;matthew@lewinski.org&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Matthew Lewinski &lt;matthew@lewinski.org&gt;</span><br />
has been used a total of 2 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/framework/Symfony/Component/Yaml/Unescaper.php: * @author Matthew Lewinski &lt;matthew@lewinski.org&gt;
libraries/framework/Symfony/Component/Yaml/Escaper.php: * @author Matthew Lewinski &lt;matthew@lewinski.org&gt;
</pre>
  
    <a name='cf5e3d96b635f0aeb7cad4913bd01799'></a>
    <h3>Romain Neutron &lt;imprec@gmail.com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Romain Neutron &lt;imprec@gmail.com&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/framework/Symfony/Component/Yaml/Exception/RuntimeException.php: * @author Romain Neutron &lt;imprec@gmail.com&gt;
</pre>
  
    <a name='1eaa60217b4f4f2e66694a3c333ef053'></a>
    <h3>Jay Burrell, Systems &amp; Networks, Mississippi State University</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Jay Burrell, Systems &amp; Networks, Mississippi State University</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/joomla/client/ldap.php:   * @author  Jay Burrell, Systems &amp; Networks, Mississippi State University
</pre>
  
    <a name='5e29920bf0eba722cb5da5c790c079f9'></a>
    <h3>Oliver Saunders &lt;oliver (a) osinternetservices.com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Oliver Saunders &lt;oliver (a) osinternetservices.com&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phputf8/str_pad.php:* @author Oliver Saunders &lt;oliver (a) osinternetservices.com&gt;
</pre>
  
    <a name='c9a300dbf4f54176db9f457fe5ca654d'></a>
    <h3>Matthias Sommerfeld, &lt;mso@phlylabs.de&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Matthias Sommerfeld, &lt;mso@phlylabs.de&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/idna_convert/transcode_wrapper.php: * @author Matthias Sommerfeld, &lt;mso@phlylabs.de&gt;
</pre>
  
    <a name='315cd831a94d957eb5d5555f79661e37'></a>
    <h3>Matthias Sommerfeld  &lt;mso@phlyLabs.de&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Matthias Sommerfeld  &lt;mso@phlyLabs.de&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/idna_convert/uctc.php: * @author Matthias Sommerfeld  &lt;mso@phlyLabs.de&gt;
</pre>
  
    <a name='9572e438961b579156fa8abec3a8ac30'></a>
    <h3>&lt;chernyshevsky at hotmail dot com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author &lt;chernyshevsky at hotmail dot com&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phputf8/native/core.php:* @author &lt;chernyshevsky at hotmail dot com&gt;
</pre>
  
    <a name='1cd8f614ff83d986f045741103ff82b9'></a>
    <h3>elfrink at introweb dot nl</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author elfrink at introweb dot nl</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/simplepie/simplepie.php: * @author elfrink at introweb dot nl
</pre>
  
    <a name='ddd11c7832824d508a1a495949fff4b5'></a>
    <h3>Nicholas</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Nicholas</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>administrator/components/com_joomlaupdate/restore.php: * @author Nicholas
</pre>
  
    <a name='599130524f664cddaa28b66cc5c90651'></a>
    <h3>Nicholas K. Dionysopoulos</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Nicholas K. Dionysopoulos</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>administrator/components/com_joomlaupdate/restore.php:   * @author Nicholas K. Dionysopoulos
</pre>
  
    <a name='350ac68cde440cbefc07fe540468a65f'></a>
    <h3>Brett Stimmerman &lt;brettstimmerman[at]gmail[dot]com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Brett Stimmerman &lt;brettstimmerman[at]gmail[dot]com&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>administrator/components/com_joomlaupdate/restore.php: * @author      Brett Stimmerman &lt;brettstimmerman[at]gmail[dot]com&gt;
</pre>
  
    <a name='f935870ac27511a0f4ed89edc614645f'></a>
    <h3>Matt Knapp &lt;mdknapp[at]gmail[dot]com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Matt Knapp &lt;mdknapp[at]gmail[dot]com&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>administrator/components/com_joomlaupdate/restore.php: * @author      Matt Knapp &lt;mdknapp[at]gmail[dot]com&gt;
</pre>
  
    <a name='f6ddaceceed9535fd31cc409faee3c9f'></a>
    <h3>Michal Migurski &lt;mike-json@teczno.com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Michal Migurski &lt;mike-json@teczno.com&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>administrator/components/com_joomlaupdate/restore.php: * @author      Michal Migurski &lt;mike-json@teczno.com&gt;
</pre>
  
    <a name='fb3de7a74a8059836523a220cb70f6b5'></a>
    <h3>Chris Ryan</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Chris Ryan</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phpmailer/smtp.php: * @author Chris Ryan
</pre>
  
    <a name='2fa46549f9feb052b6293fc392bb842e'></a>
    <h3>Richard Davey (orig) &lt;rich@corephp.co.uk&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Richard Davey (orig) &lt;rich@corephp.co.uk&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/phpmailer/pop3.php: * @author Richard Davey (orig) &lt;rich@corephp.co.uk&gt;
</pre>
  
    <a name='12adf302d22f2924ef4989273dc4db3f'></a>
    <h3>Josh Peck &lt;jmp at joshpeck dot org&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Josh Peck &lt;jmp at joshpeck dot org&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/simplepie/simplepie.php: * @author Josh Peck &lt;jmp at joshpeck dot org&gt;
</pre>
  
    <a name='cbfaeb5f0f9d3d6c368b57ca05b99683'></a>
    <h3>nikosdion &lt;nicholas@dionysopoulos.me&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author nikosdion &lt;nicholas@dionysopoulos.me&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>administrator/components/com_joomlaupdate/models/default.php: * @author      nikosdion &lt;nicholas@dionysopoulos.me&gt;
</pre>
  
    <a name='3a67a6bbd18028c99314f919f4ca2bf2'></a>
    <h3>Alexander Merz &lt;alexander.merz@web.de&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Alexander Merz &lt;alexander.merz@web.de&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/simplepie/simplepie.php: * @author Alexander Merz &lt;alexander.merz@web.de&gt;
</pre>
  
    <a name='4db617fd69ba192fa6566ad40097d775'></a>
    <h3>Ryan Parman</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Ryan Parman</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/simplepie/simplepie.php: * @author Ryan Parman
</pre>
  
    <a name='b2eed24cb8500506be17cdb0b4c0911b'></a>
    <h3>Geoffrey Sneddon &lt;geoffers@gmail.com&gt;</h3>
    <p>This tag:<br /><span style="font-family:'Courier New', Courier, monospace; background:#eee; border:1px solid #ddd; padding:0px 5px;">* @author Geoffrey Sneddon &lt;geoffers@gmail.com&gt;</span><br />
has been used a total of 1 times within the following files:</p>
    <pre style='white-space:pre; text-align:right; overflow:auto; font-size:12px;' class='white_box'>libraries/simplepie/simplepie.php: * @author Geoffrey Sneddon &lt;geoffers@gmail.com&gt;
</pre> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 15: @author - Joomla DocBlock headers</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 14: <a href='/support/edu/joomla-3/subpackage'>@subpackage - Joomla DocBlock headers</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 16: <a href='/support/edu/joomla-3/package'>@package - Joomla DocBlock headers</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/author&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/author'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzI5MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e9b1e3012b5fb18f7c47c02c0741d8a6" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>0</span> Questions & <span class='comment-text'>Comments</span></h3>
