<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68871:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/ps-16-friendly-url-error-on-product-pages" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Chris_L, In addition to Christian's question below, is this an upgraded PrestaShop or a new installation? Have you activated any other modules in ..." />
  <title>PS 1.6 Friendly URL error on Product Pages | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/ps-16-friendly-url-error-on-product-pages" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fa75036b1b17f2ee723b559519d2c4eb -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '37.159.229.65']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>PS 1.6 Friendly URL error on Product Pages</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-LIgSQxqchbI/AAAAAAAAAAI/AAAAAAAAALs/kDCPLSHGszs/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/Chris_L'>Chris_L</a>
			<div>83 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-09-13 7:46 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,396</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>PrestaShop1.6.0.9, default theme is in use<br />
Problem: When Friendly URL is enabled under Preferences/SEO/URL and Preferences/Product modules, the Product pages comes up with error 404 &quot;THIS PAGE IS NOT AVAILABLE<br />
WE'RE SORRY, BUT THE WEB ADDRESS YOU'VE ENTERED IS NO LONGER AVAILABLE&quot;.<br />
Friendly url of other pages e.g. the CMS pages work fine though. Only the Product pages do not display.<br />
When Friendly URL is disabled, all the pages including the product pages work/display properly. <br />
Background information:  Multi-store view is disabled, Default language is English and no other language is enabled.<br />
I've run error reporting but nothing new comes up.  The same error 404  &quot;THIS PAGE IS NOT AVAILABLE<br />
WE'RE SORRY, BUT THE WEB ADDRESS YOU'VE ENTERED IS NO LONGER AVAILABLE&quot; appears on Product pages.  <br />
Any solution?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5617' id='upvote_answer_5617' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5617' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5617').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5617' id='downvote_answer_5617' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5617' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5617').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/ChristianMcQuilkin'>ChristianMcQuilkin</a>
					
					<div>70 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-09-14 12:22 am EST
                		        </div>
					
		                </div>

				Have you tried generating the .htaccess in the generator section?<br />
If it has been generated but the problem persists then there will need to be some edits to it as there are some factors affecting it.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5617').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5617' id='form_comment_on_answer_5617' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thanks for your input. Where is the 'generator' section in PS 1.6.0.9?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-LIgSQxqchbI/AAAAAAAAAAI/AAAAAAAAALs/kDCPLSHGszs/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Chris_L'>Chris_L</a><br />
									83 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-09-16 2:05 am EST
								</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5619' id='upvote_answer_5619' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5619' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5619').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5619' id='downvote_answer_5619' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5619' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5619').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Chris_L,<br />
<br />
In addition to Christian's question below, is this an upgraded PrestaShop or a new installation? Have you activated any other modules in addition to the ones activated by default?<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5619').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5619' id='form_comment_on_answer_5619' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Scott, It is a newly installed PS 1.6.0.9.  I've updated some of the modules since installation in August.     Yes, I think I have enabled some of the modules other than those enabled by default but I have also disabled some of them since. </div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Since I've posted this issue, I've set up a Test Store using a copy of my Live Store's database.  When I enabled the Friendly URL on the Test Store and run the Error Reporting on cPanel, I got Error 403 Error 403 - Forbidden &quot;You don't have permission to access the requested resource. Please contact the web site owner for further assistance&quot; (On the product pages).  However, only 2 of the 3 product pages have the Error 403.  One of the product pages displays properly i.e. no error.  I have disabled Apache's mod_security module in this test.  Please advise.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Sorry for the late reply currently fixing my laptop, but can you check in ur .htaccess that AllowOverride is set to: AllowOverride All<br />
<br />
If it's not in there.... Add it.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/ChristianMcQuilkin'>ChristianMcQuilkin</a><br />
									70 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-09-16 3:22 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Oh and clear the cache in performance. One or the other (or both) should work.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Christian, Thank you for your answers.  I've checked the .htaccess and there is no 'AllowOverride'.  Which line on the .htaccess should I add in &quot;AllowOverride All&quot;?</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Can you make a support ticket and ask the support team if AllowOverride is set to All. I cant check becuase well.... im not a support team member.<br />
<br />
 I ask to make this ticket, becuae ive had some experience with some hosts not having it there, just to make sure, make a ticket.<br />
<br />
Im assuming you are using a sbared server, but ask the support team either way.<br />
</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Chris_L,<br />
<br />
AllowOverride is a viable solution and you can set that at the top of your .htaccess file. Please let us know if that helps the matter.<br />
<br />
Kindest Regards,<br />
Scott M</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									...
									36,990 <a href='/support/team/points' target='_blank'>Points</a>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you for all the inputs. After I key in AllowOverride to htaccess file, I can't log into PS1.6 admin, it generates an 'Error 500 Internal Server Error'.  I remove AllowOverride and it goes back to before.  Two of the Product Pages Friendly URL still don't work (one of the Product Pages still works).  I've submitted tickets to Support team many times to no avail/new suggestion.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Ok, I somehow got the friendly URLs to work by simply changing the 'name' of the category in PS1.6 back office, Catalog/Categories.  Now the Friendly URL works for all three products.  Very trivial!</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Chris_L,<br />
<br />
We're glad you were able to get your <strong>Friendly URL's</strong> working in Prestashop. Thank you for sharing your solution.<br />
<br />
...
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Why is presta shop trivial..... i think you got to 500 internal server error becuase you didnt add the directory tag. That was my bad, but glad you sorted it out.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Prestashop shows 404 on all pages instead of home page:<br />
http://www.onstreet.ro/ceasuri-barbatesti.html?categories=<br />
<br />
I am using Clean URLs v0.42<br />
<br />
Can you please help me to figure it out</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com//picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/ziyaindia78'>ziyaindia78</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-11-05 3:51 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Ziyaindia78,<br />
<br />
Sorry you're having problems with a plugin in PrestaShop.  When I tried to find information on this plugin, I found little to no documentation on it and less support information.  It does appear to be written for PrestaShop 1.5, so you should not be using it in 1.6.  If you can provide a little more information on the plugin  and the version of PrestaShop you're using, it would help us out.  You may be better off contacting the author of the plugin for more in depth support on the issue. <br />
<br />
Please provide more information on the plugin and we might be able to find more information in regards to troubleshooting this third-party plugin issue.<br />
<br />
Regards,<br />
Arnel C.<br />
<br />
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/ps-16-friendly-url-error-on-product-pages&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/ps-16-friendly-url-error-on-product-pages'></div>
<script type='text/javascript'>
  (function() {
