<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51187:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/what-happens-to-my-email-when-i-switch-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Kenthai, Thanks for the question! Different hosts have different ways of hosting email, but the way emails are routed from one place to another is..." />
  <title>What happens to my email when I switch hosting? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/what-happens-to-my-email-when-i-switch-hosting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b3af6fcd48d9694e2d433bc576e1e103 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.191.82.254']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>What happens to my email when I switch hosting?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/kenny.thai.902/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/kenthai'>kenthai</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-08 5:38 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>4,273</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I plan to change the DNS entries on my domain to point it to InMotion. How does this affect my email? Right now I have email accounts created that automatically forwards the email to my Gmail account. Do I have to recreate my email addresses for my domain? What happens to all my previous email?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3067' id='upvote_answer_3067' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3067' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3067').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3067' id='downvote_answer_3067' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3067' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3067').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Kenthai,<br />
<br />
Thanks for the question!  Different hosts have different ways of hosting email, but the way emails are routed from one place to another is standard.  Changing your DNS in effect changes where emails will be sent.  When make the change, then you will need to create the accounts again at the new host.  You can actually setup the email accounts before the change if you wish.   If your previous host was using the same system as us (cPanel), then you could simply export the entire cPanel account from the old host and then have it imported into our hosting service.  <br />
<br />
Your email and web traffic are controlled by the DNS settings which can be set to direct ALL traffic (email and website traffic) to one host, or split up.  If you want all traffic to go to one host, you simply need to change name servers and then both email and website traffic will go to your new host after a short period of propagation.  Once propagation is complete, then the definition of where the domain name points to (in terms of the host) changes and that's where traffic will go.  It's not an instantaneous change on the web, but it's fairly quick  - usually up to 24 hours.  We have an article about <a href="http://www.inmotionhosting.com/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting" target="new">moving your emails from your old host to InMotion</a>.  <br />
Check that out for a good summary of the process.  <br />
<br />
Once the email moves, the forwarders will no longer exist, and you will need to rebuild them.  You can find  more information in our article on <a href="http://www.inmotionhosting.com/support/edu/everything-email/email-features/set-up-email-forwarder" target="new">creating email forwarders</a>.<br />
<br />
I hope this helps provide the information you need.  We have a great education on <a href="http://www.inmotionhosting.com/support/edu/everything-email" target="new">everything email</a>, so check it for more details.<br />
<br />
...
Community Support Team
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3067').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3067' id='form_comment_on_answer_3067' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/what-happens-to-my-email-when-i-switch-hosting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/what-happens-to-my-email-when-i-switch-hosting'></div>
<script type='text/javascript'>
  (function() {
