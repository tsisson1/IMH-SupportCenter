...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/horde-webmail/how-to-add-a-profile-picture-to-the-online-horde-email-client" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question on images in your HordeMail. I assume you mean to add a profile image in your signature area. It that is the case, yo..." />
  <title>How to add a profile picture to the online Horde email client | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/horde-webmail/how-to-add-a-profile-picture-to-the-online-horde-email-client" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e25735ab8f4e9a578f557619f2ed9ab4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to add a profile picture to the online Horde email client</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-07-27 1:21 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>526</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hey,<br />
<br />
I'd like to add a profile picture to my email account on the Horde web client. How do I go about this?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7749' id='upvote_answer_7749' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7749' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7749').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7749' id='downvote_answer_7749' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7749' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7749').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question on images in your HordeMail. I assume you mean to add a profile image in your signature area. It that is the case, you can follow the <a href="http://www.inmotionhosting.com/support/email/horde-webmail/add-signature-image">instructions here</a>. This does not work on the shared servers, but does work on the VPS and Dedicated servers.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7749').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7749' id='form_comment_on_answer_7749' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hey, <br />
<br />
Thanks for the reply, but that's not what I'm asking about. Since the online webmail isn't exactly the most current on email features, I forward all my mail to a more thorough client (gmail). When sending from my Horde address through gmail, my profile picture is blank because I cannot add one through Horde. That's what I'd like to know how to do.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-3Sdvzya9yww/AAAAAAAAAAI/AAAAAAAADec/9RdS6hZiui4/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Amit_Mehta'>Amit_Mehta</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-07-27 1:49 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Amit_Mehta,<br />
<br />
I'm not sure if you're using the paid service for Googlemail or if you're using the free Gmail client.  However, in either case, both email clients from Google can handle email tasks such as incoming/outgoing emails, but the feature set that you're looking for (which includes the profile pic) is not something that you'll be able to simply add to the Horde email account. Horde is an online email account that is serving the emails from the InMotion servers.  The option for the profile pic is something that Google provides and normally a part of any email account.  <br />
<br />
...
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/horde-webmail/how-to-add-a-profile-picture-to-the-online-horde-email-client&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/horde-webmail/how-to-add-a-profile-picture-to-the-online-horde-email-client'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a063c751fefeb9448972f1a9fd31739d" value="1" />	</div>
	</form>
<!-- <br />
