<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49875:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dnssec" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Mossback, I took a look further into DNSSEC for you, and a came across the following cPanel post: Filed: [Case 4386] DNSSEC support in cPanel The thr..." />
  <title>dnssec | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dnssec" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2ea2a0d40cce0a8a9a96708df91ef70d -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>dnssec</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Mossback'>Mossback</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-01-14 4:13 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,593</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How do I enable DNSSEC for my domain?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_409' id='upvote_answer_409' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='409' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_409').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_409' id='downvote_answer_409' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='409' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_409').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Mossback,<br />
<br />
I took a look further into &lt;a href='http://en.wikipedia.org/wiki/Domain_Name_System_Security_Extensions' target='_blank'&gt;DNSSEC&lt;/a&gt; for you, and a came across the following cPanel post:<br />
&lt;a href='http://forums.cpanel.net/f145/case-4386-dnssec-support-cpanel-89085.html' target='_blank'&gt;Filed: [Case 4386] DNSSEC support in cPanel&lt;/a&gt;<br />
<br />
The thread is over three pages long and began on &quot;08-07-2008 11:00 PM&quot;. While cPanel does not have this feature implemented, I'm sure they will one day implement it.<br />
<br />
To answer your question, currently we do not have a way to enable DNSSEC for you. To have it at this time would require that you use a third party DNS service that offers this functionality, or you would have to be on VPS Hosting (or Dedicated) with root access and know how to set it up.<br />
<br />
I'm sure this isn't the answer you're looking for, but I hope this at least answers your question. Please let me know if you have any follow up questions or if there is anything further I can assist with.<br />
<br />
Thanks,<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_409').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_409' id='form_comment_on_answer_409' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dnssec&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dnssec'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="00200bbd8c407b8293c5e8073c4675cb" value="1" />	</div>
	</form>
<!-- <br />
