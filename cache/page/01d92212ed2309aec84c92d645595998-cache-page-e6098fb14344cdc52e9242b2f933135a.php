<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67728:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/user-account-level-filtering" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-11T15:27:06-07:00" />
  <meta name="keywords" content="User Level Filtering cPanel email filter account Manage Edit Create" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This tutorial will explain the User Level Filtering within the cPanel." />
  <title>Creating user level filtering in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/user-account-level-filtering" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a8873261713b56d48060bbc6f0a33be4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '187.49.236.162']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating user level filtering in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,494</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 29, 2012'><span style='color:#606060;'>Published:</span> Mar 11, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When receiving emails on the server, there may be a need for filtering specific email addresses that are coming into the server. Emails can be Discarded, sent to another email address, or delivered to a program with the User and Account Level Filtering. This tutorial will explain the <strong>User / Account Level Filtering</strong> within the cPanel. If the previous tutorial was missed, please visit the <a href="/support/edu/cpanel/cpanel-email/edit-mx-remote-local" title="Click here to view the previous article" target="_blank">Setting domain MX records to remote settings in cPanel</a> tutorial.</p>
<h3>Filtering emails on the User and Account level</h3>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" title="Click for more information">Log into your cPanel</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-1-select.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="user-level-filtering-1-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-1-select.gif" title="Click here to view the larger image" width="200" /></a>For <strong>User</strong> level filtering Navigate to the <strong>Mail</strong> &gt; <strong>User Level Filtering</strong> in cPanel. <br style="clear: both;" /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-4-account.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="user-level-filtering-4-account" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-4-account.gif" title="Click here to view the larger image" width="200" /></a>For <strong>Account</strong> level filtering Navigate to the <strong>Mail</strong> &gt; <strong>Account Level Filtering</strong> in cPanel. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-2-manage.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="user-level-filtering-2-manage-moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-2-manage.gif" title="Click here to view the larger image" width="200" /></a>In the <strong>Manage filters</strong> section, click the <em>Manage filters</em> link in the row of the email account that is having filters set up.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-3-create.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="user-level-filtering-3-create-moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-3-create.gif" title="Click here to view the larger image" width="200" /></a>The <strong>Edit Filters</strong> for your@emailaddress.com will open up. Click the <strong>Create a New Filter</strong> button to add email filters.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-5-click.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="user-level-filtering-5-click-moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-5-click.gif" title="Click here to view the larger image" width="200" /></a>In this article, Yahoo.com will be used for the filter. The filter will send any emails from a Yahoo.com email address to the Junk folder. Set the <strong>Filter name</strong>, <strong>Rules</strong>, and <strong>Actions</strong> and click <strong>Create</strong>. The action in this case will be Junk. Below is a description of what each <strong>Option</strong>, <strong>Operator</strong>, and <strong>Action</strong> does.<br style="clear: both;" />
<table class="article_table" border="0">
<tbody>
<tr>
<td colspan="3" style="background: #cccccc;" valign="top">
<h2 style="padding: 2px 0px 2px 5px;">Email Filter Option Rules</h2>
</td>
</tr>
<tr>
<td valign="top" width="168"><strong>From</strong></td>
<td colspan="2" valign="top" width="945">This is for matching the from email address.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Subject</strong></td>
<td colspan="2" valign="top" width="945">This will filter by the subject of the email.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>To</strong></td>
<td colspan="2" valign="top" width="945">This will filter the email by who it was sent to.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Reply Address</strong></td>
<td colspan="2" valign="top" width="945">Filters by the reply address to who the email will be replied to.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Body</strong></td>
<td colspan="2" valign="top" width="945">Scans the text of the email for any matches and filters according to the text of the email..</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Any Header</strong></td>
<td colspan="2" valign="top" width="945">Scans specific criteria found in the Headers of the email.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Any Recipient</strong></td>
<td colspan="2" valign="top" width="945">Looks at all recipients of the email.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Has not been previously delivered</strong></td>
<td colspan="2" valign="top" width="945">Filters emails if they are still in Queue on the server..</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Is an error message</strong></td>
<td colspan="2" valign="top" width="945">Looks at errors received by auto responders.</td>
</tr>
<tr>
<td colspan="3" style="background: #cccccc;" valign="top">
<h2 style="padding: 2px 0px 2px 5px;">Email Filter Operator Rules</h2>
</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Equals</strong></td>
<td colspan="2" valign="top" width="945">Matches exactly what is put in the box.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Matches Regex</strong></td>
<td colspan="2" valign="top" width="945">A <a href="http://en.wikipedia.org/wiki/Regular_expression" target="_blank" title="Regular Expression">Regular Expression</a> can be used here..</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Contains</strong></td>
<td colspan="2" valign="top" width="945">Will match if the email has the string of characters in it.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Does not Contain</strong></td>
<td colspan="2" valign="top" width="945">Will match if the email does NOT have the string of characters in it.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Begins with</strong></td>
<td colspan="2" valign="top" width="945">Begins with the characters that were typed.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Ends with</strong></td>
<td colspan="2" valign="top" width="945">Ends with the Characters that were typed.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Does not begin with</strong></td>
<td colspan="2" valign="top" width="945">Doesn't begin with the characters that were typed.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Does not end with</strong></td>
<td colspan="2" valign="top" width="945">Doesn't end with the Characters that were typed.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Does not match</strong></td>
<td colspan="2" valign="top" width="945">Does not equal the characters typed.</td>
</tr>
<tr>
<td colspan="3" style="background: #cccccc;" valign="top">
<h2 style="padding: 2px 0px 2px 5px;">Email Filter Action Rules</h2>
</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Discard Message</strong></td>
<td colspan="2" valign="top" width="945">Deletes the message with no Failure message.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Redirect to Email</strong></td>
<td colspan="2" valign="top" width="945">Sends the email to another email address.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Fail with Message</strong></td>
<td colspan="2" valign="top" width="945">Deletes the email and sends a failure message..</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Stop processing rules</strong></td>
<td colspan="2" valign="top" width="945">Does not run any filter rules.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Deliver to folder</strong></td>
<td colspan="2" valign="top" width="945">Sends the email to a specified folder.</td>
</tr>
<tr>
<td valign="top" width="168"><strong>Pipe to program</strong></td>
<td colspan="2" valign="top" width="945">Sends the email to a program or script on the server.</td>
</tr>
</tbody>
</table>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-6-success.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="user-level-filtering-6-success-moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-6-success.gif" title="Click here to view the larger image" width="200" /></a>Once the filter is created there should be a "<em>You have successfully created a new filter</em>" message.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-7-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="user-level-filtering-7-final=moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-7-final.gif" title="Click here to view the larger image" width="200" /></a>When visiting the <strong>Edit Filters</strong> section again, the new filter will be in the list of filters. Here is where the filter can be edited or removed.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-8-test.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="user-level-filtering-8-test-moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-8-test.gif" title="Click here to view the larger image" width="200" /></a>Next the filter can be tested to see if its doing what is required. At the bottom of the edit filters section, change the <strong>To:</strong> and<strong> From:</strong> emails or the <strong>subject</strong> (depending on how you set up the filter) to test the filter. Click <strong>Test Filter</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-9-output.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="user-level-filtering-9-output-moodle" src="//cdn.inmotionhosting.com/support/images/stories/201/user-level-filtering/user-level-filtering-9-output.gif" title="Click here to view the larger image" width="200" /></a>The test filter will run and display on the Filter Trace page. In the Filter trace results: the message can be seen going to where the filter was set. In this case The message was Saved to the Trash..<br style="clear: both;" /></li>
</ol>
<p>This concludes the article for Creating user level filtering in cPanel. <!-- Please check the next article on <a target="_blank" href="/support/" title="Click here to view the next article">** Next Article **</a>. --> For more information on this course please visit <a target="_blank" href="/support/edu/cpanel/cpanel-email" title="Click here to view the courses">Using Email - cPanel</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Creating user level filtering in cPanel</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/user-account-level-filtering&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/user-account-level-filtering'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzQmaWQ9MTk0NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5fde006a3a1eb608804215d44a7c6041" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/account-level-filtering-limit?tsrc=rsbraq'>Account Level Filtering limit?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/can-boxtrapper-block-subjects?tsrc=rsbraq'>Can BoxTrapper block subjects?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email-troubleshooting/email-filter-doesnt-work?tsrc=rsbraq'>Email filter doesn't work</a>
                                </div>
