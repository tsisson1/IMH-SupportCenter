<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69022:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/wp-childtheme-2014" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-12T14:12:10-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="If you need to modify a WordPress theme, you should be using a child theme to keep from losing your modifications." />
  <title>Creating a Child Theme in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/wp-childtheme-2014" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2014-10', 3]);
	...
	<!-- cid:53d07a0aa51adecf5f1835da19efa314 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '68.35.217.61']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a Child Theme in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,053</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 30, 2014'><span style='color:#606060;'>Published:</span> May 12, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you want to modify a WordPress theme, you should create what's called a <i>child theme</i>.  A <i>child theme</i> allows you to make updates that would not be overwritten by updates to the theme. Theme updates occur on a regular basis, usually in response to updates to WordPress. If the modifications were made to the main theme, then they would be erased upon the theme update.  The <i>child theme</i> allows you to avoid losing your modifications. The following article takes you through the steps needed to create a basic <i>child theme</i>. </p>
...
<ol class="article_list">
  ...
  <li><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to the cPanel</a>.</li>

  <li>Open the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">cPanel File Manager</a> and then go to your WordPress installation directory.  Look for the <b>wp-content/themes</b> folder. </li>
...
<li>In File Manager, click on your newly created CSS file and edit the file by clicking on <b>Code Editor</b> in the menu. Add the following into the blank <i>style.css file:</i>
...
<li>
<p>Next, you will edit the <i>functions.php</i> file that you just created.  Click on the file, and edit it with the <b>Code Editor</b> as you did the last file. Add the following code:
</p>
<p class="code_block">
&lt;?php<br>
...
<p>This code is the final step in creating the child theme.  As per WordPress, the code in the <i>functions.php</i> allows you to <i>enqueue</i> the parent theme stylesheets. <b><i>NOTE: The previous method of using "@import" is no longer considered best practice for importing the parent theme stylesheet.</i></b> For more information, please see <a href="http://codex.wordpress.org/Child_Themes" rel="nofollow" target="_blank">WordPress Codex: child themes</a>.</p>
...
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wp-child-theme/child-theme.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Activate child theme" src="//cdn.inmotionhosting.com/support/images/stories/wp-child-theme/child-theme.png" width="100" align="right"/></a>
...
<table WIDTH="50%"   CELLPADDING="4" CELLSPACING="3">
  <tr><td>BEFORE</td><td>AFTER</td>
  </tr>
  <tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wp-child-theme/wp-2014-cap2.png"><img  alt="Unmodified 2014 Theme" src="//cdn.inmotionhosting.com/support/images/stories/wp-child-theme/wp-2014-cap2.png" width="200" /></a>
</td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wp-child-theme/wp-child-theme-cap2.png"><img  alt="Child theme modifying the 2014 theme" src="//cdn.inmotionhosting.com/support/images/stories/wp-child-theme/wp-child-theme-cap2.png" width="200" /></a>
</td>
</tr>
</table>
<br>
...
<p>This completes the tutorial on creating a child them using the WordPress twenty-fourteen theme.  Note that this is only the foundation upon which you will base all of your future changes to the site.  Child themes are used to preserve modifications to a theme so that theme updates do not destroy your changes.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Creating a Child Theme in WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/wordpress/change-wordpress-appearance/add-new-media-wordpress-351'>Add New Media in Wordpress 3.5.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzkmaWQ9MzQzMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8620f14aa20f026674a36b6b136f4814" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/with-wordpress-the-child-theme-css-not-overriding-parent-themes-css?tsrc=rsbraq'>With WordPress, the child theme CSS not overriding parent theme's CSS.</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/i-cannot-install-the-child-theme-for-my-parent-theme-on-wordpress?tsrc=rsbraq'>I cannot install the child theme for my parent theme on Wordpress</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/rearrange-order-of-pages-on-website?tsrc=rsbraq'>Rearrange order of pages on website</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/56a702bd202076cc404604fbebdb6879?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/56a702bd202076cc404604fbebdb6879'>Michael</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 5:39 am</div>
				                <div><h3 style="color: #23282d; font-size: 1.3em; margin: 1em 0px; font-family: 'Open Sans', sans-serif; line-height: 18.2000007629395px; background-color: #f1f1f1;">Broken Themes</h3>
<p style="font-size: 13px; line-height: 1.5; margin: 1em 0px; color: #444444; font-family: 'Open Sans', sans-serif; background-color: #f1f1f1;">The following themes are installed but incomplete. Themes must have a stylesheet and a template.</p>
...
<a class="button button-secondary delete-theme" style="color: #aa0000; -webkit-transition-property: border, background, color; transition-property: border, background, color; -webkit-transition-duration: 0.05s; transition-duration: 0.05s; -webkit-transition-timing-function: ease-in-out; transition-timing-function: ease-in-out; outline: 0px; display: inline-block; text-decoration: none; line-height: 26px; height: 28px; margin: 0px; padding: 0px 10px 1px; cursor: pointer; border: 1px solid transparent; -webkit-appearance: none; border-radius: 3px; white-space: nowrap; box-sizing: border-box; -webkit-box-shadow: none; box-shadow: none; vertical-align: top; background: 0px 0px;" href="http://www.naijajobsboard.com/wp-admin/themes.php?action=delete&amp;stylesheet=jobsapp&amp;_wpnonce=4c535e70a1">Delete</a>



<p>Does anyone have an idea on how to resolve these.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23574);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 10:30 am</div>
				                <div>Hello Michael,<br />
<br />
Thank you for contacting us. It sounds like the Theme you are installing is missing the stylesheet, or .css file.<br />
<br />
Are you following the guide above? What step are you getting that error on?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23585);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
