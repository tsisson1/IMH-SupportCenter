<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65792:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/general-information/host-my-email-different-email-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-30T13:41:36-07:00" />
  <meta name="keywords" content="Email server different provider" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this article, we discuss what to do if you wish to host your email with a different email server or provider." />
  <title>What should I do if I host my email with a different email server - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/general-information/host-my-email-different-email-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d346846edc3a8c511afb83dccb9a5a00 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '187.188.42.228']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What should I do if I host my email with a different ema...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What should I do if I host my email with a different email server									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,448</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 24, 2011'><span style='color:#606060;'>Published:</span> Apr 30, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you're already using a third party email server and do not wish to host your email on our servers, you'll need to make a few changes so that your email will be routed correctly. For example, many users have a Microsoft Exchange server or email provided through Google Apps, and need to route their email there.</p>

<p>Before continuing, please be sure that all of your email accounts are created at your external mail server (such as at Google Apps or at your Microsoft Exchange server). Email accounts created within your cPanel will not receive any email if you are routing your email to an external email server.</p>

<div><span style="font-size: 22px; font-weight: bold;">Obtain your MX Records</span></div>
<div>The first thing you'll have to do is obtain the correct MX records to point your domain name to. If you are not sure which MX records to use, please contact your email provider. Many times, they will have them listed online, in the case here of Google:</div>
<div></div>
<div><a href="http://www.google.com/support/a/bin/answer.py?hl=en&amp;answer=33915">http://www.google.com/support/a/bin/answer.py?hl=en&amp;answer=33915</a></div>
<div></div>
<div><span style="text-decoration: underline;"><strong>Priority - Mail Server</strong></span></div>
<div><strong>1 - ASPMX.L.GOOGLE.COM.</strong></div>
<div><strong>5 - ALT1.ASPMX.L.GOOGLE.COM.</strong></div>
<div><strong>5 - ALT2.ASPMX.L.GOOGLE.COM.</strong></div>
<div><strong>10 - ASPMX2.GOOGLEMAIL.COM.</strong></div>
<div><strong>10 - ASPMX3.GOOGLEMAIL.COM.</strong></div>
<div></div>
<div>Listed above are the MX records you'll use if setting up Google Apps.</div>
<div></div>
<h1>Modify your domain's MX records</h1>
<div>To change your MX records, log into your cPanel and click the "<em>MX Entry</em>" icon under the "<em>Mail</em>" heading. If you do not have an "<em>MX Entry</em>" icon within your cPanel, please contact our Support Department for further assistance with updating your MX records.</div>
<div></div>
<div>If you have multiple domains on your account, choose the appropriate domain listed in the domain drop down box.</div>
<div></div>
<div>The first thing you'll want to do is remove any current MX records that are in place. You can do this by clicking "<em>Delete</em>" next to each record listed under "<em>MX Records</em>".</div>
<div></div>
<div>In this example, we will point our MX records to the Google Apps records listed above. The first MX record listed is 1 - ASPMX.L.GOOGLE.COM. Under the "<em>Add New Record</em>" section, enter 1 as the "<em>Priority</em>", enter ASPMX.L.GOOGLE.COM as the "<em>Destination</em>", and then click "<em>Add New Record</em>". Follow these same steps for each of the MX records listed. If given more than one MX record, you should enter them all.</div>
<div></div>
<div>After you have added all of your MX records, you then need to tell our server that it needs to deliver email to those MX records. The easiest way to do this is to select "<em>Automatically Detect Configuration</em>" under the "<em>Email Routing</em>" section, and then click "<em>Change</em>".</div>
<div></div>
<div>Please note that changes to MX records can take <strong>up to 24 hours</strong> before they begin to take affect.</div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/general-information/host-my-email-different-email-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/general-information/host-my-email-different-email-server'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNiZpZD02OTgmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="11fd539d6d7cac5bdef4a644a6cb5f6c" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/17d4acc253be844d4a97511ebea7cb52?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/17d4acc253be844d4a97511ebea7cb52'>Kevin Andrews</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-11 5:23 am</div>
				                <div><p>What about configuring Google's "split delivery". &nbsp;How should that be configured so that email for which a Gmail account is not provisioned can be routed to the InMotion server mail manager?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29696);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-11 3:37 pm</div>
				                <div>Google's Split Delivery would be set up on the Google side after you have pointed your domain to Google servers -- as detailed above. As far as the second part of your request, in which you mentioned the account that has not been provisioned, I admit I'm not sure what you mean. <br />
<br />
Also, by "server mail manager" do you mean Web Host Manager, or cPanel, or exim?<br />
<br />
If you mean an account that has been provisioned at InMotion then you can configure a new account at Google and it will work if your domain points there.<br />
<br />
Feel free to reply back with any further data or questions. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29714);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30710'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ad1a1a3fb2eba7a592548440853f4cdf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ad1a1a3fb2eba7a592548440853f4cdf'>Lauren</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-21 9:37 am</div>
				                <div><p>What should I do to host my company's email with two different email servers? &nbsp;We have some staff that need a desktop email platform (Thunderbird)&nbsp;and others that need a web-based email platform (Zoho).</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30710);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-22 10:06 am</div>
				                <div>Hello Lauren,<br />
<br />
Thunderbird is simply an email client, so you can use the existing email server platform on our servers (Dovecote) in order to support POP3/IMAP email accounts.  However, I'm not sure what Zoho requires as a back-end.  When I looked up the Zoho platform, the email portion appears to be a part of a much larger CRM software.  I'm not sure that you could run it separately from the platform.  You would need to contact Zoho company for further information in that regard.    Apologies that I couldn't give you information on Zoho.  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30731);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
