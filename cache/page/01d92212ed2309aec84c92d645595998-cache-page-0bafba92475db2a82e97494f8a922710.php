<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62000:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssh/using-the-linux-sar-command" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-16T19:44:34-07:00" />
  <meta name="keywords" content="sar linux command use usage system activity reporter log logs" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/ssh/using-the-linux-sar-command" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:125242baf1a6573c185c310e4395986d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '141.202.54.2']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Using the Linux sar command</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the Linux sar command									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,512</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 6, 2013'><span style='color:#606060;'>Published:</span> Aug 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'll be explaining the Linux sar command and some of its many uses for helping you track down possible bottleneck problems on your server.</p>
...
<p class="cli" style="width: 500px; white-space: nowrap;">Linux 2.6.32-279.22.1.el6.x86_64 (elite.inmotionhosting.com) 03/06/2013 _x86_64_ (8 CPU)<br /><br /> 12:00:04 AM CPU %user %nice %system %iowait %steal %idle<br /> 12:10:01 AM all 0.06 0.08 0.04 0.40 0.00 99.42<br /> 12:20:01 AM all 0.04 0.10 0.04 0.26 0.00 99.55<br /> 12:30:01 AM all 0.04 0.09 0.03 0.02 0.00 99.82</p>
...
<p>You'll get output back like this:</p>
<p class="cli" style="width: 500px; white-space: nowrap;">Linux 2.6.32-279.22.1.el6.x86_64 (elite.inmotionhosting.com) 03/06/2013 _x86_64_ (8 CPU)<br /><br /> 12:00:01 AM runq-sz plist-sz ldavg-1 ldavg-5 ldavg-15<br /> 12:02:01 AM 2 260 0.75 0.53 0.67<br /> 12:04:01 AM 1 255 0.96 0.75 0.73<br /> 12:06:01 AM 2 254 0.31 0.57 0.67<br /> 12:08:01 AM 3 269 0.35 0.53 0.63<br /> 12:10:01 AM 5 269 7.30 2.25 1.20</p>
...
<p>I had written another article on <a href="/support/website/server-usage/advanced-server-load-monitoring" target="_blank">advanced server load monitoring</a> that even explains how you can use the following one-liner to show all the times your server's load average was spiking:</p>
...
<p>In another article I wrote on <a href="/support/website/website-troubleshooting/determine-cause-of-server-usage-spike" target="_blank">how to determine the cause of a server usage spike</a> it goes over also using <strong>sar</strong> data to find when your server's load has been spiking, and then how to look at your Apache website access logs to correlate what was going on at that time, that might have led to the server's usage spiking.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssh/using-the-linux-sar-command&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssh/using-the-linux-sar-command'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTEmaWQ9NjE2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
