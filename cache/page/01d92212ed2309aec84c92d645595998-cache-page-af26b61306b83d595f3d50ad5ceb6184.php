...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/adding-contact-forms/advantages-using-contact-form" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-29T20:58:52-07:00" />
  <meta name="keywords" content="contact form benefit advantage feedback" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn what the advantages are to using a contact form on your website.  " />
  <title>Advantages of using a Contact Form - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/adding-contact-forms/advantages-using-contact-form" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2b3f75a12b99ca94eca6a1341605446a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.139.181.59']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Advantages of using a Contact Form									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,071</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 2, 2011'><span style='color:#606060;'>Published:</span> Oct 29, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you visit a number of websites around the internet, it is very likely that the majority of those website will have a contact form. A contact form is basically a set of questions filled out on the webpage by your visitor that is automatically sent to your email when it is filled out. Below is a basic example of a contact form on a website:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/contactform.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/contactform.gif" alt="contactform"  /></a></p>
<p>A contact form can be used for just about anything you can think of but here are a few examples of reasons to use a contact form:</p>
<ul>
<li><strong>Feedback</strong>: This is a contact form that is used for general comments from your visitors</li>
<li><strong>Questions</strong>: This form allows visitors to contact you with various questions they may have relating to your business</li>
<li><strong>Service/ Information Request</strong>: If your business sells a service, or product your customers can use this to inquire more information.</li>
</ul>
<p>Some of the major benefits to using a contact form:</p>
<ul>
<li><strong>Reduce Spam</strong>: since contact forms are handled serverside and your email address is not readily available spammers cannot harvest it as easily and this is much safer than using the mailto: tag&nbsp;</li>
<li><strong>Information control</strong>: Since you specify the information you'd like from the customer you can capture the exact information you want from them</li>
<li><strong>Consistency</strong>: Since all the information is provided to you the same way, the emails from the contact form are consistant and can help you stay organized. See more information on email filters</li>
</ul>
<p>Please check the next article on <a target="_blank" href="/support/edu/website-design/adding-contact-forms/how-contact-forms-work" title="Click here to view the next article"> How Contact Forms Work</a>. For more information on this course please visit <a target="_blank" href="/support/edu/website-design/adding-contact-forms" title="Click here to view the courses">Adding Contact Forms</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/website-design/adding-contact-forms'>202: Adding Contact Forms </a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Advantages of using a Contact Form</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/website-design/adding-contact-forms/how-contact-forms-work'>How Contact Forms Work</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/website-design/adding-contact-forms/advantages-using-contact-form&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/website-design/adding-contact-forms/advantages-using-contact-form'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMjMmaWQ9OTYzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="a6be613755fc3450f6fcb7faacdda627" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/website-design/adding-contact-forms?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding Contact Forms </h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/website-design/adding-contact-forms/advantages-using-contact-form?tsrc=rsbedu'>Advantages of using a Contact Form</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/website-design/adding-contact-forms/how-contact-forms-work?tsrc=rsbedu'>How Contact Forms Work</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/website-design/adding-contact-forms/creating-a-contact-form-with-formmail?tsrc=rsbedu'>Creating a Contact Form with FormMail</a></td>
                </tr>
          	</table>
