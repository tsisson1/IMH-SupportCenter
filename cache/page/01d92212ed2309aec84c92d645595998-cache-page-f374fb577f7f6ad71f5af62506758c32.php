<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58645:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/managing-permissions/assign-moderators" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-04T19:57:19-08:00" />
  <meta name="keywords" content="user group assign moderation privilieges phpBB 3.0" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this phpBB 3.0 article you will learn how to assign moderation privileges to users and groups." />
  <title>How to assign moderators to forums in phpBB 3.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/managing-permissions/assign-moderators" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1d96ca5b40cc0cd9e1642e0da2ba7075 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb' itemprop='url'><span itemprop='title'>phpBB<span></a><div class='dropdown_4columns'><h2>phpBB Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/phpbb/getting-started-phpbb'>101: Getting Started in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-forums'>102: Creating Forums in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/working-with-users'>103: Working with Users in phpBB 3.0</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/phpbb/general-settings'>201: Working with General Settings in phpBB 3</a></div><div><a href='/support/edu/phpbb/manage-posting-settings'>202: Working with posting settings in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/managing-permissions'>203: Managing permissions in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-styles'>204: Managing styles and themes in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/maintaining-forum'>205: Forum moderation in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-system-settings'>206: Manging System Settings in phpBB 3.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb/managing-permissions' itemprop='url'><span itemprop='title'>203: Managing permissions in phpBB 3.0<span></a><div class='dropdown_3columns'><h2> Managing permissions in phpBB 3.0</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/phpbb/managing-permissions/copying'>Copying forum permissions in phpBB 3.0</a></div><div>2. <a style='display:inline;' href='/support/edu/phpbb/managing-permissions/assign-moderators'>How to assign moderators to forums in phpBB 3.0</a></div><div>3. <a style='display:inline;' href='/support/edu/phpbb/managing-permissions/edit-roles'>Editing permission roles in phpBB 3.0</a></div><div>4. <a style='display:inline;' href='/support/edu/phpbb/managing-permissions/permissions'>How to change forum level permissions in phpBB 3.0</a></div><div>5. <a style='display:inline;' href='/support/edu/phpbb/managing-permissions/manage-group-permissions'>Adding permissions to your specific phpBB group</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to assign moderators to fo...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to assign moderators to forums in phpBB 3.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,609</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 4, 2013'><span style='color:#606060;'>Published:</span> Jan 4, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>In the beginning, you may be able to administer your forums by yourself. As your community grows, however, you may want to begin assigning individual moderators or moderation groups to your forums.&nbsp; You can assign moderator privilges to either indivirual users or groups, and you can assign moderators either globally, or to individual forums. Below are our instructions on assigning moderator permissions to users and groups and assigning them to forums within your phpBB community.</div>
<h2>Assigning moderators to forums</h2>
<ol class="article_list">
<li><a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">Log into your phpBB admin dashboard</a>.</li>
<li>From there, click on the <strong>Permissions</strong> tab if the screen is not already focused on it.</li>
<li>This leads you to the <em>Permissions</em> tab where you will see a list of categories in a sidebar on the left hand side. Locate and click on the <strong>Forum Moderators</strong> link found under the <em>Forum Based Permissions</em> section.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/click-forum-moderators.png"><img  alt="click on forum moderators" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/click-forum-moderators.png" /></a></li>
<li>This leads you to the <em>Forum Moderators</em> screen. You will see a list of forums where you can choose either one or multiple forums to work with. You can also choose a forum from the lower dropdown which will automatically include any subforums. For our example, we are selecting the forum named <em>Your New Forum</em> for adding moderators. Click the <strong>Submit</strong> button to continue to the next phase.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/choose-forum.png"><img  alt="select form for adding moderators" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/choose-forum.png" /></a></li>
<li>Now we are taken to the <em>Forum Moderators</em> assignement page. The top windows display the users and groups that have moderator permissions for your selected forums. The lower windows display the users or groups you can select to add moderator permissions to.&nbsp; Highlight your desired groups or users and click on the <strong>Add Permissions</strong> button to continuet. We are choosing to add the&nbsp;<em>Global Moderators</em> group to this forum.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/forum-moderator-list.png"><img  alt="add new forum moderators" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/forum-moderator-list.png" /></a></li>
<li>From this screen, we choose which moderator role to assign our <em>Glboal Moderators</em> group. There are five moderator roles to select from. Once you select the desired role, click on the <strong>Apply all permissions</strong> button.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/moderator-role-list.png"><img  alt="select moderator role" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/moderator-role-list.png" /></a><br /><br />
<table class="article_table">
<tbody>
<tr><th>No role assigned</th>
<td>This role should be selected if you wish to assign custom permissions. To view the permissions list for selection, click the <strong>Advanced Permissions</strong> link.</td>
</tr>
<tr><th>Standard Moderator</th>
<td>Has all moderator privileges except the ability to change post authors or ban users.</td>
</tr>
<tr><th>Simple Moderator</th>
<td>Has basic moderaton privileges, but cannot approve posts, change authors, nor can they lock, merge, move, or split topics.</td>
</tr>
<tr><th>Full Moderator</th>
<td>Has all moderation privileges.</td>
</tr>
<tr><th>Queue Moderator</th>
<td>Can simply approve and edit posts, but has no other moderation permissions.</td>
</tr>
</tbody>
</table>
<p>Your user or group should now receive the selected moderation permissions. Returning to the <em>Forum Moderator</em> list screen for the forum now shows our G<em>lobal Moderators</em> in the upper group window, indicating it has moderator permissions.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/new-mod-group-added.png"><img  alt="moderator group added to forum" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/permissions/moderators/new-mod-group-added.png" /></a></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phpbb/managing-permissions'>203: Managing permissions in phpBB 3.0</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to assign moderators to forums in phpBB 3.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/phpbb/managing-permissions/copying'>Copying forum permissions in phpBB 3.0</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/phpbb/managing-permissions/edit-roles'>Editing permission roles in phpBB 3.0</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/managing-permissions/assign-moderators&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/managing-permissions/assign-moderators'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTcmaWQ9MjE0MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b425e035ef36af6330376a48573e78d8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/phpbb/managing-permissions?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing permissions in phpBB 3.0</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/phpbb/managing-permissions/copying?tsrc=rsbedu'>Copying forum permissions in phpBB 3.0</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/phpbb/managing-permissions/assign-moderators?tsrc=rsbedu'>How to assign moderators to forums in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/phpbb/managing-permissions/edit-roles?tsrc=rsbedu'>Editing permission roles in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/phpbb/managing-permissions/permissions?tsrc=rsbedu'>How to change forum level permissions in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/phpbb/managing-permissions/manage-group-permissions?tsrc=rsbedu'>Adding permissions to your specific phpBB group</a></td>
                </tr>
          	</table>
