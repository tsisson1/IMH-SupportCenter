<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51400:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/code-editor-doesnt-display-properly-in-chrome" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear that you're having problems with the code editor. You do have the latest version of Chrome and it's the same version that I am usin..." />
  <title>Code editor doesn't display properly in Chrome | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/code-editor-doesnt-display-properly-in-chrome" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7d4096999b1f7bb3a793fb177161625a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '37.54.106.253']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Code editor doesn't display properly in Chrome</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-01-03 12:32 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>224</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Yesterday I started having problems with Code Editor when used in Chrome browser. When  I select a like of code it is displayed in a slightly shifted location, creating an overlay. I do not seem to have similar problem in IE. I had no problems with Code Editor before. My Chrome version is 39.0.2171.95 m.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6227' id='upvote_answer_6227' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6227' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6227').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6227' id='downvote_answer_6227' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6227' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6227').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear that you're having problems with the code editor.  You do have the latest version of Chrome and it's the same version that I am using.  I tested and don't see any particular issues.  We did not develop the Code Editor in the File Manager (I'm assuming you're referring to the code editor in the cPanel), but we can submit a query to cPanel regarding the issue if there is a bug or problem that they should address.  It may not help with your particular problem, but make sure that you have <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">cleared your browser cache</a> before looking at the file again in Chrome.  You can also adjust the zoom level (of the page view) and the fonts being used to display content.  Either of these will have an effect on how things appear in the browser.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6227').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6227' id='form_comment_on_answer_6227' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/code-editor-doesnt-display-properly-in-chrome&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/code-editor-doesnt-display-properly-in-chrome'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="66c51ea6746213bc408db73edad7e5c1" value="1" />	</div>
	</form>
<!-- <br />
