<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71898:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins/sexy-contact-form-wordpress-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-21T16:15:11-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will walk you through setting up the Sexy Contact Form plugin for Wordpress." />
  <title>Sexy Contact Form Wordpress Plugin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/sexy-contact-form-wordpress-plugin" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:1a26734865250e2371b86a84d6e83b37 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '193.49.41.254']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Sexy Contact Form Wordpress Plugin</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Sexy Contact Form Wordpress Plugin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,475</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 9, 2013'><span style='color:#606060;'>Published:</span> Oct 21, 2013</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('installation');">Installing</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('adding');">Adding a form to your site</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('creating_forms');">Creating forms</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('modifying_fields');">Modifying fields</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('appearance');">Appearance</button>
</div>
<p>In this article, we will walk you through the process of installing, configuring, and implementing the Sexy Contact Form plugin to insert attractive contact forms on your Wordpress site.</p>
<h2>What is Sexy Contact Form?</h2>
<p>Sexy Contact form is a contact form generator plugin for Wordpress that will allow you to easily make attractive contact forms to your visitors to easily contact you with.  While not in the free version, the pro version also allows you to insert an easy to use captcha into the site as well to reduce incoming spam to your inbox as well.</p>
<a name='installation'></a>
<h2>How to install Sexy Contact Form for Wordpress</h2>
<p>Installing Sexy Contact Form is quite easy and is done right through the Wordpress admin dashboard.  Installation can be done in just a few simple steps.</p>
<ol class='article_list'>
<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-1.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>First, log into your Wordpress dashboard and click on plugins on the sidebar to the left.  Then, click on "Add New" at the top of the page.  This page will allow you to install any plugins in the Wordpress plugin database that may be available for your Wordpress installation.</p>
</li>
<li style='clear:both;'>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-2.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>When searching for the words "sexy contact form" within your Wordpress admin, the first result should be the one you want.  Simply click "Install Now" to begin the installation.</p>
</li>
<li style='clear:both;'>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-3.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>The Sexy Contact Form plugin will then be installed to your Wordpress site.  To activate the plugin, just click "Activate Plugin".</p>
</li>
    <div style='clear:both;'></div>
</ol>
<p>Now that the plugin is installed and activated, you may follow along with the next steps to configure Sexy Contact Forms.</p>
<a name='adding'></a>
<h2>Adding Sexy Contact Form to your Wordpress site</h2>
<p>All contact forms from the Sexy Contact Form plugin are entered in using shortcodes.  Shortcodes are small snippets that you may place within any page or post to link conteant within it.</p>
<ol class='article_list'>
<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-4.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>First, you will need to locate your shortcode for your form if ou do not already know it.  To the left of your Wordpress dashboard, you will see a menu option that says "Sexy Contact Form".  If you click on that menu option, it will take you directly into the setup options for Sexy Contact form.</p>
</li>
<li style='clear:both;'>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-5.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Now that you are in the control panel for Sexy Contact Form, click on Forms.  This will allow you to view any forms that are created for your Wordpress site by Sexy Contact form.  This will also display the Shortcode for that particular form.</p>
</li>
<li style='clear:both;'>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-6.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>In a new page or post, such as a page labeled as "Contact Us", add the shortcode that you obtained from the previous step including the opening and closing brackets.  Your form created with Sexy Contact Form will then be inserted on that particular page of your Wordpress site.</p>
</li>
</ol>
<a name='creating_forms'></a>
<h2>Creating new forms with Sexy Contact Form</h2>
<p>In the previous steps, you learned how to install, activate, and insert your form from Sexy Contact Form into your Wordpress site.  Now, we will teach you how to create a new form to use.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-7.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>In the next step, you will click on Sexy Contact Form to the left of your Wordpress dashboard, then click on Forms.  From here, it will display all of your forms available.  With the free version of Sexy Contact Form, you are only allowed a single form.  This is just find if you only need something like a simple contact form.  As you are only allowed a single contact form here if you are using the free version, simply delete the example form and create a new one by clicking on the "New" button.</p>
<div style='clear:both;'></div>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-8.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-8.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Inside the "New Form" interface, ypou will see several options.  Within this article, we will go over a few of the important fields.</p>
<div style='clear:both;'></div>
<ul class='article_list'>
<li>
<p><b>Name:</b> This is the name of the form.  This is something that will only be shown within the back end of your Wordpress dashboard.</p>
</li>
<li>
<p><b>Top Text:</b> This is also the name of your contact form, but will be used on the top of the form when displayed on your website.</p>
</li>
<li>
<p><b>Pre Text:</b> This is the text displayed right under the top text on the from of your contact form.</p>
</li>
<li>
<p><b>Message successfully sent:</b>  This is the message that is displayed to the user once the message is successfully sent using the contact form.</p>
</li>
<li>
<p><b>Send text:</b>  This field determines what the "Send" button says.</p>
</li>
<li>
<p><b>Send new text:</b> This is the text of the "Send new" button on your contact form.</p>
</li>
<li>
<p><b>Close alert text:</b> This is the text that is displayed within the alert box when closing out of the contact form without submitting the information typed.</p>
</li>
<li>
<p><b>Form width:</b> This is the width of the form displayed.  It can be entered in either pixels or a percentage.</p>
</li>
<li>
<p><b>Template:</b> This field determines the particular template that the form will use when being displayed.</p>
</li>
<li>
<p><b>Enable Redirect:</b> This box will determine if your user is redirected to another page after submitting your contact form.</p>
</li>
<li>
<p><b>Redirect Menu Item:</b> In this dropdown box, you can select what page you want your users directed to if you have the Enable Redirect option enabled.</p>
</li>
<li>
<p><b>Redirect URL:</b> If you want your form to redirect to a specific URL instead of a specific page on your Wordpress site, you would enter that URL here.</p>
</li>
<li>
<p><b>Redirect delay:</b> This option determines how long the Sexy Contact forms plugin will wait after the submission of the form to redirect to the page you have defined. (In miliseconds. 1000=1 second)</p>
</li>
<li>
<p><b>Show send me copy:</b> This option determines if users are able to request a copy of the form that they sent to you.</p>
</li>
<li>
<p><b>Send me a copy text:</b> This field allows you to change that the "Send me a copy" button looks like on the contact form.</p>
</li>
</ul>
<p>Once you have created a new form, you may edit the shortcode within the page that you want Sexy Contact Form to display in, if you need to.  It will then use your new form options that you have put in place.</p>
<a name='modifying_fields'></a>
<h2>Modifying form fields in Sexy Contact Form</h2>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-9.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-9.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Modifying form fields within the Sexy Contact Form plugin for Wordpress is quite simple.  To do so, click on Sexy Contact Form to the left of your Wordpress dashboard.  From here, then click on Fields.</p>
<div style='clear:both;'></div>
<p>By default, some example fields will already be there.  You may modify these or create new ones.  If you are using the free version of the Sexy Contact Form Wordpress, you are limited to a maximum of 5 fields.  This should be enough for more fimple contact forms.  If you need to add an additional one, you will first need to delete a field.  This can be done by selecting the filed with the checkboxes to the left and then clicking Delete to the right.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-10.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-10.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>To create a new form field in Sexy Contact Form, click on New.  From here, you may select various options such as Name, Form, Type, Required, and Status.</p>
<div style='clear:both;'></div>
<ol class='article_list'>
<li>
<p>First, enter the field name.  This is a unique name that you want to display in both the contact form as well as any emails you receive from it.</p>
  </li>
<li style='clear:both;'>
    <p>Then, determine the particular contact form that you want the field to be associated with and use the dropdown box to select it.</p>
  </li>
<li style='clear:both;'>
<p>Next, enter the type of field it will be.  Try to pick the one that best matches what the user will be submitting as Sexy Contact Form will adjust the field being displayed accordingly.</p>
  </li>
<li style='clear:both;'>
    <p>Then, just select the radio buttons to determine if the field is something that is required for the user to submit the form, as well as if it is published or not.</p>
</li>
    </ol>
<a name='appearance'></a>
<h2>Editing the appearance of Sexy contact Form</h2>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-11.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/sexy-contact-form-11.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Sexy Contact Form comes with several templates, as well as many other options within the Templates section of the Sexy Contact form settings.  There are several options here that you can change around to adjust the look and feel of the form.  While we will not go over every one of these settings in this article, I do recommend reviewing each of them to enable the best look and feel that will appropriately match your site.  The pre-created templates are also quite attractive and will still lead to good results.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-plugins/sexy-contact-form-wordpress-plugin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-plugins/sexy-contact-form-wordpress-plugin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjcmaWQ9Mjg3NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e859412eccdd98aa54584e6dc7fd4b72" value="1" />	</div>
	</form>
<!-- <br />
