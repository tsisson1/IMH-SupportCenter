<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49727:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/how-do-you-format-a-csv-file-to-import-selected-email-addresses" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question. I recommend following our full walk-through guide on how to &quot;Import Email Accounts/Forwarders in cPanel&quot; It explains..." />
  <title>How do you format a .csv file to import selected e-mail addresses? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/how-do-you-format-a-csv-file-to-import-selected-email-addresses" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:40aeb48a7df878b2bde53d66246dad19 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do you format a .csv file to import selected e-mail addresses?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-01-30 2:14 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>162</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>What format should a .csv or .vcf file be in to import correctly. Are there field tags to show where the e-mail address should be positioned, for instance, in the comma-delimited data list? should a ,NULL, or ,, be used where there is no data for a field like the First Name?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4482' id='upvote_answer_4482' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4482' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4482').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4482' id='downvote_answer_4482' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4482' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4482').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question. I recommend following our full walk-through guide on how to "<a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/import-email-accounts-forwarders-in-cpanel">Import Email Accounts/Forwarders in cPanel</a>"<br />
<br />
It explains the delimiters, and how to access the example <em>.csv</em> or <em>.xls</em> file from cPanel. It only requires 3 fields: (Email,Password,Quota) so none of them should be blank.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4482').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4482' id='form_comment_on_answer_4482' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/how-do-you-format-a-csv-file-to-import-selected-email-addresses&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/how-do-you-format-a-csv-file-to-import-selected-email-addresses'></div>
<script type='text/javascript'>
  (function() {
