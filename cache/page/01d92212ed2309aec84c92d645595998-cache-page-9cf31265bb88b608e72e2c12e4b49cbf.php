<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54268:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/is-there-a-difference-betwwen-the-registry-key-and-the-authorization-code-for-transferring-domains" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello dbjune, Thank you for your question. Please see our full guide How to unlock your domain name and retrieve your Authorization Code, it explains ho..." />
  <title>Is there a difference betwwen the registry key and the authorization code for transferring domains?    | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/is-there-a-difference-betwwen-the-registry-key-and-the-authorization-code-for-transferring-domains" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7bfd0811c5bd6806a82fc2bf825ca5f0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '72.229.19.88']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Is there a difference betwwen the registry key and the authorization code for transferring domains?   </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/PeggyG'>PeggyG</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-06-04 4:20 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,293</span>
			</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>How do I get the Authorization code to transfer away from Inmotion/MelbourneIT?</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/dbjune'>dbjune</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-03-18 12:02 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1108' id='upvote_answer_1108' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1108' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1108').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1108' id='downvote_answer_1108' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1108' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1108').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello PeggyG,<br />
<br />
Yes, there is a difference.  IF your domain registrar is the same as our domain registrar, then the registry key for transferring a Melbourne IT (our domain registrar) to Melbourne IT account is required.  If it's different, then you would need to use the authorization code to transfer the domain.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1108').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1108' id='form_comment_on_answer_1108' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_6817' id='upvote_answer_6817' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6817' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6817').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6817' id='downvote_answer_6817' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6817' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6817').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello dbjune,<br />
<br />
Thank you for your question. Please see our full guide <a href="http://www.inmotionhosting.com/support/domain-names/registrations-and-transfers/how-to-unlock-domain-name-retrieve-authorization-code">How to unlock your domain name and retrieve your Authorization Code</a>, it explains how the process works.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6817').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6817' id='form_comment_on_answer_6817' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/is-there-a-difference-betwwen-the-registry-key-and-the-authorization-code-for-transferring-domains&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/is-there-a-difference-betwwen-the-registry-key-and-the-authorization-code-for-transferring-domains'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="0cc62c499c36df6f4e5e2d5a3d901503" value="1" />	</div>
	</form>
<!-- <br />
