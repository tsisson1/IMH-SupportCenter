<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49134:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/set-configure-catalog-modes" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="set configure catalog modes PrestaShop 1.5" />
  <meta name="description" content="This PrestaShop 1.5 course covers how to set and configure catalog modes." />
  <title>112: Setting and Configuring Catalog Modes | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/set-configure-catalog-modes" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:36f8a1963ffcc01a4ef4740e3d691568 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '87.12.238.178']);
...
<div class='page-header'>
	<h1>112: Setting and Configuring Catalog Modes</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Modes</h2><div>Set and configure catalog modes</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/set-configure-catalog-modes/set-catalog-mode'>How to set Catalog Mode in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 article explains how to set your store into Catalog mode, turning off the ability for customers to purchase on the site.</div>
					<div class='smallgrey'>Hits: 13,726</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/set-configure-catalog-modes/enable-b2b-mode'>How to enable B2B mode in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial shows you how to enable B2B (business to business) mode.</div>
					<div class='smallgrey'>Hits: 9,459</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/set-configure-catalog-modes/how-to-set-maintenance-mode-in-prestashop-15'>How to set Maintenance mode in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial demonstrates how to set the store to Maintenance mode.</div>
					<div class='smallgrey'>Hits: 18,350</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/set-configure-catalog-modes/redirection-after-adding-product'>Changing Page Redirection After Adding Products in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial shows how to change the page a customer is redirected to after adding a product to their cart.</div>
					<div class='smallgrey'>Hits: 5,067</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/set-configure-catalog-modes/show-previous-shopping-cart'>How to show the last shopping cart in PrestaShop 1.5</a>
					<div>Learn how to display the customer's shopping cart from their previous visit in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 2,387</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/set-configure-catalog-modes/setting-search-engine-friendly-urls'>How to set up Search Engine Friendly URLs in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 article helps you understand how to enable the Friendly URL setting.</div>
					<div class='smallgrey'>Hits: 4,340</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>This PrestaShop 1.5 tutorial explains how to turn on error reporting for troubleshooting and debugging.</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTEmaWQ9MjkxJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a9ba6c0621d7a64a81a1d9fb1b11e8fd" value="1" />	</div>
	</form>
<!-- <br />
