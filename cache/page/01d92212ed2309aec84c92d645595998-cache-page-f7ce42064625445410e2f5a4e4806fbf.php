<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68456:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/will-you-support-lets-encrypt" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="After waiting a reasonable amount of time for InMotion to support this, I moved to another host that does support it. Now I have a free certificate on a..." />
  <title>Will you support Let's Encrypt? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/will-you-support-lets-encrypt" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4e724c2e38543a095e7b7591ce422670 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Will you support Let's Encrypt?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/ssl'>Ssl</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/manunkind'>manunkind</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-11-02 9:47 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>946</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Will you guys be supporting the Let's Encrypt initiative when it rolls out?  If so, what are the requirements of use?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>I hope that InMotion will support Let's Encrypt for those of us with shared hosting plans in the near future. There is a CPanel plugin available now, and more and more hosts are offering Let's Encrypt to their customers. I am currently recommending that my clients choose a host that supports Let's Encrypt. </div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/Marla'>Marla</a><br />
					10 <a href='/support/team/points' target='_blank'>Points</a><br />
					2016-03-12 10:17 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>On March 8, 2016, Let's Encrypt issued its millionth certificate after seven months of existence.[39] 44 days later, on April 21, 2016, they had issued over 2,000,000 certificates.[40]<br />
<br />
On April 12, 2016, Let's Encrypt left Beta.[41]<br />
Let’s Encrypt is leaving beta today. We’re also excited to announce that founding sponsors Cisco and Akamai have renewed their Platinum sponsorships with 3-year commitments, Gemalto is joining as our newest Gold sponsor, and HP Enterprise, Fastly, Duda and ReliableSite.net are our newest Silver sponsors.<br />
<br />
Since our beta began in September 2015 we’ve issued more than 1.7 million certificates for more than 3.8 million websites. We’ve gained tremendous operational experience and confidence in our systems. The beta label is simply not necessary any more.<br />
<br />
Will you support Let's Encrypt?<br />
Thanks</div>
			...
			<td style='width:100px;' valign='top'>
				<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/ndweb'>ndweb</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2016-05-04 10:48 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8442' id='upvote_answer_8442' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8442' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8442').submit();"></div>
	</form>
	<div class='vote_sum'>-3</div>
	<form method='post' name='downvote_answer_8442' id='downvote_answer_8442' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8442' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8442').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello manunkind,<br />
<br />
Thank you for your question on Let's Encrypt.  We have no immediate plans to support Let's Encrypt. It will first need to go through extensive evaluation and testing from our security tier before a decision can be made. We are not ruling it out, we simply need time and data to test.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8442').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8442' id='form_comment_on_answer_8442' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Any update on support for Let's Encrypt? It is now in public beta with over 250,000 certificates running. Is it possible to set up a certificate according to letsencrypt's 'Get Started' guide? (https://community.letsencrypt.org/t/quick-start-guide/1631) Or would we have to wait until InMotion chooses to offer the service through the control panel?<br />
<br />
Thanks,<br />
<br />
Luke</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/lukenjohnson'>lukenjohnson</a><br />
									6 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-01-05 1:46 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>We do not have plans to support Let's Encrypt at this time. </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-AmEnso4E7cE/AAAAAAAAAAI/AAAAAAAAAB8/-OBGtrb_6VM/s90-p-rw-no/photo.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/christopherm'>christopherm</a><br />
									3,380 <a href='/support/team/points' target='_blank'>Points</a>
...
<br />
Let's Encrypt is gaining popularity and is backed by top companies including Automattic, the folks behind WordPress, as well as Facebook, Mozilla, Chrome, Cisco and Sucuri. Can you update us on Inmotion's thoughts about supporting LE? </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/syllogic'>syllogic</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-02-18 5:55 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello syllogic,<br />
<br />
Thank you for contacting us. We still currently have no plans to support Let's Encrypt.<br />
<br />
Let's encrypt is still in a beta stage of production, and is not supported in the latest stable release of cPanel (which we use). Thre is currently a <a href="https://features.cpanel.net/topic/provide-support-for-lets-encrypt-automated-certificate-management-ssl" target="_blank" rel="nofollow">ticket open</a> with cPanel to provide support,  but the security and compatibility must still be worked out.<br />
<br />
Because of its relatively untested nature, introducing this software on a shared server can potentially negatively impact a large number of other users on the server. <br />
<br />
Also, I could not identify any level of warranty to protect purchasers on your site.<br />
<br />
Thank you,<br />
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I understand InMotion's hesitation to introduce LE for shared hosting. But could LE be adopted more quickly for VPS / Dedicated servers, since those environments are isolated?</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello lukenjohnson,<br />
<br />
Well you could incorporate it with root access but it may conflict with cPanel. That is until they validate that it can work with their software.<br />
<br />
Best Regards,<br />
TJ Edens</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-fI7zh5HdUcw/AAAAAAAAAAI/AAAAAAAAADs/nezrUM_KGls/s50-p-rw-no/photo.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/TJEdens'>TJEdens</a><br />
									9,548 <a href='/support/team/points' target='_blank'>Points</a>
									<div style='padding-left:20px; background:url(/support/templates/supportcentertemplate/images/gold_star.png) no-repeat 0px 2px;background-size:12px 12px;'>Staff</div>
									2016-02-20 3:29 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Let's Encrypt is now out of Beta and has a stable release. Does InMotion Hosting plan on adding support soon?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/rdytog5'>rdytog5</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-04-15 2:40 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello,<br />
<br />
This can be installed on VPS+ servers but at this time we do not have a time frame of when it will be added to any shared servers.<br />
<br />
Best Regards,<br />
TJ Edens</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello NDweb,<br />
<br />
Thanks for the comment and update on Let's Encrypt.  We still do not have any immediate plans to support Let's Encrypt.  As our servers use cPanel, we depend on the updates from cPanel for the support of specific certificate providers.<br />
<br />
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_9898' id='upvote_answer_9898' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9898' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9898').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9898' id='downvote_answer_9898' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9898' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9898').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='/support/images/avatars/default_avatar.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/Marla'>Marla</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2016-05-13 5:35 pm EST
                		        </div>
					
		                </div>

				After waiting a reasonable amount of time for InMotion to support this, I moved to another host that does support it. Now I have a free certificate on all of my add-on domains with no need to purchase dedicated hosting or pay for SSL certificates. If InMotion would have given an indication that they were working on supporting Let's Encrypt, I would have waited.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9898').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9898' id='form_comment_on_answer_9898' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I am not at this stage yet, but this is certainly something that I would consider when I renew my annual sub to an host. Lets make the web more secure.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/nbernaz@gmail&per;com'>nbernaz@gmail.com</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-05-17 3:09 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>As stated above anyone with a VPS/Dedicated hosting plan with InMotion Hosting can test out Let's Encrypt with no limitation.<br />
<br />
Regarding an effort to make the web more secure, SSLs purchased from vendors like Comodo are secure and meet rigorous industry standards.<br />
<br />
It is only because InMotion Hosting cares about the security and success of their customers that they want to make sure Let's Encrypt would work as expected with the hosting services they offer before rushing to meet a fairly recent demand.</div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="92486dfabf74659c0031073c522ea7a2" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/how-to-force-https-using-the-htaccess-file'>How to force HTTPS using the .htaccess file</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/request-csr-in-amp'>Requesting a CSR for 3rd Party SSLs in AMP</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/sha-1'>How to Fix the Insecure SSL Error due to SHA-1 Deprecation </a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/request-csr-via-amp'>How to request a CSR via AMP</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/comodo-ssl-certificate-details'>Comodo SSL certificate details</a><br/><br />
		</div>
