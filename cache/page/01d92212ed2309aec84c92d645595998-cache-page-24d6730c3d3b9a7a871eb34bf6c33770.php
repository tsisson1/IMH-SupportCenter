...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/i-keep-getting-a-fatal-error-when-i-log-into-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Wendelika, Thank you for your question. This type of error is commonly caused by a bad Wordpress Plugin. Since the plugins are coded by separate 3..." />
  <title>I keep getting a fatal error when I log into Wordpress | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/i-keep-getting-a-fatal-error-when-i-log-into-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a0af27df715a68395249acfe1572e577 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I keep getting a fatal error when I log into Wordpress</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Wendelika'>Wendelika</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-20 6:31 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>237</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Fatal error: Call to undefined function is_user_admin() in /home/clinea5/public_html/homebaking/wp-admin/index.php on line 27</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2472' id='upvote_answer_2472' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2472' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2472').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2472' id='downvote_answer_2472' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2472' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2472').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Wendelika,<br />
<br />
Thank you for your question. This type of error is commonly caused by a bad Wordpress Plugin. Since the plugins are coded by separate 3rd party developers, this type of incompatibility can occur. You can troubleshoot the issue by disabling the plugins.  Rename your Wordpress plugin folder,  in the root of your wordpress site look for:<br />
/wp-content/plugins<br />
<br />
Rename the plugins folder something like:<br />
plugins.old<br />
<br />
Now create a new folder called plugins, and move them one at a time from: plugins.old<br />
To: plugins<br />
<br />
Test your site after you move each plugin, and when you get the fatal error, then you know it was the last plugin you moved.<br />
<br />
Just delete or replace the plugin to stop the error.<br />
<br />
If you have any further questions, feel free to post them below, or contact live Tech Support.<br />
<br />
They are available 24/7 via:<br />
Email: <a href="mailto:support@inmotionhosting.com">support@inmotionhosting.com</a><br />
Phone: 	888-321-HOST (4678)<br />
  	757-416-6575 (Intl.)<br />
&<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2472').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2472' id='form_comment_on_answer_2472' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/i-keep-getting-a-fatal-error-when-i-log-into-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/i-keep-getting-a-fatal-error-when-i-log-into-wordpress'></div>
<script type='text/javascript'>
  (function() {
