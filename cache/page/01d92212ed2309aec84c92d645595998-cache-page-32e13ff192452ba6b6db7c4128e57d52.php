<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50742:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/i-cannot-configure-the-advance-parameters-for-email-in-prestashop-16" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, I looked over your PrestaShop SMTP settings and they looked to be incorrect. It looks like you were trying to use port 110 which is not the port ..." />
  <title>I cannot configure the advance parameters for email in Prestashop 1.6 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/i-cannot-configure-the-advance-parameters-for-email-in-prestashop-16" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6e72ec62f83bfd349773f3c86cb164dd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '88.184.216.182']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I cannot configure the advance parameters for email in Prestashop 1.6</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-06-27 1:10 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,551</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to configure my email on Prestashop but receiving error messages when I send a email test.  I have tried using the PHP mail function and set my own SMTP but I receive this..<br />
Error: Please check your configuration<br />
Sending failed using mail() as PHP's default mail() function returned boolean FALSE.<br />
or<br />
Error: Please check your configuration<br />
There was a problem reading line 2 of an SMTP response. The response so far was:<br />
[-ERR Invalid command. ]. It appears the connection has died without saying goodbye to us! Too many emails in one go perhaps? (fsockopen: #0) <br />
Please help :)</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5179' id='upvote_answer_5179' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5179' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5179').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5179' id='downvote_answer_5179' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5179' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5179').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
I looked over your PrestaShop SMTP settings and they looked to be incorrect. It looks like you were trying to use port &lt;strong&gt;110&lt;/strong&gt; which is not the port on the sever for SMTP, which is &lt;strong&gt;25&lt;/strong&gt;.<br />
<br />
I went ahead and tested using a temporary email account I created on your domain and I was able to get it to work using the following settings:<br />
<br />
&lt;ol class=&quot;article_list&quot;&gt;<br />
&lt;li&gt;&lt;a href=&quot;http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/login-to-dashboard&quot; target=&quot;_blank&quot;&gt;Login to PrestaShop Dashboard&lt;/a&gt;&lt;/li&gt;<br />
&lt;li&gt;Click on &lt;strong&gt;Advanced Parameters&lt;/strong&gt;, and then &lt;strong&gt;E-mail&lt;/strong&gt;&lt;/li&gt;<br />
&lt;li&gt;Under the &lt;strong&gt;Email&lt;/strong&gt; section, change the &lt;strong&gt;SMTP user&lt;/strong&gt; and &lt;strong&gt;SMTP password&lt;/strong&gt; to a valid email account. Ensure you can &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail&quot; target=&quot;_blank&quot;&gt;login to webmail&lt;/a&gt; with this account to ensure you're using the right credentials&lt;/li&gt;<br />
&lt;li&gt;Leave the &lt;strong&gt;Port&lt;/strong&gt; to &lt;strong&gt;25&lt;/strong&gt;&lt;/li&gt;<br />
&lt;li&gt;Under the &lt;strong&gt;Test your email configuration&lt;/strong&gt; type in an email address to test with then click on &lt;strong&gt;Send an email test&lt;/strong&gt;. You should get a message indicating &lt;strong&gt;A test email has been sent to the email address you provided.&lt;/strong&gt;&lt;/li&gt;<br />
&lt;/ol&gt;<br />
<br />
...
- Jacob
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5179').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5179' id='form_comment_on_answer_5179' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/i-cannot-configure-the-advance-parameters-for-email-in-prestashop-16&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/i-cannot-configure-the-advance-parameters-for-email-in-prestashop-16'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="55933fe82f54f7a1a94d0dd1ef9d7bbe" value="1" />	</div>
	</form>
<!-- <br />
