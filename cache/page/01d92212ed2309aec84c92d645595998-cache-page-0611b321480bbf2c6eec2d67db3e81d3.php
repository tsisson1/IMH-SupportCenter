<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73193:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/how-can-i-connect-via-ftp-using-filezilla-i-get-a-530-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I just experienced the same problem. Filezilla needed to be updated. I updated it and then I got the same error except this time the error message was m..." />
  <title>How can I connect via FTP using FileZilla? I get a 530 error.  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/how-can-i-connect-via-ftp-using-filezilla-i-get-a-530-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5e115b405f970756a4a04f9172e5c171 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.4.11.5']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/community-support' itemprop='url'><span itemprop='title'>Community Support<span></a><div class='dropdown_1column'>
<div class='col_1'>
	<a href='/support/community-support'><h2>Community Support</h2></a>
	<ul>
		<li><a href='/support/community-support'>Browse Questions</a></li>
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>How can I connect via FTP using FileZilla? I get a 530 error. </h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/file-management'>File Management</a></div>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'></div>
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='/support/images/avatars/avatar_314391382.jpg' class='user_avatar' /><br />
			<a href='/support/community-support/users/CarlosBerman'>CarlosBerman</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-09 12:46 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>107,980</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi,<br />
<br />
I've a problem connecting with my site by FTP, first I create an account in cPanel, but when I try to connect with filezilla I can't, a see a message: <br />
<br />
USER OK<br />
Response:	530 Login authentication failed<br />
Error:	Critical error<br />
Error:	Could not connect to server<br />
<br />
I changed my password many times, but the problem persist.<br />
<br />
I also created 3 users, with all of them the same problem.<br />
<br />
I used my domain name, my domain name using ftp., the server name(ecbiz115...), the temp URL, the server IPs, nothing works.<br />
<br />
What happens?<br />
<br />
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Yes. I am facing this problem.</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='https://lh6.googleusercontent.com/-k05Wj8A1K-M/AAAAAAAAAAI/AAAAAAAAABY/H8wral92gg4/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/sanjit733'>sanjit733</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-03-21 11:36 am EST
				</div>
			</td>
		</tr>
	</table>
...
<h2 style='border-bottom:1px solid #ddd; margin-top:30px; padding-bottom:10px; margin-bottom:20px; color:#000; font-size:18px;'>OTHER ANSWERS</h2>
<div class=' straight_bottom not_best_answer'>
	
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_546' id='upvote_answer_546' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='546' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_546').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_546' id='downvote_answer_546' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='546' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_546').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-NBh2f5kDJfQ/AAAAAAAAAAI/AAAAAAAAACU/6SP6_r-gSAQ/s90-p-rw-no/photo.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/Tim S'>Tim S</a>
					<div style='padding-left:20px; background:url(/support/templates/supportcentertemplate/images/gold_star.png) no-repeat 0px 2px;background-size:15px 15px;'>Staff</div>
					<div>11,071 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-02-09 9:14 am EST
                		        </div>
				...
				Hi Carlos,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. I created a test FTP account and verified everything is working correctly. Filezilla connected to the server without any errors. Typically, a 530 error means your settings are not correct. Here is the correct settings:<br />
<br />
<strong>Host</strong>: cursosenhd.com<br />
<strong>Username</strong>: the full username (such as test@cursosenhd.com)<br />
<strong>password</strong>: the password you created when you set up the FTP account<br />
<br />
<br />
Alternatively you can use your cPanel username in the place of the username above and the cPanel password replacing the FTP password. However, if these accounts are for other users, we do not advise giving out your cPanel credentials. <br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_546').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_546' id='form_comment_on_answer_546' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div>
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>hi carlos,<br />
i am using Filezilla from last 1 year but i got same 503 error from last day.....i didn't get anything wrong in my ftp and i didn't change any settings os filezilla.....Please let me know what is the problem with filezilla.......<br />
Resolving address of ftp.xxxxxxxxx<br />
Status:	Connecting to xxxxxxxxxx...<br />
Status:	Connection established, waiting for welcome message...<br />
Response:	220 Microsoft FTP Service<br />
Command:	USER xxxxxxxxxxxx<br />
Response:	331 Password required for xxxxxxxx.<br />
Command:	PASS *********<br />
Response:	530 User xxxxxxx cannot log in.<br />
Error:	Critical error<br />
Error:	Could not connect to server </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/madhan'>madhan</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-05-21 11:53 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello madhan,<br />
<br />
I found a <a href="https://forum.filezilla-project.org/viewtopic.php?f=2&t=24303">discussion of a similar issue</a> on FileZilla's official support forum. As per this forum, " You often get 530 if your login data isn't accepted anymore by the server. "<br />
<br />
I saw you are connecting to a Windows server <em>(Response:220 Microsoft FTP Service)</em>, I would check with your host to make sure you still have access to the server. <br />
<br />
Also, check your firewall settings to make sure it is not being blocked there. <br />
<br />
If you are using a domain name as a hostname, <a href="http://www.inmotionhosting.com/support/domain-names/general-information/how-to-look-up-domain-whois">check the whois</a> to make sure it hasn't expired, and it is still pointed to the correct nameservers.<br />
<br />
...
-John-Paul</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='http://lh3.googleusercontent.com/-Qzm5Afwbl4g/AAAAAAAAAAI/AAAAAAAAAEc/CXPngTPySFA/s120-c/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/John-Paul'>John-Paul</a><br />
									22,986 <a href='/support/team/points' target='_blank'>Points</a>
									<div style='padding-left:20px; background:url(/support/templates/supportcentertemplate/images/gold_star.png) no-repeat 0px 2px;background-size:12px 12px;'>Staff</div>
									2013-05-22 11:06 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>This is absolutely correct!!! <br />
I also had the same problem but knew my credentials were all ok. Still I faced the critical error.Now Tim's answer saved me....thanks Tim a lot.... you are a life savior!! :)))</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/avik.sarkar.796/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/obheek9'>obheek9</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-01-30 10:30 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Tim,<br />
<br />
I have exactly the same problem but I did'nt understood very help your instructions.<br />
<br />
I'm not sure if I can explain myself as my english is not so good:(<br />
<br />
A friend gave me this site that I use now for my business, but as far as I know my site was hosted in a server that they use together with other site they have. <br />
<br />
Now they sold that other site to someone and I no longer as access to the server. So I think that myght be the problem that Filezilla give me that error.<br />
<br />
I do not have acess to the site as well, it gives me the &quot;error 404 page not found&quot;<br />
<br />
Thanks<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/merces.p.machado/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/minta64'>minta64</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-03-06 5:47 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello minta64.<br />
<br />
It sounds as if your site was removed and the FTP credentials were changed.  To resolve the issue, you will need to contact the individual in charge of the account.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-ML7FcuvnOJw/AAAAAAAAAAI/AAAAAAAAAB0/UiLncgP8kr8/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/JeffMa'>JeffMa</a><br />
									11,186 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-03-07 11:14 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Tim!<br />
I have created a subdomain on 000webhost and want to upload some of the files to it.<br />
While i try to do it through Filezilla, i am facing the same login authentication failed error as mentioned above.<br />
The user name given to me isn't of the form test@example.com instead is an alphanumeric string. I am trying to login through that user name, password and the hostname and everytime the authentication fails. any help? <br />
</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/mahulivishal'>mahulivishal</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-11-19 6:13 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>doing same as you said but again same error</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-w_X_z0fUx58/AAAAAAAAAAI/AAAAAAAACH8/CyIKDGDRWBw/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/hardeep27'>hardeep27</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-04-20 7:29 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Hardeep, <br />
<br />
Sorry for the problem with using FileZilla.  We need to know the steps you're taking, the version of FileZilla and any errors that you're seeing.   Can you please provide us a URL to review if the problem is repeating?  Also, if you can copy the logged messages with your connection attempt .  This would give us valuable information to determine what's happening.  <br />
<br />
...
Arnel C.</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-np8xy9GiNy8/AAAAAAAAAAI/AAAAAAAAAEU/Eu1yKGoTxiA/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Arn'>Arn</a><br />
									32,263 <a href='/support/team/points' target='_blank'>Points</a>
									<div style='padding-left:20px; background:url(/support/templates/supportcentertemplate/images/gold_star.png) no-repeat 0px 2px;background-size:12px 12px;'>Staff</div>
									2016-04-20 9:33 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I tried in the same way as you mentioned. but still the result is same :(<br />
but this time am getting messages like this<br />
...
Command:	PASV<br />
Response: 	227 Entering Passive Mode (83,138,8,111,196,88)<br />
Command:	MLSD<br />
Error:        	The data connection could not be established: ECONNREFUSED - Connection refused by server<br />
what should I do now ?? please tell me</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-hO4aMuJfgA4/AAAAAAAAAAI/AAAAAAAAA-A/XEOZK4rPUOA/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/mithranabraham'>mithranabraham</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-04-28 9:17 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello mithranabraham,<br />
<br />
Thank you for contacting us. As a test, try using the "quickconnect" section of FileZilla, since it uses the default settings.<br />
<br />
Ensure your server is allowing access, and is not blocking your IP from the firewall.<br />
<br />
Also, review the <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">FTP logs</a> for additional clues/errors, or record of your connection.<br />
 <br />
Thank you,<br />
John-Paul</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4944' id='upvote_answer_4944' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4944' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4944').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4944' id='downvote_answer_4944' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4944' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4944').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/alto5400'>alto5400</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-05-11 2:48 pm EST
                		        </div>
					
		                </div>

				hi, the same is happening to me at Godaddy in 90% of my tries. Then suddenly - without changing anything - it works. It seems to depend on the time of day. Godaddy couldn't resolve the problem. They said everything worked fine - even though I sent them the logs with the error messages and reset my PW several times.<br />
In the meantime - as long as I'll have to stay with that host - I do my FTPs when everybody else is supposed to sleep and then it works. Very annoying but what can I do with no real support? Cheers alto
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4944').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4944' id='form_comment_on_answer_4944' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Ho Alto, Hope I can fix this for you on Godaddy ... Believe it or not, You cPanel PW is the answer top your problem. Most think it's the FTP you created. NOPE! This is only with Godaddy that I have figured it out on. Not sure what others are like. Make sure the FTP Account name is the same but for some reason as I stated, The FTP account PW is not right, It's your cPanel PW. Hope this helps. </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/rscd@live&per;com'>rscd@live.com</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-10-05 7:59 am EST
								</div>
...
<div class='  not_best_answer'>
	
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5601' id='upvote_answer_5601' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5601' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5601').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5601' id='downvote_answer_5601' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5601' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5601').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh6.googleusercontent.com/-t_vWcclLNL4/AAAAAAAAAAI/AAAAAAAABeg/K97jo2MQ6OI/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/reenamn'>reenamn</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-09-10 12:57 pm EST
                		        </div>
					
		                </div>

				I just experienced the same problem. <br />
Filezilla needed to be updated. I updated it and then I got the same error except this time the error message was more descriptive.<br />
Response: 	530 Login authentication failed<br />
Status:      	Check your login credentials. The entered password starts or ends with a space character.<br />
Error:        	Critical error: Could not connect to server<br />
<br />
Aha... the entered password had a space at the end... gosh darn it!<br />
That fixed the problem. Hope this helps others.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5601').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5601' id='form_comment_on_answer_5601' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/how-can-i-connect-via-ftp-using-filezilla-i-get-a-530-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/how-can-i-connect-via-ftp-using-filezilla-i-get-a-530-error'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a3355fec2bc3875cbd834e8fbc9a2c2e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/zip-unzip-win7'>Zip and Unzip Files using Windows 7</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-enable-ssh-through-whm'>How to enable SSH through WHM</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/best-practice-for-naming-files-in-linux'>Best practice for naming files in Linux</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/view-ftp-uploads-with-archived-raw-logs'>View FTP uploads with archived raw logs</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/changing-the-document-root-with-root-access'>Changing the document root for your domain</a><br/><br />
		</div>
