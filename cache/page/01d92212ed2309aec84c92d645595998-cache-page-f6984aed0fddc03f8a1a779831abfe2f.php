<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55828:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-access-cpanel-why-do-i-get-a-timeout-error-message" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Vinnie_lannone, Thanks for posting your question. I'm more than happy to assist you today. I've tested your account to be sure that there was no issu..." />
  <title>I cannot access cPanel. Why do I get a timeout error message? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-access-cpanel-why-do-i-get-a-timeout-error-message" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d6a9a2a8c0f3432cbcdab74dc5fae1db -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '74.132.25.87']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I cannot access cPanel. Why do I get a timeout error message?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='/support/images/avatars/avatar_314355890.jpg' class='user_avatar' /><br />
			<a href='/support/community-support/users/Vinnie_Iannone'>Vinnie_Iannone</a>
			<div>11 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-01-19 11:48 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>11,730</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I've been trying to access the cPanel throughout the day today and I keep getting a timeout.  Things seem to be ok on my end, so I figured the thing to do was ask.<br />
<br />
I'm just trying to login to cpanel via IE and chrome, results in page timeouts.<br />
<br />
I've tried going to my domain name/cpanel and through the link in the amp homepage.<br />
<br />
Google Chrome could not load the webpage because secure***.inmotionhosting.com took too long to respond. The website may be down, or you may be experiencing issues with your Internet connection.<br />
<br />
Is there any reason this would consistently time out?<br />
<br />
Just tried firefox as well.  I ran a speed test @ http://www.speedtest.net/ and got a 16ms ping with a 25.5mbps per sec download.<br />
<br />
I'm never successfully connecting to the cPanel  and upon going to it via the amp panel it redirects and times out.  If I try to access it directly from adding /cpanel to the end of a url it doesn't get found.<br />
<br />
Thanks Tim, any idea what in my firewall might be preventing this?  Haven't had any trouble until a few days ago and I seem to be able to access the rest of the net normally.  Any specific thing you'd recommend I look for?<br />
<br />
IP addy :24.6.19.5</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_436' id='upvote_answer_436' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='436' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_436').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_436' id='downvote_answer_436' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='436' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_436').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,071 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-01-20 5:13 pm EST
                		        </div>
					
		                </div>

				Hi Vinnie_Iannone,<br />
<br />
Thanks for getting back to me. I'm more than happy to help you. Please respond back with your IP address and I'll be happy to check the server's blacklist to make sure your IP address is not being blocked by the server. You can check your IP address by going to this URL:<br />
<br />
<a href="http://www.inmotionhosting.com/support/ipcheck.php">What is my IP address?</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_436').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_436' id='form_comment_on_answer_436' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_432' id='upvote_answer_432' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='432' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_432').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_432' id='downvote_answer_432' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='432' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_432').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,071 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-01-20 9:02 am EST
                		        </div>
					
		                </div>

				Hi Vinnie_lannone,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. I've tested your account to be sure that there was no issue with <a href='http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel'>logging into cpanel</a> and I was able to log into cPanel using AMP without any issues. I also visited the biz107.inmotionhosting.com/cpanel to be sure it redirected correctly and it does. You may want to check if you are behind a firewall on your local network to see if thats the issue. You can also try and accessing cpanel through this link:<br />
<br />
<a href="http://cpanel.vincentiannone.com/">http://cpanel.vincentiannone.com/</a><br />
<br />
I also visited your website to be sure that you could access the domain and it loads the default landing page without error. <br />
<br />
If you need further assistance please feel free to contact us.<br />
<br />
Thanks!<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_432').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_432' id='form_comment_on_answer_432' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-access-cpanel-why-do-i-get-a-timeout-error-message&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-access-cpanel-why-do-i-get-a-timeout-error-message'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ef4ebe0dd7bf0625c7568f2df673cb05" value="1" />	</div>
	</form>
<!-- <br />
