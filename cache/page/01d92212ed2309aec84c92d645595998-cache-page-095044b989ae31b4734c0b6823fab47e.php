<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56286:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/modules/introduction" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-01T13:42:44-07:00" />
  <meta name="keywords" content="drupal 8 module introduction what is faq" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn the basics of a Drupal module and check out some of the more common questions regarding them." />
  <title>Introduction to Drupal 8 modules - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/modules/introduction" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a8c81758c77bd7bddb176ed7ac5f1501 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '198.12.80.175']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Introduction to Drupal 8 modules									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>563</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 1, 2013'><span style='color:#606060;'>Published:</span> Nov 1, 2013</div>
...
<h2>What is a Drupal module?</h2>
<p>Drupal 8 allows you to use many different modules in order to design your website. Modules are adddons, or extensions, that can be added to the core of your Drupa site. Modules typically are built to perform a single function or a collection of related functions.</p>

<h2>Core Modules</h2>
<p>There are quite a few modules that come with the default Drupal installation, these are known as <em>Code Modules</em> simply because they are already in the program upon installation. Some of them are already enabled and some are not. Some cannot be disabled as they are an integral part of Drupal 8. Others can be disabled if you wish to discontinue their use.</p>

<h2>Contributor Party Modules</h2>
<p>There are many third party modules available for your Drupal site. These are known as <em>Contributor modules</em> as they are contribute to the Drupal community by other independent developers. Some of these modules become popular enough through their use and functionality to become core modules in future releases. In Drupal 8, one of the modules that graduated from <em>Contributor</em> to <em>Core</em> is the <em>Views</em> module.</p>

<h2>Can modules operate independently?</h2>
<p>While the core Drupal website can operate without modules, modules themselves cannot operate as independent programs. They must be integrated as part of your Drupal site in order to use them.</p>

<h2>Do I have to use modules?</h2>
<p>Strictly speaking, aside from the core modules that you cannot disable,  you do not have to use modules in your Drupal site. However, you will be doing your site a dis-service as modules greatly expand the features and capabilities of your site. Even if you start off with no additional modules integrated we think you will soon change your mind as you find modules that enhance both your user's experience and your maintenance capabilities.</p> 

<h2>Where do I find additional modules?</h2>
<p>Drupal modules can be found on the main Drupal site. Specifically, they are located in the <a href="http://drupal.org/projects/module">Download and Extend</a> section</p>

<h2>How do I get started with modules?</h2>
<p>If you are ready to begin learning the basics of modules, you may start with our next tutorial on how to install a Drupal module.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-8/modules'>201: Working with Modules in Drupal 8</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Introduction to Drupal 8 modules</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-8/modules/activate'>Activating modules in Drupal 8</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/modules/introduction&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/modules/introduction'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NzEmaWQ9MjkzNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="43b2897070dd8768a06c711c45a1b188" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-8/modules?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Modules in Drupal 8</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-8/modules/introduction?tsrc=rsbedu'>Introduction to Drupal 8 modules</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-8/modules/activate?tsrc=rsbedu'>Activating modules in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-8/modules/install?tsrc=rsbedu'>Installing a module in Drupal 8</a></td>
                </tr>
          	</table>
