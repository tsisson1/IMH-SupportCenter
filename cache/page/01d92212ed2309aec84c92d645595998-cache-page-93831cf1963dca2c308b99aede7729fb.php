<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:86401:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/change-wordpress-admin-username-for-security" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-08T18:35:33-07:00" />
  <meta name="keywords" content="WordPress change updated admin user username security brute force attack" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'll discuss how you can update and change your WordPress admin username, as this can be a great security measure to help prevent unauthorized access to your WordPress admin dashboard." />
  <title>Change WordPress admin username for security - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/change-wordpress-admin-username-for-security" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f782d98fed3bb350c612718a87547ec6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.2.121.199']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Change WordPress admin username for security</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Change WordPress admin username for security									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>42,828</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 15, 2013'><span style='color:#606060;'>Published:</span> Sep 8, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="640" height="480" src="//www.youtube.com/embed/ESsysqgp6xw" frameborder="0" allowfullscreen></iframe>
<p>In this article I'll discuss how you can update and change your WordPress admin username, as this can be a great security measure to help prevent unauthorized access to your WordPress admin dashboard.</p>

<div style="background-color: #FAFAD2; border: 1px #D3D3D3 dashed; border-radius: 5px; padding: 0px 0px 0px 5px;">
  <p>This is a good security measure to help protect against the recent global <a href="/support/news/general/wp-login-brute-force-attack" target="_blank">WordPress wp-login.php brute force attack</a> that has been ongoing for the last few days affecting multiple web hosts.</p>
</div>

<h2>Update Wordpress admin username</h2>

<p>Using the steps below, I'll show you how easy it is to add a new WordPress administrator user, delete your old non-secure default admin one, and then assign or attribute all of the old user's posts to your new secure user.</p>

<ol class="article_list">

  <li style="clear: both;">
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/click-on-add-new-user.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/click-on-add-new-user.png" alt="click on add new user" /></a>From the left-hand menu, hover over <strong>Users</strong>, then click on <strong>Add New</strong></li>

  <li style="clear: both;">
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/fill-in-new-admin-details-click-add-new-user.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/fill-in-new-admin-details-click-add-new-user.png" alt="fill in new admin details click add new user" /></a>Fill in all of the user fields with new info.
    <p>Then select <strong>Administrator</strong> from the <strong>Role</strong> drop-down.</p>
    <p>Finally click on <strong>Add New User</strong>.</p></li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/new-user-created-confirmed.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/new-user-created-confirmed.png" alt="new user created confirmed" /></a>You should now see your new admin user you just created.</li>

      <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/hover-over-admin-click-log-out.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/hover-over-admin-click-log-out.png" alt="hover over admin click log out" /></a>Hover over <strong>Howdy, admin</strong> at the top-right.
        <p>Then click on <strong>Log Out</strong></p></li>

      <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/type-in-new-admin-username-click-log-in.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/type-in-new-admin-username-click-log-in.png" alt="type in new admin username click log in" /></a>Now type in your new WordPress admin username and password and click <strong>Log In</strong></li>

      <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/click-on-users.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/click-on-users.png" alt="click on users" /></a>From the left-hand menu click on <strong>Users</strong></li>

  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/click-on-delete-beside-admin.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/click-on-delete-beside-admin.png" alt="click on delete beside admin" /></a>
    
    <p class="alert">Prior to deleting your old admin user, I'd recommend you <a href="/support/website/cpanel/backup-your-database-in-cpanel" target="_blank">backup your WordPress database in cPanel</a> just in case.</p>
    
    <p>Hover over the old <strong>admin</strong> user, then click <strong>Delete</strong>.</p></li>

  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/select-attribute-posts-to-and-confirm-deletion.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/select-attribute-posts-to-and-confirm-deletion.png" alt="select attribute posts to and confirm deletion" /></a><p class="alert"><strong>BE CAREFUL!</strong> Deleting your old WordPress admin user, without attributing its posts to your new admin user will delete all those posts!</p>
    
    <p>Now select your new admin user from the <strong>Attribute all posts</strong> drop-down, and click on <strong>Confirm Deletion</strong>.</p>
  ...
  <li style="clear: both;">
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/user-deleted-new-user-left.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/change-admin-username/user-deleted-new-user-left.png" alt="user deleted new user left" /></a>You should now see the old admin user has been deleted, and you should only be left with the new administrator user, will all the old posts attributed to it.</li>
</ol>

<p style="clear: both;">&nbsp;</p>

<p>You should now understand how you can easily update and change your WordPress admin username, so that you're better protected against common brute force attempts at gaining access to your WordPress website.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/change-wordpress-admin-username-for-security&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/change-wordpress-admin-username-for-security'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0yNjEyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="260f8fac2c24336b7c451c3a0e461bcb" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/569dc2930ff58156fc8b6d83293c9db6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/569dc2930ff58156fc8b6d83293c9db6'>Yashwant</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-16 1:57 am</div>
				                <div><p>Its nice tutorial.&nbsp; Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11632);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15068'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0a5abae6ccfaea9ca3f61b479d9a1c75?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0a5abae6ccfaea9ca3f61b479d9a1c75'>treeleaf</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-15 5:07 pm</div>
				                <div><p>I'm trying to change the admin user name, but would like to keep the same email address. It won't let me do this--wants me to supply a different email as this email is "already registered". Any suggestions?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15068);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-15 5:34 pm</div>
				                <div>Hello Treeleaf,<br />
<br />
Thanks for the question!  I suggest that you modify the email address of the original administrator user.  You can then create your new admin user and then use the email address that you wish to you use.  You can't have administrators with the same email address unfortunately.  However, you can create email forwarders for any new email address that you create and automatically forward email to a central email address .   So, even if you have multiple administrators, if an email is sent to one, it will be sent to the central email assigned to each forward.<br />
<br />
I hope this is helps to resolve the issue for you.  Please  let us now if you have any further questions or comments.<br />
Regards,<br />
Arnel C.                                                                                                                                                                                                                                                                                                                                                                                                                                </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15069);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16666'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9e2e7d806673f5c613a0e13010b868f5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9e2e7d806673f5c613a0e13010b868f5'>RodH</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-24 12:30 am</div>
				                <div>Enough said: Magnificent!<br />
Thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16666);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18844'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a656ba4eff3fa9bb5adb49e77838e498?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a656ba4eff3fa9bb5adb49e77838e498'>Chris</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-23 6:16 pm</div>
				                <div><p>This works as of december 23 2015</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18844);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24627'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6fc12b413f2fececd055575311793732?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6fc12b413f2fececd055575311793732'>Mohammad</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-05 1:18 pm</div>
				                <div><p>Does the new user precisely have all the privileges the old one had?</p>
<p>Nothing to lose?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24627);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-06 10:58 am</div>
				                <div>Hello Mohammad,<br />
<br />
If you're referring to the admin user that's referred to in this article,then "yes" the privileges remain the same.  We're simply re-naming the admin user.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24647);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27617'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ce000781552be3508bb8c7690f61b02a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ce000781552be3508bb8c7690f61b02a'>Andrea Perez</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-17 4:48 pm</div>
				                <div><p>Hi,Thank you very much. This tutorial is very helpful.RegardsAndrea</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27617);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28068'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/74259a479bb5b1cddc8c1a81fd55521a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/74259a479bb5b1cddc8c1a81fd55521a'>Me</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-31 1:39 pm</div>
				                <div><p>Thanks a lot really useful!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28068);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7d6721ceab1f22e5207699d97913e399?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7d6721ceab1f22e5207699d97913e399'>Ganesh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-16 1:18 am</div>
				                <div><p>Superb ..Thanks A Lot !!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29206);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29479'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/55703122fe732d0cd8b6e1f1ee491813?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/55703122fe732d0cd8b6e1f1ee491813'>Rui Carvalho</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-31 8:28 am</div>
				                <div><p>great Tutorial.. thanks a lot and a happy new 2016 year</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29479);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
