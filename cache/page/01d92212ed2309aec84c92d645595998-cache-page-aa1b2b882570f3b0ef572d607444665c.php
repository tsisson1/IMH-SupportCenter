<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45436:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.us/support/edu/mediawiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Media Free open source software similar implement wiki server php based program require database  set up setting up installation install configure installing tutorials articles instruction step wikipedia" />
  <meta name="description" content="MediaWiki is a free Wiki software that is used by sites like Wikipedia, Wikimedia Foundation, and more. WikiMedia can be customized to suit your needs and is Free to instal on a General Public License. This section will teach you how to implement a Wiki o" />
  <title>MediaWiki | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4e65d98e6c68eca63f043e4685aefb4e -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>MediaWiki</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>MediaWiki Education Channel</h1>
		</div>
	
<div style='clear:both;'></div>

<div class='edu_class_listing white_box'>
	<h2>MediaWiki Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/mediawiki/getting-started-mediawiki'>101: Getting Started with MediaWiki</a></li>
<li  ><a href='/support/edu/mediawiki/adding-content-mediawiki'>102: Adding content to MediaWiki</a></li>
<li  ><a href='/support/edu/mediawiki/change-media-wiki-appearance'>103: Changing the MediaWiki appearance</a></li>
<li  ><a href='/support/edu/mediawiki/add-contact-form-media-wiki'>104: Adding a contact form in MediaWiki</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/mediawiki/change-mediawiki-interface-language'>201: Changing the MediaWiki interface Language</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							...
							<div class='smallgrey'>Hits: 48,590</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							...
							<div class='smallgrey'>Hits: 24,786</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
						...
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							...
							<div class='smallgrey'>Hits: 20,024</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
...
<form action="http://www.inmotionhosting.us/support/edu/mediawiki" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>MediaWiki - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/mediawiki/make-changes-to-mediawiki-skins'>How to make basic changes to mediawiki skins</a></div>
					<div>In this article we'll show you the basics on how you can get started with editing skins in mediawiki.</div>
					<div class='smallgrey'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDYmaWQ9MTA2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="56043ebaa73c4420c926739d71e61c7d" value="1" />	</div>
	</form>
<!-- <br />
