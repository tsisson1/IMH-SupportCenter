<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63776:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/what-is-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-22T14:15:53-07:00" />
  <meta name="keywords" content="cpanel what is control panel" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn what cPanel is and some of the features cPanel includes with your InMotion Hosting account." />
  <title>What is cPanel? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/what-is-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a279a6ac203029529e28965d2f9411db -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '174.53.26.186']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>12,160</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 2, 2011'><span style='color:#606060;'>Published:</span> Sep 22, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center>
  <iframe width="560" height="315" src="https://www.youtube.com/embed/Cvb1Pyo3SPU" frameborder="0" allowfullscreen></iframe>
</center>
<p><strong>cPanel</strong>, often referred to as <em>control panel</em>, is the interface used for making changes to and customizing your hosting account with InMotion. Some of the great features that cPanel includes are:</p>
<ul>
  <li><strong>Email</strong>: Within cPanel you can <a href="/support/edu/everything-email/introduction-email/creating-email-account" target="_blank">create</a> new email accounts, view/modify your existing accounts, modify your <a href="/support/edu/cpanel/cpanel-email/modfying-mx-records" target="_blank">MX records</a>, change <a href="/support/email/general-information/changing-your-email-password" target="_blank">email passwords</a>, set up mail box quotas and much more. </li>
  <li><strong>Domains</strong>: Under the domains section of cPanel, you can <a href="/support/domain-names/registrations-and-transfers/add-another-domain-name-account" target="_blank">configure new domains</a> to your account, set up <a href="/support/edu/cpanel/cpanel-manage-domains/adding-a-parked-domain-to-cpanel" target="_blank">parked</a> domains, create <a href="/support/edu/cpanel/cpanel-manage-domains/creating-a-subdomain" target="_blank">subdomains</a>, setup <a href="/support/edu/cpanel/cpanel-manage-domains/setting-up-redirect-cpanel" target="_blank">redirects</a>, and much more.</li>
  <li><strong>File Management</strong>: In the files section of cPanel, you can <a href="/support/edu/cpanel/cpanel-file-manager/backing-up-your-cpanel" target="_blank">backup your cpanel</a> account, <a href="/support/website/managing-files/how-to-manage-files-server" target="_blank">access/ modify files</a> stored in your account, review your <a href="/support/edu/cpanel/getting-started-cpanel/how-to-find-server-specifications-in-cpanel-stats" target="_blank">disk usage</a>, and create/manage <a href="/support/website/ftp/getting-started-guide" target="_blank">FTP</a> accounts</li>
  <li><strong>Databases</strong>: Here you can <a href="/support/website/databases/create-db-user" target="_blank">create new databases</a>, set up <a href="/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel" target="_blank">remote access</a> to MySQL, access the databases using <a href="/support/website/database-setup/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel" target="_blank">phpMyAdmin</a>, and much more</li>
</ul>
<p>cPanel is very user friendly and is quite robust. There's numerous tools within cPanel to handle a wide variety of tasks. It contains a full help menu that is easy to use.</p>
<h2>cPanel is VPS Optimized</h2>
<p>Did you know that there is a version created specifically for VPS servers? <a href="http://www.inmotionhosting.com/cpanel-hosting/vps-with-cpanel.html">Click here</a> to read more.</p>
<p>Please check the next article on <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here to view the next article">How to log into cPanel</a>. For more information on this course please visit <a target="_blank" href="/support/edu/cpanel/getting-started-cpanel" title="Click here to view the courses">Getting Started in cPanel</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: What is cPanel?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/cpanel/getting-started-cpanel/switch-your-cpanel-theme-to-paper-lantern'>How to switch your cPanel Theme to Paper Lantern</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel'>cPanel Login</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/what-is-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/what-is-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzImaWQ9OTY5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="bd39369405e3916d161c16c5925b6901" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/technical-support-mail-server?tsrc=rsbraq'>Technical support mail server</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0410b3f73e923d7db1b01665fed6fef8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0410b3f73e923d7db1b01665fed6fef8'>Joshua Dadzie</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-26 5:37 am</div>
				                <div><p>Please how can i register new domain on my server</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17835);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-26 9:20 am</div>
				                <div>Hello Joshua,<br />
<br />
Thanks for the question.  Please see <a href="http://www.inmotionhosting.com/support/domain-names/registrations-and-transfers/registering-a-new-domain-name">How to register a new domain in the Account Management Panel (AMP)</a> for further information.  If you are trying to add a domain to your account, then please read <a href="http://www.inmotionhosting.com/support/domain-names/registrations-and-transfers/add-another-domain-name-account">Adding Another Domain to Your Account</a>.<br />
<br />
If you require further assistance, please let us know. <br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17846);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
