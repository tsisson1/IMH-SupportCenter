...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/amp/how-to-check-your-server-information-on-a-vps-or-dedicated-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T13:19:45-07:00" />
  <meta name="keywords" content="server information status current memory usage disk space vps dedicated 2xram" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will teach you how to view your server information on a VPS or Dedicated server through the WHM." />
  <title>How to check your Server Information on a VPS or Dedicated hosting account - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/amp/how-to-check-your-server-information-on-a-vps-or-dedicated-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c479feae966f118777afc19bf43a1b39 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to check your Server Information on a VPS or Dedicated hosting account									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>105,754</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 27, 2013'><span style='color:#606060;'>Published:</span> Jul 17, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When managing your server with InMotion Hosting, you can check your Server Information to find what type of server you have. This can be done in the Web Host Manager (WHM) of your <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated hosting</a> server. The below steps will explain how to view your server Processor Information, System Information, Current Memory Usage, and Current Disk Usage to see what VPS plan you are on.</p>
<p class="alert"><strong>Important!</strong> You can only view this information on VPS or Dedicated servers. Shared servers have no WHM access.</p>
  <h2>Finding your server information in WHM</h2><ol class="article_list"><li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm" target="_blank" title="Click here for info">Log into WHM</a>.</li><li>Navigate to <strong>Home &gt; Server Status &gt; Server Information</strong>.</li><li>Scroll to the bottom to see the Memory and Disk space. The image below shows what the section looks like.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/questions/server-stats.png"><img  alt="Snapshot of WHM Server Informaion cPanel" src="//cdn.inmotionhosting.com/support/images/stories/questions/server-stats.png" title="Click here to view the larger image" width="400" /></a></li></ol><h2>Current Memory Usage</h2>
  <p>The memory usage can be view in the Server information stats to see if it matches the plan you upgraded to. Below is an excerpt of the Current Memory Usage on a VPS1000. The <span style="color: #FF8000"><strong>total</strong></span> memory is burstable memory, in this case 1 gig for the VPS1000 plan.  If it where a VPS3000 the number would be 3145728 kilobytes.  The <span style="color: #FF0000"><strong>used</strong></span> is the total memory currently used by the server. The <span style="color: #006600"><strong>free</strong></span> memory is what the server has left to use.</p>
  <pre style="margin-left:20px">             <span style="color: #FF8000"><strong>total</strong></span>       <span style="color: #FF0000"><strong>used</strong></span>       <span style="color: #006600"><strong>free</strong></span>     shared    buffers     cached
   Mem:       <span style="color: #FF8000">1048576</span>     <span style="color: #FF0000">589016</span>     <span style="color: #006600">459560</span>          0          0          0
   -/+ buffers/cache:     589016     459560
   Swap:            0          0          0
   Total:     1048576     589016     459560</pre><h2>Current Disk Usage</h2>
   <p>The below is an excerpt of a VPS server with a VPS1000 plan. The <span style="color: #FF8000"><strong>Size</strong></span> is the total disk space on the server. In this example, this is a  VPS1000 plan because it has 40 gigs of space. If you upgraded to a VPS2000 you should see ~80gigs (The actual size will be a few gigs smaller in order to store server required information.). The <span style="color: #FF0000"><strong>Used</strong></span> is the total space used including all cPanel accounts and the server Operating Systems and systems files. The <span style="color: #006600"><strong>Avail</strong></span> is what's available on the disk and the <span style="color: #0033FF"><strong>Use%</strong></span> is the total used in percent.</p>
   <pre style="margin-left:20px">Filesystem            <span style="color: #FF8000"><strong>Size</strong></span>  <span style="color: #FF0000"><strong>Used</strong></span> <span style="color: #006600"><strong>Avail</strong></span> <span style="color: #0033FF"><strong>Use%</strong></span> Mounted on
   /dev/vzfs              <span style="color: #FF8000">39G</span>   <span style="color: #FF0000">12G</span>   <span style="color: #006600">27G</span>  <span style="color: #0033FF">31%</span> /
   none                  512M  4.0K  512M   1% /de</pre>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/amp/how-to-check-your-server-information-on-a-vps-or-dedicated-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/amp/how-to-check-your-server-information-on-a-vps-or-dedicated-server'></div>
	<script type='text/javascript'>
	  (function() {
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/432b3c202e9003312c047e73aadc9beb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/432b3c202e9003312c047e73aadc9beb'>Syed Rubel</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-28 10:18 am</div>
				                <div>Thanks. this post  helpfull</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30191);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-26 8:36 am</div>
				                <div><p>Is there a way to see some sort of graph that shows how and when the memory is being used over the month? For example let's say I want to know if there is a moment of the day where I almost run out of memory, where can I check that?</p>
<p>&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32257);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-26 9:29 am</div>
				                <div>You can check the "Daily Process Log" under <em>Server Status</em> in WHM.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32261);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
