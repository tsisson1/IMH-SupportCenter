<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50136:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/different-mail-and-web-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for contacting us with your DNS question. To have your mail served from external email servers and your domain served from our home ser..." />
  <title>How do I host my domain and mail from different servers | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/different-mail-and-web-hosting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c088e2294b3814d012b9e04f4757f473 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I host my domain and mail from different servers</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-12-19 2:47 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,620</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How do I setup my domain DNS records to point the domain name to inmotion servers but keep the mail server unchanged.  The mail server is curently pointed via MX records.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6165' id='upvote_answer_6165' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6165' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6165').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6165' id='downvote_answer_6165' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6165' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6165').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for contacting us with your DNS question. To have your mail served from external email servers and your domain served from our home servers, it simply takes a change of a couple of DNS records.<br />
<br />
I see your domain is using our name servers, so you will simply want to change your MX records to point to the third party external servers. Be sure to also set the location for email routing to external and to remove or overwrite the default MX record in the list, which points to our servers. You can find more information from our<a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records"> MX modification</a> article.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6165').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6165' id='form_comment_on_answer_6165' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/different-mail-and-web-hosting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/different-mail-and-web-hosting'></div>
<script type='text/javascript'>
  (function() {
