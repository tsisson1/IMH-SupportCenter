<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61204:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/localization-currencies-taxes/change-default-currency" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-08T17:41:06-08:00" />
  <meta name="keywords" content="modify Prestashop 1.5 default currency" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this PrestaShop 1.5 tutorial, we explain how to change the default currency for your store." />
  <title>How to change the default currency in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/localization-currencies-taxes/change-default-currency" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:07d666fdb3a07fa49db0ca371717df75 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '88.101.0.221']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change the default currency in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,558</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 8, 2012'><span style='color:#606060;'>Published:</span> Nov 8, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The default currency represents the currency format that your product prices are set. Your <em>Localization</em> settings allow for you to change the default currency for your store. Below are the instructions to set the default currency or your PrestaShop 1.5 store.</p>
<p><strong>Modifying the default currency in PrestaShop 1.5</strong></p>
...
<li>Using the top menu bar, hover over the <strong>Localization</strong> tab and click on the <strong>Localization</strong> option.</li>
<li>This brings you to the <em>Localization</em> settings page. Look for the <em>Configuration</em> section and find the <strong>Default Currency</strong> field. From here you can select the new currency from the dropdown. In our example, we select the <strong>Euro</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Localization/Localization/change-default-currency/select-currency.png"><img  alt="select-currency" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Localization/Localization/change-default-currency/select-currency.png" /></a><br /><br /></li>
<li>Click on the <strong>Save</strong> button located at the bottom of the <em>Configuration</em> section to finalize and save the changes. <br />
<div class="alert">After changing your default currency, you must manually change every product price.</div>
</li>
</ol>
<div>Please check the next article on<a href="/support/edu/prestashop-15/localization-currencies-taxes/add-tax"> How to add a new tax in PrestaShop 1.5</a>. If you missed our previous article, <a href="/support/edu/prestashop-15/localization-currencies-taxes/delete-currency">How to delete a currency in PrestaShop 1.5</a> please see the tutorial. For more information on this course please visit <a href="/support/edu/prestashop-15/localization-currencies-taxes">Working withLocalization Currencie and Taxes in PrestaShop 1.5</a></div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/localization-currencies-taxes'>208: Working with Localization Currencies and Taxes in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to change the default currency in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/prestashop-15/localization-currencies-taxes/delete-currency'>How to delete a currency in PrestaShop 1.5 </a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/prestashop-15/localization-currencies-taxes/edit-measurements'>How to change your units of measure in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/localization-currencies-taxes/change-default-currency&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/localization-currencies-taxes/change-default-currency'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzgmaWQ9MTk3NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/localization-currencies-taxes?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Localization Currencies and Taxes in PrestaShop 1.5</h3></a>
		<table><tr><td colspan='2'><h4>Working with Currencies</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/localization-currencies-taxes/add-currency?tsrc=rsbedu'>How to add a new currency in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/localization-currencies-taxes/edit-currency?tsrc=rsbedu'>How to modify a currency in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/localization-currencies-taxes/disable-currency?tsrc=rsbedu'>How to disable a currency in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/localization-currencies-taxes/delete-currency?tsrc=rsbedu'>How to delete a currency in PrestaShop 1.5 </a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/localization-currencies-taxes/change-default-currency?tsrc=rsbedu'>How to change the default currency in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/localization-currencies-taxes/edit-measurements?tsrc=rsbedu'>How to change your units of measure in PrestaShop 1.5 </a></td>
                </tr>
        <tr><td colspan='2'><h4>Managing Taxes</h4></td></tr>  <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/localization-currencies-taxes/add-tax?tsrc=rsbedu'>How to add a new tax in PrestaShop 1.5 </a></td>
                </tr>
          	</table>
