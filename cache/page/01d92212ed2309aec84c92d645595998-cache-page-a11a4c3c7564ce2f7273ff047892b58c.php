<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61906:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/website/databases/postgresql/export-database" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-19T01:49:06-08:00" />
  <meta name="keywords" content="PostgreSQL phppgadmin export database" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This is a walk through guide on using phpPgAdmin to export a PostgresSQL database in cPanel." />
  <title>Exporting a PostgreSQL database with phpPgAdmin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/databases/postgresql/export-database" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:495936a4b78c1e0d398047c2668deb1b -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Exporting a PostgreSQL database with phpPgAdmin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,007</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 31, 2014'><span style='color:#606060;'>Published:</span> Dec 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After <a href="/support/website/databases/postgresql/install-setup">installing PostgreSQL and phpPgAdmin</a> on your server, you can begin to work with PostgreSQL databases. In this tutorial we will show you how to <strong>export</strong> your <strong>PostgreSQL database</strong> using <strong>phpPgadmin</strong>. Exporting your database allows you to save a backup of it, or <a href="/support/website/databases/postgresql/import-database">import it</a> into another account.</p>


<h2>How to Export a Database using phpPgAdmin</h2>
<ol class="article_list">
  ...
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/phppgadmin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/phppgadmin.png" alt="" title="accessing phppgadmin in cpanel" /></a>
  <br>
<br><div class="alert alert-warning"><strong>Note:</strong> The <em>phpPgAdmin</em> button, is only available after <a href="/support/website/databases/postgresql/install-setup">installing PostgreSQL</a> on your VPS, or Dedicated server.</div></li>
  <li>On the top left, click the name of the database you want to export. You may have to <em>expand</em> the <strong>PostgreSQL</strong> option to see the databases.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/select-database-to-export.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/select-database-to-export.png" alt="" title="choose database" /></a></li>
  <li>Click the <strong>Export</strong> tab.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/select-export-tab.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/select-export-tab.png" alt="" title="choose the export tab in cpanel" /></a></li>
  <li>Choose the format you want to export the database in; I recommend selecting <strong>Structure and data</strong>.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/select-export-format.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/select-export-format.png" alt="" title="choose format for exporting" /></a></li>
  <li>In the <em>Options</em> section, choose <strong>Download</strong>, or <strong>Download compressed with gzip</strong>, then click the <strong>Export</strong> button.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/download-export.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/download-export.png" alt="" title="download and export database in phppgadmin" /></a><br><br>
  You will then be prompted to download the database file. Save it to your computer, and you are finished.</li>
  <br></ol>
<br>
<p>Congratulations, now you know how to export your PostgreSQL database using phpPgAdmin in cPanel! I the next tutorial we will show you how to <a href="/support/website/databases/postgresql/import-database">import a PostgreSQL</a> database. Learn more about <a href="http://www.inmotionhosting.com/postgresql-hosting">PostgreSQL Hosting</a> options.</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDMmaWQ9MzE4NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
