<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63365:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php/strict-standards-fix" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-07T17:44:32-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to disable the 'strict standards' error message in your php application." />
  <title>Fixing the strict standards error in php.ini - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php/strict-standards-fix" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:945d25be9212720f25654c06d7d09283 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.114.68.96']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Fixing the strict standards error in php.ini</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Fixing the strict standards error in php.ini									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,030</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 9, 2014'><span style='color:#606060;'>Published:</span> Jan 7, 2015</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('what');">What it is</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('why');">Why it displays</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('fix');">How to fix it</button>
</div>

<p>There are times when your site will give PHP errors after an upgrade or a site move that were not there before. One of the more common errors we see with Content Management Systems is the <em>strict standards</em> error.  It normally appears at the top of the page and looks something like the following one from a Joomla site.

<pre class="code_block">Strict Standards: Non-static method JLoader::import() should not be called statically in &lt;joomla path&gt; on line 34</pre>

This error in particular can seem confusing since it was not in your previous setup. Never fear, this is nothing terrible and easy to take care of.</p>
...
<ol class="article_list">
  ...
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/1-click-file-manager.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="click file manager icon" src="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/1-click-file-manager.png" title="Click here to view the larger image" width="200" /></a>Find the <em>Files</em> section and click on the <strong>File Manager</strong> icon.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/2-open-php-ini.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="open the php.ini" src="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/2-open-php-ini.png" title="Click here to view the larger image" width="200" /></a>Once in the <em>File Manager</em>, navigate to the <strong>php.ini</strong> file and <a href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor">open it for editing</a>. If you do not have a <em>php.ini</em> file, please <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact Live Support</a> so they can place one in your account for you.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/3-error-reporting.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="find the error reporting" src="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/3-error-reporting.png" title="Click here to view the larger image" width="200" /></a>Inside the <em>php.ini</em> file, locate the section for error reporting and then locate your particular setting. It will be the one without the semicolon ';' in front of it.<div style="clear:both;"></div></li>
  ...
  <li>Click on the <strong>Save Changes</strong> button in the upper right corner of the screen.<div style="clear:both;"></div></li>
</ol>
...
<tr>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/3-error-reporting.png"><img   style="" alt="settings prior to change" src="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/3-error-reporting.png" title="Click here to view the larger image" width="100%" /></a></td>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/4-final.png"><img   style="settings after change" alt="" src="//cdn.inmotionhosting.com/support/images/stories/php/strict-standards/4-final.png" title="Click here to view the larger image" width="100%" /></a></td>
</tr>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php/strict-standards-fix&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php/strict-standards-fix'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTImaWQ9MzQ2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
