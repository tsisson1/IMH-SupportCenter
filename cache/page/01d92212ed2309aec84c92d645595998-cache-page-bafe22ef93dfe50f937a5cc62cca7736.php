<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51242:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/there-is-any-ability-to-do-automatically-backups-of-selected-databases-and-files" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello S.Gurenkov, Currently there are no automated options to backup both the databases and website files. To automate your backups into a retrievable f..." />
  <title>There is any ability to do automatically backups of selected databases and files? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/there-is-any-ability-to-do-automatically-backups-of-selected-databases-and-files" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:baec6648780f3f7cef7ef886174472c9 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>There is any ability to do automatically backups of selected databases and files?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/S&per;Gurenkov'>S.Gurenkov</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-08-15 2:39 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>374</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I need to do backup of any databases and some files in our account. There is a chance to do it automatically in cPanel?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1434' id='upvote_answer_1434' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1434' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1434').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1434' id='downvote_answer_1434' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1434' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1434').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello S.Gurenkov,<br />
<br />
Currently there are no automated options to backup both the databases and website files.  To automate your backups into a retrievable format for you, you would need to create a backup script and then set it up as a cron job, which is a fancy way to say scheduled task. This way you can have it run on a particular schedule. We currently do not have instructions for coding a backup script, however. <br />
<br />
FYI - All sites under 10GB are backed up every 24-36 hours. Those are not accessible in a file format directly from the cpanel, however. They can be restored via a support contact if needed. <br />
<br />
...
If you have any more questions or information specific to the issue please leave a comment below so we can further assist you.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1434').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1434' id='form_comment_on_answer_1434' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/there-is-any-ability-to-do-automatically-backups-of-selected-databases-and-files&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/there-is-any-ability-to-do-automatically-backups-of-selected-databases-and-files'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3959aa718ed1f8ab3833a341f9e87289" value="1" />	</div>
	</form>
<!-- <br />
