<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72329:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/disable-xml-rpc-requests" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-05T20:46:58-07:00" />
  <meta name="keywords" content="disable wordpress xml-rpc xmlrpc.php xmlrpc" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="WordPress uses the XML-RPC protocol to extend functionality to remote clients, and you can disable it if this isn't needed." />
  <title>Disable WordPress XML-RPC requests - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/disable-xml-rpc-requests" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:552d950c5cfd0bf7c45362fb40dc0107 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '72.164.249.34']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Disable WordPress XML-RPC requests</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Disable WordPress XML-RPC requests									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>25,293</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 5, 2013'><span style='color:#606060;'>Published:</span> Sep 5, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>WordPress uses an implementation of the <strong><a href="http://codex.wordpress.org/XML-RPC_Support" target="_blank">XML-RPC</a></strong> protocol in order to extend functionality to software clients.</p>

<p>This <strong>Remote Procedure Calling</strong> protocol allows commands to be run, with data returned formatted in <strong>XML</strong>.</p>
            
<p>Beginning with <strong>WordPress 3.5</strong> the <strong>XML-RPC</strong> functionality is <strong>enabled by default</strong>, without a way to disable.</p>
            
<h2>Do I need WordPress XML-RPC?</h2>
            
<p>Most users don't need <strong>WordPress XML-RPC</strong> functionality, and it's one of the most common causes for exploits.</p>

<p>Some clients such as the official <a href="http://wordpress.org/mobile/" target="_blank">WordPress Mobile Apps</a> and <a href="http://blogger.com" target="_blank">Blogger</a> use <strong>XML-RPC</strong> requests to function.</p>            
            
<p>All of the WordPress <strong>XML-RPC</strong> requests are remote <strong>POST</strong> requests to the <strong>xmlrpc.php</strong> script. 
    
<p>A full list of the different requests that can be made via <strong>XML-RPC</strong> can be found at <a href="http://codex.wordpress.org/XML-RPC_WordPress_API" target="_blank">XML-RPC WordPress API</a></p>    
   
<h2>Block WordPress xmlrpc.php requests with .htaccess</h2>
            
<p>I want to send WordPress <strong>XML-RPC</strong> requests from my fictional IP address of <strong style="color:red;">123.123.123.123</strong>.</p>
            
<p>So I can deny all requests to the <strong>xmlrpc.php</strong> file, except for that IP, using the following <strong>.htaccess</strong> rules:</p>            

<pre class="code_block" style="width: 275px; margin-bottom:15px; margin-left: 150px;"># Block WordPress xmlrpc.php requests
&lt;Files xmlrpc.php&gt;
order deny,allow
deny from all
allow from <strong style="color: red;">123.123.123.123</strong>
&lt;/Files&gt;
</pre>       
    
<p>If you didn't need any IP addresses to use <strong>XML-RPC</strong> requests, just don't use any <strong>allow</strong> lines.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/disable-xml-rpc-requests&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/disable-xml-rpc-requests'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0yODI1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="802a3cbd5a2ae15b5f921c869e246767" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7e76e6f76f1d20bb3f4fd4a88c2a51d9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7e76e6f76f1d20bb3f4fd4a88c2a51d9'>Abirami R</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 4:41 am</div>
				                <div><p>These discussion helps me to understand xml rpc</p>
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9920);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/antoinmo'>antoinmo</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-27 4:49 pm</div>
				                <div>By completely blocking xmlrpc.php, isn't this also disabling the legitimate use of it for pingbacks?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21170);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24509'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0172337523b287f5d1a20ba670a97fe1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0172337523b287f5d1a20ba670a97fe1'>Michal</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-28 11:54 am</div>
				                <div><p>My WP site just got hacked by some Bangladesh' hackers group. Looking through access logs I discovered xmlrpc.php was flooded with POST requests. No FTP was used in the attack, so I assume hackers must have gained access through the xmlrpc. Disabled permanently.</p>
<p>Thank God they didn't do more damage.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24509);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26847'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5c194ee4ac69d0f29d0e3080abcbeedc?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5c194ee4ac69d0f29d0e3080abcbeedc'>Paul P</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-21 3:47 pm</div>
				                <div><p>you can disable per the following.</p>
<p>WordPress v3.5 introduces the filter <code class=" prettyprint prettyprinted"><span class="pln">xmlrpc_enabled</span></code>:</p>
<pre class=" prettyprint prettyprinted" lang="php"><span class="pln">add_filter</span><span class="pun">(</span><span class="str">'xmlrpc_enabled'</span><span class="pun">,</span><span class="str">'__return_false'</span><span class="pun">);</span></pre>
<p>You can add this code to your <code class=" prettyprint prettyprinted"><span class="pln">wp_config</span><span class="pun">.</span><span class="pln">php</span></code> after the line <code class=" prettyprint prettyprinted"><span class="pln">require_once</span><span class="pun">(</span><span class="pln">ABSPATH </span><span class="pun">.</span><span class="str">'wp-settings.php'</span><span class="pun">);</span></code> if you want to disable XML-RPC for your site. Surely a better solution is to create a small plugin.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26847);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27381'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b38c9103ba1d0ede89450d3304990778?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b38c9103ba1d0ede89450d3304990778'>Chris Backe</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-09 12:53 pm</div>
				                <div><p>As of February 2015, a plugin disables XML-RPC to where it's not a problem: https://wordpress.org/plugins/disable-<strong>xml</strong>-<strong>rpc</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27381);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32698'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b0d3843ca381f03f5f961375f36f477f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b0d3843ca381f03f5f961375f36f477f'>Bram De Smet</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-15 6:14 am</div>
				                <div><p>There is a module for that here:&nbsp;https://wordpress.org/plugins/disable-xml-rpc/</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32698);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
