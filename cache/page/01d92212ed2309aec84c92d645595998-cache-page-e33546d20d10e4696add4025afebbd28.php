<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62162:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management/zip-unzip-win7" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-23T18:10:07-07:00" />
  <meta name="keywords" content="Zip Unzip Windows 7 compress uncompress win7 file folder" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide shows you how to Zip or Unzip a file or folder using the tools included in Windows 7." />
  <title>Zip and Unzip Files using Windows 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-management/zip-unzip-win7" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2014-08', 3]);
	...
	<!-- cid:e93196e07c8626b2ae08b7fb7b1cc3b9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.130.111.114']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Zip and Unzip Files using Windows 7</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Zip and Unzip Files using Windows 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,918</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 18, 2014'><span style='color:#606060;'>Published:</span> Sep 23, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/zip-archive.png"><img  style="margin: 15px 15px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/zip-archive.png" alt="Compressed folder in win7" align="right" title="Example of zipped file or folder in Windows 7" /></a>
<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
    <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('zip');">Zip a File/Folder</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('unzip');">Unzip a File/Folder</button>
</div>
    
<p>In this tutorial we will show you how to <strong>Zip</strong> and <strong>Unzip</strong> a <strong>file</strong> or <strong>folder</strong> in Windows 7. You can then transfer a zipped file safely over the internet, or unzip a file that was shared with you. I will be using the tools included in Windows 7. This is convenient, since it does not require any additional software installations.</p>

<div style="clear:both;"></div>  
<a name="zip"></a>
<h2>Zip a File/Folder</h2>
<ol class="article_list">
<li>In Windows, navigate to the file/folder you want to zip, and <strong>Right-click</strong> it.</li>
<li>On the menu that pops up, roll your mouse over <strong>Send to</strong>, then click <strong>Compressed (zipped) folder</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/send-to-compressed-zipped-folder.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/send-to-compressed-zipped-folder.png" alt="Windows 7 send to zip" title="sending folder to zip compressed archive" /></a></li>
<li>You will see a new zipped file/folder appear, it will have a "<strong>Z</strong>" on it for identification. It contains the file/folder you selected, and will have the same name. Feel free to enter a new name is necessary, then click the <strong>Enter</strong> key to save the file.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/new-zipped-file.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/new-zipped-file.png" alt="Compressed file" title="Zip archive folder in Windows 7" /></a></li>
<br></ol>
    
    
<a name="unzip"></a>
<h2>Unzip a File/Folder</h2>
<ol class="article_list">
  <li>In Windows 7, navigate to the zipped (compressed) file you want to <em>Unzip</em>, and <strong>right-click</strong> it.</li>
<li>On the menu that pops up, roll your mouse over <strong>Open with</strong>, then click <strong>Windows Explorer</strong>.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/open-zip-file-with-windows-explorer.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/open-zip-file-with-windows-explorer.png" alt="Win7 Explorer compressed file" title="Accessing the contents of a Zip file in Windows 7." /></a></li>
<li>You will then see the contents of the zip file. Click the file and drop it on your desktop, or another file location. The contents of the file will be unzipped, and you can then use it as needed.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/drag-drop.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/zip-unzip/drag-drop.png" alt="Uncompressing a file in Windows 7 explorer." title="Drag and drop file onto desktop." /></a></li>
<br></ol>
<p>Congratulations, now you know how to <strong>Zip</strong> (compress) or <strong>Unzip</strong> (uncompress) a file in Windows 7! You can safely <a href="/support/website/managing-files/how-to-upload-files-server">upload the file</a> to your account, or transfer it as needed.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/file-management/zip-unzip-win7&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/file-management/zip-unzip-win7'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMyZpZD0zMzY4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
