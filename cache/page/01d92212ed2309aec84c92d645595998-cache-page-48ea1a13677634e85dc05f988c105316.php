<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60162:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/plugins-not-showing-in-wp-administration-panels" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello bigpacific, The /test copy was from us torubleshooting the original issue. That copy has been removed from the account. The version running in the..." />
  <title>Plugins not showing in wp administration panels | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/plugins-not-showing-in-wp-administration-panels" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:313f04ed7f3db46cadd46cda7513dd4c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.229.1.221']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Plugins not showing in wp administration panels</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh4.googleusercontent.com/-LzGqHMqiOhA/AAAAAAAAAAI/AAAAAAAAADo/Dijha3vcNn8/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/martinnichols'>martinnichols</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-04 12:41 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>7,088</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Trying to install plugins into my wordpress install at martinnicholsdesign.com and the plugin management is not showing in the dashboard or left side navigation.<br />
<br />
I thought it was possibly because of the Avada theme installed, which is pretty comprehensive, but even when switched to twenty eleven template the plugins remain unavailable. How do we access them? Does inmotion's wordpress install hide them for security/resource reasons? Would like to import my wordpress.com blog and need the importer plugin installed. <br />
<br />
Thanks</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Hi, I'm Martin's consultant on this site. We received a notice that a new installation of Wordpress 3.5.1 has been completed, but an attempt to load it generates an error &quot;Error establishing database connection&quot; for both the main /test/ page and the /test/wp-admin.<br />
<br />
Also, we will want an unrestricted version of Wordpress running in the root of the domain. Would it be best to delete what we have now and go for a clean unrestricted install at the root, or should we work in the test directory and then request it be moved to the root when the site is done?</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/bigpacific'>bigpacific</a><br />
					9 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-06-04 04:20 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3257' id='upvote_answer_3257' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3257' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3257').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3257' id='downvote_answer_3257' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3257' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3257').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>36,987 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-06-04 4:36 pm EST
                		        </div>
					
		                </div>

				Hello martinnichols,<br />
<br />
The reason you are not seeing the Plugins option in the left hand menu bar is due to you having the multisite setup enabled. In this setup, the plugins option is moved to the Network Admin menu. This is located under the My Sites menu located at the left side of the upper toolbar.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3257').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3257' id='form_comment_on_answer_3257' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi, Scott. Thanks. I'm not seeing the My Sites menu - I see Dashboard &gt; My Sites but when I click on that all I get is Primary Site Martin Nichols Design   visit | dashboard   save changes. I've also checked wordpress.org help files and checked under the 'Howdy Admin' link as well.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/bigpacific'>bigpacific</a><br />
									9 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-06-04 5:21 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi, Scott - hoping for an answer or instructions on the missing 'Network Admin' link under 'my sites'. It is not showing for us...</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello bigpacific,<br />
<br />
As a test I created a <em>fresh install</em> of wordpress with multisites, and confirmed the <strong>Network Admin</strong> link is in fact there.<br />
<br />
If the <em>Network Admin</em> link is missing, it could be affected by the specific Themes/Plugins you are using. Have you tried disabling them and testing again? Also, here is a link to our guide on <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/common-wordpress-troubleshooting-techniques">troubleshooting Wordpress</a>.<br />
<br />
...
-John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Unfortunately even the plugins are not showing in the menu. I guess the best thing to do is delete the entire site and reinstall fresh.<br />
</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_3258' id='upvote_answer_3258' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3258' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3258').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3258' id='downvote_answer_3258' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3258' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3258').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello bigpacific,<br />
<br />
The /test copy was from us torubleshooting the original issue. That copy has been removed from the account. The version running in the root is unrestricted and can be used at will. You may certainly also create and run a development copy in a subfolder and move it to the root when you are ready.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3258').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3258' id='form_comment_on_answer_3258' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/plugins-not-showing-in-wp-administration-panels&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/plugins-not-showing-in-wp-administration-panels'></div>
<script type='text/javascript'>
  (function() {
