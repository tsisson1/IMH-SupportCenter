<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53764:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/prestashop-16/set-maintenance-mode" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-24T13:34:39-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to set your PrestaShop 1.6 store to maintenance mode." />
  <title>Setting Maintenance Mode in PrestaShop 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/set-maintenance-mode" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:63e40910aea96ac5e6ea41f988e5d924 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '196.207.159.84']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting Maintenance Mode in PrestaShop 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,111</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 21, 2014'><span style='color:#606060;'>Published:</span> Mar 24, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Whether you are creating your shop for the first time, or modifying your existing installation, you may not want to allow customers to come and shop while you are working. Whenever you want to work on your store without beign bothered by the public, you can set the store into a maintenance mode. We show you how to do that in this tutorial. Click here to see our page on <a href="http://www.inmotionhosting.com/prestashop-hosting">PrestaShop Hosting</a>.</p>


<h2>How to set Maintenance Mode in PrestaShop 1.6</h2>

<ol class="article_list">
  <li>First, <a href="/support/prestashop-16/admin-login">log into your admin dashboard</a>.<div style="clear:both;"></div></li>
  <li>Click on the <strong>Preferences</strong> option from the left hand side menu.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/_common-images/click-preferences-maintenance.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/_common-images/click-preferences-maintenance.png" title="Click here to view the larger image" /></a>Click on the <strong>Maintenance</strong> link in the submenu.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/preferences/maintenance/set-maintenance.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/preferences/maintenance/set-maintenance.png" title="Click here to view the larger image" width="200" /></a>You will see a simple tab with two fields. The first field is a toggle to turn the maintenance mode off and on. Clicking the <strong>Enable Shop</strong> switch to a green <em>Yes</em> means that the store is active. Clicking it to a red <em>No</em> means that maintenance moce id enabled.<div style="clear:both;"></div></li>
  <li>Next, if you wish for any developers or employees to still be able to view the store while it is in maintenance mode, enter their IP address in field named <strong>Maintenance IP</strong>. If you have more than one IP in the field, separate them with a comma.<div style="clear:both;"></div></li>
  <li>Click on the <strong>Save</strong> button in the lower right corner of the tab to activate the changes you have made.<div style="clear:both;"></div></li>
</ol>
<br />
<p>Now that you have set your store to maintenance mode, you can visit your site to see how it looks to the public. If you entered your IP in the maintenance IP field, you will need to visit the site from another network or IP. Below shows how a site looks normally and how it looks in maintenance mode.</p>

<table class="article_table" style="width:100%">
<tr>
  <th>Enabled</th><th>Disabled</th>
</tr>

<tr>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/preferences/maintenance/1-before.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/preferences/maintenance/1-before.png" title="Click here to view the larger image" width="100%" /></a></td>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/preferences/maintenance/1-after.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/preferences/maintenance/1-after.png" title="Click here to view the larger image" width="100%"/></a>
</td>
</tr>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/prestashop-16/set-maintenance-mode&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/prestashop-16/set-maintenance-mode'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzE2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="96777dd89a738dde2a025c17d34beb3a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/my-site-does-not-work-seisexycom?tsrc=rsbraq'>My site does not work seisexy.com</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8d34fb583ca9b3c86c0822a2f79e0d22?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8d34fb583ca9b3c86c0822a2f79e0d22'>Sandeep Panesar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-31 5:00 am</div>
				                <div>great, to the point. thank you very much.. it couldn't have been better</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16938);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
