<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53001:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-customize-my-soa-record-for-my-reseller-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Josereyez, Thanks for the question about the SOA (Statement of Authority). Basically, if you have just changed it, it is possible that you're runn..." />
  <title>How to customize my soa record for my reseller domain? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-customize-my-soa-record-for-my-reseller-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ef65455d5a27790a8f4a5a63fcd5c4e4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '37.182.225.145']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to customize my soa record for my reseller domain?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/dns-nameserver-changes'>Dns Nameserver Changes</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/josereyesz'>josereyesz</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-11-18 1:08 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>154</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I created my customized dns, but in soa record appears in primary name server ns1.servconfig.com and not ns1.jose.pe</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8558' id='upvote_answer_8558' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8558' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8558').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8558' id='downvote_answer_8558' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8558' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8558').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Josereyez,<br />
<br />
Thanks for the question about the SOA (Statement of Authority).  Basically, if you have just changed it, it is possible that you're running into DNS propagation.   Please allow for a few hours while the name servers on the internet update.   If you have allowed for the time to elapse already and you are still seeing the same problem, then please contact our live technical support team via email/phone/chat in order to have them review the issue for you.<br />
<br />
Also, did you follow the directions for using customized name servers as in our <a href="http://www.inmotionhosting.com/support/reseller/custom-name-server">tutorial</a>? Please double check on this and if you continue to have problems, please let us know.<br />
<br />
<br />
Kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8558').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8558' id='form_comment_on_answer_8558' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Arn,<br />
<br />
I configured with vanity nameservers instructions and test with intodns.com but certain errors appears in report. The error is &quot;Missing nameservers reported by parent&quot; display ns1.servconfig.com and ns2.servconfig.com, but not my nameservers ns1.jose.pe and ns2.jose.pe, why?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/josereyesz'>josereyesz</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-11-18 8:53 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Josereyesz,<br />
<br />
Sorry for the problem with the name servers, you should be able to change it.  There may be a problem with the DNS for your account.  Please <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our live technical support team</a> via phone/chat/email as they will most likely need to have the issue reviewed by one of the senior techs in order to re-push the DNS for your site.  We do not have the access here in the Support Center to address that issue.   Apologies that we can't provide a direct solution for the problem. <br />
<br />
...
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-customize-my-soa-record-for-my-reseller-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-customize-my-soa-record-for-my-reseller-domain'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="466003ef8cae87bbe1e1eb855304dc28" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/how-to-point-your-domain-to-tumblr'>How to Point Your Domain to Tumblr</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/change-google-domain-nameservers'>How to Change Name Servers in Google Domains (2)</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/change-name-servers-google-domains'>How to Change Name Servers in Google Domains</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/godaddy'>Making DNS Nameserver Changes at GoDaddy.com</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/change-dns-records-to-use-3rd-party-services'>Change DNS records to use 3rd party services</a><br/><br />
		</div>
