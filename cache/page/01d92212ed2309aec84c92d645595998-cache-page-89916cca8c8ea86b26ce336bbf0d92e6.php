<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55979:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/smf/administration/smtp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-07T20:57:06-08:00" />
  <meta name="keywords" content="SMF 2.0 edit smtp settings" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to enter SMTP settings in this SMF 2.0 article." />
  <title>Setting SMTP settings in SMF 2.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/smf/administration/smtp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e3bb4fe12d1ace1822843523a7c4716 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.184.35.142']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting SMTP settings in SMF 2.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,050</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 7, 2013'><span style='color:#606060;'>Published:</span> Jan 7, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>SMF has the ability to send emails out to its users. You can send them out via the default php mail or you can use SMTP protocol. To set up SMTP for SMF , simply follow the instructions below.</p>
<h2>How to set SMTP settings</h2>
<ol class="article_list">
<li><a href="/support/edu/smf/getting-started-smf/smf-admin-login">Log into your SMF admin dashboard</a>.</li>
<li>From the entry page, click <strong>Admin</strong> from the upper menu. This will reveal a second menu just underneath the first. Hover over <strong>Maintenance </strong>and click on the <strong>Mail</strong> option from the popup submenu.</li>
<li>Once on the main <em>Mail</em> page, click on the <strong>Settings</strong> link to bring up the email settings area. You will see three sections. The middle section is entitled <em>Mail Type</em>. Select <strong>SMTP</strong> from the <em>Type</em> Dropdown. There are four fields you will need to enter the SMTP settings into. <br />
<table class="article_table">
<tbody>
<tr><th>SMTP server</th>
<td>The mail server that the program will connect to send mail.</td>
</tr>
<tr><th>SMTP Port</th>
<td>The port number on the server that will be used.</td>
</tr>
<tr><th>SMTP username</th>
<td>The SMTP account username.</td>
</tr>
<tr><th>SMTP password</th>
<td>The SMTP account password.</td>
</tr>
</tbody>
</table>
<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/maintenance/mail/smtp-settings/smtp-settings.png"><img  alt="list of smtp settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/maintenance/mail/smtp-settings/smtp-settings.png" /></a></li>
<li>Once you have set the SMTP settings, click on the <strong>Save Changes</strong> button at the bottom to finalize your changes.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Setting SMTP settings in SMF 2.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/smf/administration/editing-groups'>How to edit group permissions in SMF 2.0</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/smf/administration/title-change'>How to change the header title in SMF 2.0</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/smf/administration/smtp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/smf/administration/smtp'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTMmaWQ9MjE1MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
