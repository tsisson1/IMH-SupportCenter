<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:102007:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-10-08T20:41:48-07:00" />
  <meta name="keywords" content="spam spamassassin cpanel email" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn what SpamAssassin is, and how to fight Spam with this free utility in your cPanel account." />
  <title>SpamAssassin: Fighting Spam - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5ff1021613d0fcad126c07e37f028893 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>34,134</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 6, 2011'><span style='color:#606060;'>Published:</span> Oct 8, 2015</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>20</a></div>
				...
				<a class="ddtut" href="http://support.inmotionhosting.com/userguides/cpflash_x3/cpanel_x3_spamassassin.swf" style='display:block; margin-bottom:15px;'>
					<img src='/support/images/icon.movie.png' /><br />
					Click here to watch a video tutorial
				</a>
				

								<p>SpamAssassin is a <strong>free utility</strong> offered to all InMotion Hosting customers to help combat spam. SpamAssassin works by blocking unwanted email addresses before they reach your email's inbox. By default, SpamAssassin is disabled so you must enable it within cPanel to take advantage of it's features.</p>
<h2>How does SpamAssassin Work?</h2>
<p>SpamAssassin is not an email filter, as some other spam prevention tools are. Instead, it determines whether an email is spam as soon as it hits the server. SpamAssassin works on the back end of your email server and has 10 different levels of settings to catch spam. When enabled by default, you will be set to 5. This is mid-range.</p>

<p>What does this default score of <strong>5</strong> actually mean?</p>

<h3>How the point system works</h3>

<p>SpamAssassin uses a points based system called "hits" to label spam. When it finds particular characteristics in an email it assigns a point value. If the email exceeds the maximum point value <strong>you</strong> set, the email is flagged as spam.</p>

<p>The lower the score <strong>you</strong> set, the more email will be caught as spam. For example, a setting of 1 means that only one <em>hit</em> needs to be flagged against an email for it to be considered spam. If you set the score higher, more <em>hits</em> will be required on an email for it to be labeled as spam. So, the lower the score, the more emails <em>should</em> be flagged as spam.</p>

<p>We suggest testing the different settings prior to using a higher setting.</p>

<h2>Enabling SpamAssassin</h2>
<ol class="article_list">
<li><p>The first step to enabling SpamAssassin is to <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into cPanel</a>. Once logged into cPanel, look for the icon called "<strong>SpamAssassin</strong>" under the <em>Mail</em> section.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/spamassassin1.jpg"><img  alt="spamassassin1" src="//cdn.inmotionhosting.com/support/images/stories/email/spamassassin1.jpg" /></a></p></li>


<li><p>Since SpamAssassin is disabled by default you will need to enable it. To do so, click on the "<strong>Enable Spam Assassin</strong>" link.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/spam-enable.jpg"><img  alt="spam-enable" src="//cdn.inmotionhosting.com/support/images/stories/email/spam-enable.jpg" /></a></p></li>


<li><p>Now that you have enabled SpamAssassin, you will see a confirmation page. Congratulations! You are finshed! Click go back if you wish to <a href="/support/email/fighting-spam/change-spamassassin-settings">modify the settings for SpamAssassin</a>.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/span-confirm.jpg"><img  alt="span-confirm" src="//cdn.inmotionhosting.com/support/images/stories/email/span-confirm.jpg" /></a>&nbsp;</p></li></ol>
<h2>Using Filters to Organize Spam</h2>
<p>In order to maximize the true power of SpamAssassin, we recommend you set up a Filter/Message rule in your mail client. Emails that are determined to be spam are still delivered to your inbox. Spam will begin with the subject line "***SPAM***". By setting up filters in your email client you can sort the mail and have all messages labeled as spam placed into its folder for review later.&nbsp; This will keep junk mail out of your inbox. To learn how to set up filters in various email clients, please visit our guide on <a href="/support/edu/everything-email/organizing-email/setting-up-email-filters">setting up email filters</a>.</p>
<p>Please check the next article on <a target="_blank" href="/support/edu/cpanel/cpanel-email/edit-mx-remote-local" title="Click here to view the next article">Setting domain MX records to remote settings in cPanel</a>. If you missed our previous article, please see the <a href="/support/edu/cpanel/cpanel-email/import-email-accounts-forwarders-in-cpanel" title="Click here to view the previous article" target="_blank">Import Email Accounts/Forwarders in cPanel</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/cpanel/cpanel-email" title="Click here to view the courses">Using Email</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: SpamAssassin: Fighting Spam</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/cpanel/cpanel-email/import-email-accounts-forwarders-in-cpanel'>Import Email Accounts/Forwarders in cPanel</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/cpanel/cpanel-email/edit-mx-remote-local'>Setting domain MX records to remote settings in cPanel</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzQmaWQ9OTgyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="79e917dbe989bbcaa8dff5cd14fd3de8" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/incoming-emails-going-to-junk-folder?tsrc=rsbraq'>incoming emails going to junk folder</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/how-can-i-stop-these-spam-exe-files-that-are-zipped-up-in-emails?tsrc=rsbraq'>How can I stop these spam .exe files that are zipped up in emails</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/is-spamassassin-trainable-on-shared-servers?tsrc=rsbraq'>Is SPAMASSASSIN trainable on shared servers?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/can-not-enable-spam-auto-delete-filter-setting?tsrc=rsbraq'>Cannot enable spam Auto-Delete filter setting</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/spam-assassin-spam-folder?tsrc=rsbraq'>Spam Assassin Spam Folder</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/how-can-i-notify-you-of-spam?tsrc=rsbraq'>How can I notify you of spam</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/emails-are-going-to-junk-in-error?tsrc=rsbraq'>E-mails are going to junk in error.</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/20648b02d01cf67a29b56064d7ac82e4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/20648b02d01cf67a29b56064d7ac82e4'>Cullie Bickham</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-20 11:57 am</div>
				                <div><p>When I identify SPAM emails, do I place the word SPAM on the subject line?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9910);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 9:04 am</div>
				                <div>When SpamAssassin identifies any spam, it will automatically place the word &lt;em&gt;spam&lt;/em&gt; within the subject line.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9934);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14848'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/64206178a272a9154179a2b85df0f93c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/64206178a272a9154179a2b85df0f93c'>Craig</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-08 4:33 pm</div>
				                <div><p>I've never ONCE seen a spam e-mail come through my SpamAssassin filter with "spam" appended to the&nbsp;subject line. &nbsp;I've got my Spam Score set to 1.1, and I specifically added rules to my configuration file that call for the subject to be modified.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14848);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-08 4:40 pm</div>
				                <div>Hello Craig, <br />
<br />
Thanks for the comment.  If you want to see if you're getting any spam, log in to <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail">webmail</a> then look for the SPAM folder and see if spam is being stored in the folder.  Otherwise, you may not be receiving any spam into your account.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14849);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13293'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9057c2b3c61c15e7a580b9378c6d2812?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9057c2b3c61c15e7a580b9378c6d2812'>Michael Hernandez</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 9:43 pm</div>
				                <div><p>It seems the instruction on this page counter the instructions on Spam Assasin...they say set the number higher (for ISP) " but if you're an ISP installing SpamAssassin, you should probably set the default to be more conservative, like 8.0 or 10.0"&nbsp; </p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13293);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-25 10:08 am</div>
				                <div>Hello Michael,<br />
<br />
Thank you for your comment. SpamAssassin uses a default threshold of 5, as per their <a href="http://wiki.apache.org/spamassassin/ImproveAccuracy#Pick_a_useful_threshold" target="_blank" >Official Documentation</a>.<br />
<br />
You can always <a href="http://www.inmotionhosting.com/support/email/fighting-spam/change-spamassassin-settings">change your SpamAssassin settings in cPanel</a> at any time.<br />
<br />
If you are following a specific guide, we would be happy to take a look? Can you provide a link to the guide?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13307);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14706'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/20458e71325f1db445a6b4033314d0e0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/20458e71325f1db445a6b4033314d0e0'>kunal jain</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 10:10 am</div>
				                <div><p>if I setup 3 that means I can stop more spam emails. I am getting lot fo junk email as zip files? how do I stop those. like the messages from AutoWarranty, </p>
<p></p>
<p class="MsoPlainText">IncomingFax.zip</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14706);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 10:29 am</div>
				                <div>On shared hosting accounts, it is not possible to filter zip files, however, on a VPS or dedicated server, &lt;a href=&quot;http://www.inmotionhosting.com/support/website/software/installable-software-reference&quot;&gt;ClamAV&lt;/a&gt; can be set up which will scan and remove unwanted zip files.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14707);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20223'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/baa394c912f489652ad893cf9aff18e5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/baa394c912f489652ad893cf9aff18e5'>Tim</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-01 5:19 pm</div>
				                <div><p>When using Spam Box, if we use imap will the spam folder show up in a local Outlook client?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20223);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-02 10:51 am</div>
				                <div>Hello Tim,<br />
<br />
Thank you for your email spam box question. Yes, since IMAP leaves all the files on the server by default, any client connecting via IMAP should be able to see all the folders including the Spam box.<br />
<br />
Ensure you <a href="http://www.inmotionhosting.com/support/email/outlook/inbox-subscribe">Subscribed to your INBOX</a> in Outlook, so you can view all folders available on the server.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20245);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22136'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/36ec32d4df7d88ff1a7d929dc9ee1cc2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/36ec32d4df7d88ff1a7d929dc9ee1cc2'>Jim</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-29 3:05 pm</div>
				                <div><p>I was receiving a lot of "junk" email so I played around with all the spam filters. Good news it stopped everything. The bad news it stopped EVERYTHING! I have disabled everything I could find, but now if someone sends an email to me, the system sends a "challenge" email back to them. If it is a human and they reply to the challenge email they get an email telling them that they are on the whitelist and can now send an email. How do I turn off the challenge part?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22136);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-30 10:13 am</div>
				                <div>Hello Jim,<br />
<br />
That sounds like you still have the BoxTrapper still running. Disabling that will stop the challenge emails from being sent.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22170);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23166'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f209b8d0bc541313368355191f06fb69?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f209b8d0bc541313368355191f06fb69'>Lori</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-04 12:32 pm</div>
				                <div><p>Which version of spam assasin are you running on the servers?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23166);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-04 1:14 pm</div>
				                <div>Hello Lori,<br />
<br />
While version may vary slightly from server to server, it appears that we are using SpamAssassin 3.3.1 <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23168);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23599'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/60c454be8459ca92e2c21aa3444499b2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/60c454be8459ca92e2c21aa3444499b2'>Craig</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 1:04 pm</div>
				                <div><p>Is there anything in place on VPS accounts that runs Bayes learning/filter programs automatically, or will I need to set that up myself through a cron job? &nbsp;It appears as though something is happening with Spamassassin learning something, but I'm really not too sure.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23599);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 5:31 pm</div>
				                <div>Hello Craig,<br />
<br />
Thank you for contacting us. While, we do not have system like that in place, you definitely have the ability to set it up, or configure it.<br />
<br />
If you are having trouble, or have a specific question about Spam Assassin, we would be happy to  help you.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23612);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28053'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3ec9e837780f762eeef1dc08b1b9f42f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3ec9e837780f762eeef1dc08b1b9f42f'>Roger Bailey</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-30 9:12 pm</div>
				                <div><p>Is it possible to run sa-learn from the command line?&nbsp; I have a small shell script that ran sa-learn on my previous host so that I could update HAM and SPAM.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28053);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-02 2:44 pm</div>
				                <div>Hello Roger,<br />
<br />
Our shared servers will not allow the sa-learn to run on them.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28096);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-02 3:30 pm</div>
				                <div><p>I've discovered that if you're on a VPS, you can set up a cron job to run sa-learn. &nbsp;I do not know about other forms of hosting, however. &nbsp;I have been told that you can run sa-learn from the command line IF you have shell access on your account, but you have to have a VPS account or higher.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28103);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28456'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f44f046bd872e76e4c7895902e074852?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f44f046bd872e76e4c7895902e074852'>Cheryl </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 1:39 pm</div>
				                <div>I am getting hundreds of spam and junk email and don't know what to do about it. I use outlook so not sure if that is doing anything to contribute to he amount of junk I'm getting.   I have the settings set for 1:1 but it doesn't seem to be helping at all.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28456);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>20</span> Questions & <span class='comment-text'>Comments</span></h3>
