<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50000:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/fighting-spam/is-there-any-way-to-undelete-a-message-mistakenly-deleted-from-the-boxtrapper-queue" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi bigalhec, Great question about BoxTrapper. Unfortunately, the only possible way to recover that message would be if it was included in the latest bac..." />
  <title>is there any way to undelete a message mistakenly deleted from the boxtrapper queue? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/fighting-spam/is-there-any-way-to-undelete-a-message-mistakenly-deleted-from-the-boxtrapper-queue" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:aaec9621170e0b55774b6b86e5b29206 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>is there any way to undelete a message mistakenly deleted from the boxtrapper queue?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/bigalhec'>bigalhec</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-03-28 2:36 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>912</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_793' id='upvote_answer_793' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='793' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_793').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_793' id='downvote_answer_793' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='793' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_793').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi bigalhec,<br />
<br />
Great question about BoxTrapper. Unfortunately, the only possible way to recover that message would be if it was included in the latest &lt;a href=&quot;http://www.inmotionhosting.com/support/website/general-server-setup/do-you-run-backups-of-your-servers&quot;&gt;backup of your account&lt;/a&gt;. Honestly, it would be more efficient to request that the sender re-send that email message. If that is not a workable solution, you can send a verified email (include either the last 4 digits of the credit card on file or the AMP password) to support@inmotionhosting.com asking that we &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/restoring-a-backup&quot;&gt;restore&lt;/a&gt; the BoxTrapper queue. Please note, this will completely overwrite the current queue and we cannot guarantee that the message is included in the backup.<br />
<br />
...
Christi N.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_793').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_793' id='form_comment_on_answer_793' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/fighting-spam/is-there-any-way-to-undelete-a-message-mistakenly-deleted-from-the-boxtrapper-queue&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/fighting-spam/is-there-any-way-to-undelete-a-message-mistakenly-deleted-from-the-boxtrapper-queue'></div>
<script type='text/javascript'>
  (function() {
