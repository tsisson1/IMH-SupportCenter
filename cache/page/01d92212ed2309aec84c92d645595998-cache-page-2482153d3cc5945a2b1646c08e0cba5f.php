<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:87235:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/managing-files/how-to-upload-files-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-02-24T19:14:26-08:00" />
  <meta name="keywords" content="how to upload file to server notepad++ notepad filezilla file manager" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="There are several ways to upload files to your server. This article will teach how to upload using File Manager, FileZilla, and Notepad++." />
  <title>How do I upload a file to my server? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/managing-files/how-to-upload-files-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bdf76c4d748fb4c07eaa8d4bf8cd4d4a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '207.244.86.212']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I upload a file to my server?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>45,164</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 1, 2013'><span style='color:#606060;'>Published:</span> Feb 24, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There are quite a few ways to upload a file to your server at InMotion Hosting. How you upload your files will depend on your preference and your accessibility to the server. In this tutorial, we will explain how to upload a file using the File Manager, FileZilla, and Notepad++.&nbsp;We assume that you know where within your account you need to upload your files. If you're not sure however, please see our article entitled <a target="_blank" href="/support/website/getting-started-guides/where-to-upload-files">What directory should I put my files in?</a>.</p>
<h2>What's the difference between each method</h2>
<p>There are reasons why a developer would use File Manager, FileZilla, or Notepad++. The following will explain why you would pick one method or the other.</p>
<p><strong>File Manager (browser based):</strong> The File manager is good to use when you are away form your computer and you can access a browser. The File Manager can be accessed from any location. This eliminates the need to install a program like FileZilla or Notepad++.</p>
<p><strong>FileZilla (FTP):</strong> FileZilla is good to use for uploading files because it works over port 21 and can upload mass amounts of files all at once.</p>
<p><strong>Notepad++ (Code Editor):</strong> Using Notepad++ is a way to upload files while you create the content for them, notepad++ is similar to DreamWeaver in that you can Edit files and upload them through the same interface. This eliminates the need to have an HTML editor and a FTP program at the same time.</p>


<a name="file-manager"></a><h2>How to upload a file through File Manager</h2>
<center><iframe width="560" height="315" src="https://www.youtube.com/embed/yAzpz6_U67M" frameborder="0" allowfullscreen></iframe></center>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a>.
<p><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>, <strong>select the public_html directory and click Go.</strong></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-1-upload.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click upload File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-1-upload.gif" title="Click here to view the larger image" width="100" /></a><strong>Navigate to the directory </strong>you want to upload a file to.
<p><strong>Click the Upload link</strong> at the top of the File Manager.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-2-browse.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="browse the loacl server File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-2-browse.gif" title="Click here to view the larger image" width="100" /></a><strong>Browse your local computer for the file</strong> you want to upload. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-3-select-file.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select the file File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-3-select-file.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the file and click Open</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-4-file-in-folder.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View of files in File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-4-file-in-folder.gif" title="Click here to view the larger image" width="100" /></a>Close the Upload files page. <strong>Refresh your File Manager by clicking the Reload link </strong>at the top middle of the File Manager.
<p>You should see the file listed in the File Manager now.</p>
<br style="clear: both;" /></li>
</ol>

<a name=""></a>
<h2>How to upload With FTP using FileZilla</h2>
<p>FileZilla has the ability to upload files from your computer to your server with us. The Left side is the" <em>Local Site</em>" and the Right is the "<em>Remote Site</em>". The "<em>Local Site</em>" is your where your computer files are located. The "<em>Remote Site</em>" is the location of the files on the server. Below is how to upload a file using FileZilla.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/website/file-management/configuring-your-site-in-filezilla" title="Click for more information">Connect to your server with FileZilla</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-5-local-filezilla.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Local File search FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-5-local-filezilla.gif" title="Click here to view the larger image" width="100" /></a><strong>Navigate your files</strong> in the third window on the left underneath the "<em>Local Site:</em>" box where its says"<em>Filename</em>". <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-6-drag-file.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Drag file from local to remote FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-6-drag-file.gif" title="Click here to view the larger image" width="100" /></a>The Window to the right of it is the "<em>Remote Site</em>" directory. <strong>Navigate to the folder where you want to upload the file/folder</strong> to in the "<em>Filename</em>" Window underneath the "<em>Remote Site</em>" window.
<p><strong>Drag the file you want to upload to the server</strong> from the "<em>Local Site</em>" to the "<em>Remote Site</em>".</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-7-file-indirectory-filezilla.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="File in directory FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-7-file-indirectory-filezilla.gif" title="Click here to view the larger image" width="100" /></a>The File will upload and you will see the file in the list of files in the directory where you dragged the file to. <br style="clear: both;" /></p>
</li>
</ol>
<h2>Using a program like Notepad++</h2>
<p><strong>Notepad++</strong> is a program that allows you to edit your site and upload and create files on the server. It is similar to HTML editor programs like <strong>Edit Plus</strong> or <strong>DreamWeaver</strong>. Below will explain how to create a file on your server with Notepad++.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/website/file-management/connect-ftp-notepad-plus" title="Click for more information">Connect to your server with Notepad++</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-8-right-click-notepad.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Right click Notepad++" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-8-right-click-notepad.gif" title="Click here to view the larger image" width="100" /></a><strong>In the NppFTP Window</strong> on the right side of Notepad++, <strong>navigate to the folder</strong> you want to upload a file to. <strong>Right click the folder and select "<em>Upload other file here. . .</em>". </strong><br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-9-browse.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Browse for the fiel Notepad++" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-9-browse.gif" title="Click here to view the larger image" width="100" /></a><strong>Browse the server for the file</strong> you want to upload. <strong>Select the file and Click open</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-10-file-in-directory.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View of file in Notepad++" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/upload-files-server/how-to-upload-a-file-10-file-in-directory.gif" title="Click here to view the larger image" width="100" /></a>Now you will see the file in the folder location on the server. <br style="clear: both;" /></p>
</li>
</ol>
...
<p>To learn how to edit a file, see our article <a target="_blank" href="/support/website/how-to/how-to-edit-a-file">How do I edit a file on my server?</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/managing-files/how-to-upload-files-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/managing-files/how-to-upload-files-server'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDYmaWQ9NTUwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="40aac0c3da0f6d4b1547679a8e204d65" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/348dc5d669cf3321d3c7dd50914e4806?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/348dc5d669cf3321d3c7dd50914e4806'>Fleur</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-18 3:07 pm</div>
				                <div><p>I'm in filezilla and need to know which file to upload my muse(local) file to. &nbsp;I tried to upload it to public_html and it wasn't quite right. &nbsp;Any help?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9875);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-18 3:16 pm</div>
				                <div>Hello Fleur,<br />
<br />
When you are uploading a file to your account, the location you put the file in depends what you are trying to accomplish.<br />
<br />
I recommend reading our guide that explains <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/where-to-upload-files">what directory to put your files in</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9877);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10346'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7aee3875e98cd40cc5afe83034f3bd9d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7aee3875e98cd40cc5afe83034f3bd9d'>SB</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-02 12:43 pm</div>
				                <div><p>I've followed the instructions above and uploaded a file using File Manager.</p>
<p>&nbsp;</p>
<p>How do I SEND A LINK VIA EMAIL to my client so they can access the file?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10346);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-02 1:03 pm</div>
				                <div>Hello SB,<br />
<br />
Thank you for contacting us. After uploading a file, you can <em>Hotlink</em>, or <em>Directlink</em> to the file, which is explained in <a href="http://www.inmotionhosting.com/support/edu/website-design/inserting-links-into-website/hotlink-direct-link">this article</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10348);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14502'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/caa5a45a1398e07141241e01dbe1ae9c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/caa5a45a1398e07141241e01dbe1ae9c'>Tony</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-29 5:05 pm</div>
				                <div><p>Do you have any articles on creating a browse button so other can upload files and picturs to your browser?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14502);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-02 10:56 am</div>
				                <div>Hello Tony,<br />
<br />
While you will not upload files to your browser as it lives on your local machine, you can set up some code to allow you to upload files and images to your hosting account. We do not currently have an article with this code, but there is a good <a href="http://www.w3schools.com/php/php_file_upload.asp">tutorial at W3Schools</a> that goes over this for you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14571);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 11:08 am</div>
				                <div><p>Thanks for responding Scott. That's exactly what I'm looking for. I've been working on this for far too long. I keep coming across that type of code but I can't get the dots to connect. Everytime I use the browse button I have a problem with the upload process.</p>
<p>I really like the way you guys respond to the public without asking us to open an account before you respond.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14651);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-08 11:37 am</div>
				                <div>Thank you for the kind words Tony, we want everyone to feel comfortable asking questions. We don't have all the answers, but we try to point you in the right direction if we do not. <br />
<br />
With your situation, is there an error message or particular behavior you encounter when the browse button is clicked?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14838);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25994'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/826993624056136916ec5ea346cc4a0b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/826993624056136916ec5ea346cc4a0b'>SP</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-23 5:58 am</div>
				                <div><p>how to upload a software plz help me!!! in filezilla</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25994);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-24 2:32 pm</div>
				                <div>Hello SP,<br />
<br />
Thank you for contacting us. The above guide explains how to upload a file via FileZilla. If you are having trouble connecting, here is a link to our guide on <a href="http://www.inmotionhosting.com/support/website/ftp-client-setup/configuring-your-site-in-filezilla">Configuring your site in FileZilla</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26033);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>10</span> Questions & <span class='comment-text'>Comments</span></h3>
