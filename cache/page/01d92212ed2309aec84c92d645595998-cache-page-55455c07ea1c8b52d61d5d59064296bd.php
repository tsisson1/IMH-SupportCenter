<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50425:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/zippostal-code-problems-in-prestashop" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello deigam5, Sorry to hear you are having an issue with Zip Code validation within PrestaShop. I did some research on the subject and the official ste..." />
  <title>Zip/Postal Code problems in Prestashop | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/zippostal-code-problems-in-prestashop" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fe445b1044433d9fbe3b2a9258220d74 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Zip/Postal Code problems in Prestashop</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/deigam5'>deigam5</a>
			<div>31 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-09-12 4:06 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>898</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>A lot of Prestashop users are having trouble with the zip code validation.  When the zip code format field in Localization - Countries is left blank or filled with the correct format it puts a red X next to the zip code, so that it looks like it will not accept it.  <br />
<br />
It will accept it and the customer will be able to continue checkout, but as an online shopper, I would assume that something was wrong.  <br />
<br />
My version is 1.6.1.0.  I didn't have this problem in 1.6.0.8, but I have seen forum posts about this issue all the way back to 1.4. If anyone out there has a solution, it would be appreciated. </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8101' id='upvote_answer_8101' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8101' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8101').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8101' id='downvote_answer_8101' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8101' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8101').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello deigam5,<br />
<br />
Sorry to hear you are having an issue with Zip Code validation within PrestaShop. I did some research on the subject and the official step to fix it is:<br />
<br />
"You need to update your theme and more specificaly this file https://raw.githubusercontent.com/PrestaShop/PrestaShop/1.6.1.x/themes/default-bootstrap/js/tools/statesManagement.js"<br />
<br />
This was directly from the <a href="http://forge.prestashop.com/browse/PSCSX-4852">PrestaShop bug forum</a>.  That should get you all set.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8101').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8101' id='form_comment_on_answer_8101' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you very much!  It worked perfectly.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/deigam5'>deigam5</a><br />
									31 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-09-18 3:58 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/zippostal-code-problems-in-prestashop&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/zippostal-code-problems-in-prestashop'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3df594a12f2e757c0712972a6716424d" value="1" />	</div>
	</form>
<!-- <br />
