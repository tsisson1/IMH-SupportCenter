<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54400:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/upgrade-on-presta16-but-contact-information-block-not-show-on-det" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="first install contact information block and re-install the same module , re arrange the footer modules ..." />
  <title> upgrade on presta1.6  but &quot;Contact information block&quot; not show on det | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/upgrade-on-presta16-but-contact-information-block-not-show-on-det" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:793380e63f71dc492460ee3c693a4983 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'> upgrade on presta1.6  but &quot;Contact information block&quot; not show on det</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-07-07 4:09 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>217</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>im upgrading 1.5 to 1.6 <br />
&quot;Contact information block&quot; details was not  show on front end..<br />
 plz help me</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5216' id='upvote_answer_5216' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5216' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5216').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5216' id='downvote_answer_5216' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5216' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5216').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
When you &lt;a href=&quot;http://www.inmotionhosting.com/support/prestashop-16/prestashop-upgrade-15-16&quot; target=&quot;_blank&quot;&gt;upgrade PrestaShop 1.5 to 1.6&lt;/a&gt;, there can be some issues like &lt;a href=&quot;http://www.inmotionhosting.com/support/prestashop-16/move-cart-block-after-upgrade&quot; target=&quot;_blank&quot;&gt;positioning the cart block after PrestaShop 1.6 upgrade&lt;/a&gt;.<br />
<br />
Please let us know if following similar steps towards solving that problem also work for the contact information block you're having issues with.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5216').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5216' id='form_comment_on_answer_5216' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5217' id='upvote_answer_5217' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5217' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5217').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5217' id='downvote_answer_5217' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5217' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5217').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-JxCUP_IBq6A/AAAAAAAAAAI/AAAAAAAAAHo/vJkaiNMEKvQ/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/jinumist'>jinumist</a>
					
					<div>13 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-07-07 5:52 am EST
                		        </div>
					
		                </div>

				first install contact information block and re-install the same module , <br />
re arrange the footer modules 
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5217').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5217' id='form_comment_on_answer_5217' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>first uninstall contact information block and re-install the same module</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-JxCUP_IBq6A/AAAAAAAAAAI/AAAAAAAAAHo/vJkaiNMEKvQ/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/jinumist'>jinumist</a><br />
									13 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-07-07 5:56 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Jinumist,<br />
<br />
I did a test of a 1.5 - 1.6 upgrade and noticed the same issue with the Contact Information Block. Any information I entered was not being displayed despite PrestaShop telling me it was saved. The information was not even being saved to the database.<br />
<br />
I uninstalled and reinstalled the module and it began working correctly. That should also work for you.<br />
<br />
Kindest Regards,<br />
Scott M<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									...
									37,013 <a href='/support/team/points' target='_blank'>Points</a>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/upgrade-on-presta16-but-contact-information-block-not-show-on-det&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/upgrade-on-presta16-but-contact-information-block-not-show-on-det'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="9daf4bac3a6942b5c59b253f5532695b" value="1" />	</div>
	</form>
<!-- <br />
