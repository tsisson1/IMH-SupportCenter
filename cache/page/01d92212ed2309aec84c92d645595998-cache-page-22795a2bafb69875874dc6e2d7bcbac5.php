<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47489:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/themes" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>105: Managing and working with Drupal 8 themes | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/themes" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ac960d2a1945ecd380ffe88ca1050520 -->
...
<div class='page-header'>
	<h1>105: Managing and working with Drupal 8 themes</h1>
</div>
<div class='section_listing'>
	The purpose of this course is to get you familiar with themes and how they work in Drupal 8.
	<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/enable-disable'>Enabling and Disabling themes in Drupal 8</a>
					<div>Check out this article to learn how to enable and disable themes for use in Drupal 8.</div>
					<div class='smallgrey'>Hits: 874</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/upload-new'>Uploading a new theme in Drupal 8</a>
					<div>Looking to get a new theme uploaded for your Drupal 8 site? Look no further, the instructions are right here!</div>
					<div class='smallgrey'>Hits: 4,645</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/change-default'>Changing the default theme in Drupal 8</a>
					<div>Let this short article demonstrate how to change your default theme in Drupal 8.</div>
					<div class='smallgrey'>Hits: 761</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/change-color-set'>Changing color sets for themes in Drupal 8</a>
					<div>Interested in changing the colors to your selected theme? Check out this article for changing color sets in Drupal 8</div>
					<div class='smallgrey'>Hits: 576</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/customize-colors'>Customizing theme colors in Drupal 8</a>
					<div>Looking to add your own flair with theme colors? Check out this article as we show you how to customize theme colors in Drupal 8.</div>
					<div class='smallgrey'>Hits: 686</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/toggle-logo'>Disabling the Drupal logo in your Drupal 8 theme</a>
					<div>Looking to remove the Drupal logo from your theme? Check out this article for how to do just that.</div>
					<div class='smallgrey'>Hits: 609</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/upload-custom-logo'>Setting custom logos in your Drupal 8 theme</a>
					<div>Looking to ditch the stock Drupal logo and upload your own? Check out this article on how to do just that in Drupal 8.</div>
					<div class='smallgrey'>Hits: 2,657</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/custom-favicon'>Uploading a custom favicon in Drupal 8</a>
					<div>Looking to change the default favicon in your Drupal 8 theme? Check out this article for instructions.</div>
					<div class='smallgrey'>Hits: 1,567</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/remove-title'>Removing the site title in Drupal 8</a>
					<div>If you are looking to remove the site title from  your Drupal 8 site, this tutorial will guide you.</div>
					<div class='smallgrey'>Hits: 1,164</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/themes/disable-user-images'>Disabling user images for posts and comments in Drupal 8</a>
					<div>If you do not wish to allow user images within posts and comments, check out this article for instructions on disabling them in Drupal 8.</div>
					<div class='smallgrey'>Hits: 326</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjgmaWQ9NDY4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
