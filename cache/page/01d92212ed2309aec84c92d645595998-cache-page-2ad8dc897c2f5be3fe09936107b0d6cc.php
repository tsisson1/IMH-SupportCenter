<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54875:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/why-is-my-home-page-displaying-as-an-index-list-only" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi pawpawspilotcar, When someone tries to load your website and does not manually type in a file name (such as index.php or index.html), the server atte..." />
  <title>Why is my home page displaying as an index list only? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/why-is-my-home-page-displaying-as-an-index-list-only" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e630eb847584db70f42d4bc17fbf2bc9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '83.25.230.232']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Why is my home page displaying as an index list only?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/pawpawspilotcar'>pawpawspilotcar</a>
			<div>15 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-01-30 5:20 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>53,790</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have uploaded all of my files for my website. I don't have an index file that I can find (index.htm or index.html).  When I type in my domain name, I see a page titled &quot;Index of /&quot; that lists each of the files used to create my website. Can anyone tell me how to fix this?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_482' id='upvote_answer_482' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='482' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_482').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_482' id='downvote_answer_482' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='482' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_482').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,399 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-01-30 5:37 pm EST
                		        </div>
					
		                </div>

				Hi pawpawspilotcar,<br />
<br />
When someone tries to load your website and does not manually type in a file name (such as index.php or index.html), the server attempts to load the &quot;directory index&quot;. The directory index is a listing of files it should load.<br />
<br />
For example, if you type in domain.com (IE not domain.com/index.php), the server will attempt to load files in the following order. If a file is not found, then it tries to load the next file in the list:<br />
<br />
http://domain.com/index.html<br />
http://domain.com/index.htm<br />
http://domain.com/index.php<br />
<br />
... and finally, if your server does not find any of these files, it then simply returns a listing of all of the files in the directory.<br />
<br />
If you have a homepage called something other than index, such as welcome.html, &lt;a href='http://www.inmotionhosting.com/support/website/general-server-setup/what-is-the-htaccess-file-and-what-do-i-use-it-for' target='_blank'&gt;edit your .htaccess file&lt;/a&gt; and add this line to tell the server to load this file first:<br />
<br />
&lt;div class='code_block'&gt;DirectoryIndex welcome.html index.html index.htm index.php&lt;/div&gt;<br />
<br />
&lt;strong&gt;To answer your question:&lt;/strong&gt;<br />
If you do not want the server to return a listing of all the files, you can disable this feature within your cPanel.<br />
<br />
1. &lt;a href='http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel' target='_blank'&gt;Log into your cPanel&lt;/a&gt;. cPanel is included with all of our accounts, including our &lt;a href='http://www.inmotionhosting.com/dedicated_servers.html' target='_blank'&gt;dedicated servers&lt;/a&gt;.<br />
2. Find and click on the icon that says &quot;Index Manager&quot; (should be at the bottom of cPanel)<br />
2B. If you get a pop up message, choose &quot;web root&quot; and then click &quot;Go&quot;<br />
3. Navigate to the folder that you want to adjust this value for. Click the folder icon to go into the folder, and click the actual folder name to select that folder and make changes for it<br />
4. Select &quot;No Indexing&quot; to hide the file names, or select &quot;Standard&quot; or &quot;Fancy&quot; indexing to list them and then click &quot;Save&quot;<br />
<br />
&lt;div class='vital_heading'&gt;Please be aware that when you make a change here, it will affect all subfolders as well. For example, if you set &quot;No Indexing&quot; for your public_html directory, then it will apply the setting to all folders within your public_html (so that you don't have to manually make this change to every folder).&lt;/div&gt;<br />
<br />
For more details on directory index (referred to above), please see:<br />
&lt;a href='http://www.inmotionhosting.com/support/website/getting-started-guides/where-to-upload-files' target='_blank'&gt;What directory should I put my files in?&lt;/a&gt;<br />
<br />
I hope this helps! If you have any questions, feel free to post a comment on this page and I'll be happy to help further.<br />
<br />
Thanks!<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_482').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_482' id='form_comment_on_answer_482' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi<br />
             I am new to webhosting,i am also facing the same issue &quot;Home page displaying as an index list only?&quot;,I would like to know that what is this cPanel, i am using godaddy server,In godaddy what we can do to solve this issue</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/rasiya.muhammed/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Rasiya'>Rasiya</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-04-22 7:37 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>cPanel is a hosting control panel that is used by us, as well as the majority of hosts across the world.  It is used to manage your hosting account.<br />
<br />
If you are hosting with GoDaddy, I won't have specifics as to how you can solve the problem, but in most cases it is simply because you do not have the correct file name for your index file.  The name of your index file should be something like &lt;em&gt;index.html&lt;/em&gt; or &lt;em&gt;index.php&lt;/em&gt;.  If you don't have a file named index, this would be why you are seeing this.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/why-is-my-home-page-displaying-as-an-index-list-only&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/why-is-my-home-page-displaying-as-an-index-list-only'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="1bf0177fda178a6f231e5aec90018c0b" value="1" />	</div>
	</form>
<!-- <br />
