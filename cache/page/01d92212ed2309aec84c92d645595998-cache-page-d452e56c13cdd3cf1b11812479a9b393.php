<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60478:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/open-source/browser-session-expired-timeout-how-to-avoid-on-large-forms" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Chuck, Thanks for the question about extending browser session times. The main problem here is that it does require a coding specific answer and w..." />
  <title>Browser session expired (timeout) - how to avoid on large forms | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/open-source/browser-session-expired-timeout-how-to-avoid-on-large-forms" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f3793efd98ded83033eed99ad9d2ed73 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '83.53.213.209']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Browser session expired (timeout) - how to avoid on large forms</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/open-source'>Open Source</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh6.googleusercontent.com/-vNP7HBzWW0Q/AAAAAAAAAAI/AAAAAAAACMg/kYBA79O4G-c/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/chuckbower'>chuckbower</a>
			<div>44 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-10-21 1:29 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>216</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have an application (PHP) that my users use that has some large forms.  Often, my users take some amount of time to fill out the forms, 1-2 hours for example.  Yes, I know it would be great if the forms weren't so large, but often there is some amount of thinking and consideration that goes into entering information into the forms.  My users are getting &quot;browser session expired&quot; or similar messages after some period of time (could be 1-2 hours), and it occurs when they click Save to save all of the information they have entered.<br />
<br />
How can I avoid this problem?<br />
<br />
These are things I have tried:<br />
Asking my users to remember to save periodically (works MOST of the time - but not ALL).<br />
Changing php.ini for session.bc_maxlifetime from 1440 to 10800 seconds. <br />
<br />
Any other ideas?  It seems like session garbage collection must be running independently of settings from php.ini and I have ANGRY users.<br />
<br />
Chuck</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8370' id='upvote_answer_8370' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8370' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8370').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8370' id='downvote_answer_8370' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8370' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8370').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Chuck,<br />
<br />
Thanks for the question about extending browser  session times.  The main problem here is that it does require a coding specific answer and we do not provide coding support.  However, we do try to point you in a direction that will give you an answer, and I think I may have found one.  Check out this post concerning <a href="http://stackoverflow.com/questions/8311320/how-to-change-the-session-timeout-in-php" rel="nofollow" target="_blank">How to change the session timeout in PHP</a>.  The author of the answer gives you really good information about how you should make the changes apply in your code.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8370').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8370' id='form_comment_on_answer_8370' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Arnel, I use stackoverflow.com all the time.  I had spent a couple of hours researching today, and with all of the timeout questions and answer postings, I had not seen this one, but its perfect, I think.  Most of the Internet postings have developers discussing why someone wants to do something, not HOW.  Including session_set_cookie_params may just be the key.  I had tried my other fix in php.ini, but I like the idea of embedding these 2 settings in the php scripts - I can easily implement this in my script that initiates session_start, and prior to that script command.<br />
<br />
I am testing right now, with a sample form page, we'll see how we do!!!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-vNP7HBzWW0Q/AAAAAAAAAAI/AAAAAAAACMg/kYBA79O4G-c/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/chuckbower'>chuckbower</a><br />
									44 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-10-21 2:32 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Well, it didn't work.  I setup a temporary script to show me phpinfo() and it shows the session.gc_maxlifetime and session.cookie_lifetime = 10800 (for 3 hours, 60 seconds x 60 minutes x 3 hours).  What a struggle.  I am following a tip that is embedded further down the article.  It appears that Debian and Ubuntu Linux systems override PHP session behavior and perform session cleanup (garbage collection) in a different fashion.  I am going to attempt to override the folder/directory where the session files are kept, hopefully allowing the 10,800 second settings to work.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Chuck,<br />
<br />
Thanks for the ongoing commentary on your efforts.  I truly hope you find the solution.  I'm not sure if you look in the actual manual - some of the user comments might help:  <a href="http://php.net/manual/en/ref.session.php" rel="nofollow" target="_blank">PHP: Session Functions</a>.  There's an interesting comment about how Debian does session management. Just search for Debian and you'll see what I mean.  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Arnel, this is also helpful, especially the comment about Debian.  But I took a look at the PHPInfo output and it seems to indicate my server biz166 is a RedHat OS?  Is this still Debian???  I guess I'm not &quot;up&quot; on whether it is a variant of Debian or not.  The first changes I made were to my php.ini file, including a different session save path folder.  The comment references a &quot;global&quot; php.ini.  I have a php.ini in my html folder, and one in my application folder, and both are set the same (double checked that).  The problem is, when I run PHPInfo, (for an application that does not have the modified script), I don't see my modified php.ini values reflected in the PHPInfo output.  I only see 2 php.ini files in my entire set of folders (I searched via File Manager from control panel).  So... that means my changes in php.ini are NOT being reflected.  Is there a restart that has to be done since I changed php.ini?  Or is there a &quot;hidden&quot; php.ini that I am unaware of that isn't changed?</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Arnel, ok, I feel like a big &quot;duh&quot;.  I think I just figured out that php.ini has to be in EACH application sub-folder.  I can't put a copy at the top level (such as hawthorneps.com) and think it will affect each application located at hawthorneps.com/Demo5, for example.  Ok, I have put it in each individual application folder, and now I see the changes reflected in the phpinfo.php.  This is what I probably need.  I will test later today.  Hopefully if I can get this to work, you can provide this solution to other customers that struggle with this problem too.<br />
</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Arnel, I've done a bunch of testing and it looks great.  No session expirations up to 3 hours.  Now that I understand I need the customized php.ini in each app folder, I'll automatically include that in my installation process.  Thanks so much for your help!</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Chuckbower,<br />
<br />
I am glad that everything is working now and Arnel was able to assist you to get to that point.<br />
<br />
Best Regards,<br />
TJ Edens</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/open-source/browser-session-expired-timeout-how-to-avoid-on-large-forms&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/open-source/browser-session-expired-timeout-how-to-avoid-on-large-forms'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3e4d2d7aa6e1eed877c73c557ff84358" value="1" />	</div>
	</form>
<!-- <br />
