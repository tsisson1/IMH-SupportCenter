<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70216:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/email/mailing-lists/email-limit-exception-request-amp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-12T20:20:03-08:00" />
  <meta name="keywords" content="250 AMP email exception limit" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article we will discuss how to send an email limit exception request through AMP. " />
  <title>Sending an Email Limit Exception Request in AMP - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/mailing-lists/email-limit-exception-request-amp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cc9600d2ae3233ec291e212c23cdd354 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Sending an Email Limit Exception Request in AMP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,473</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>All accounts hosted with <a href="http://www.inmotionhosting.com">InMotion Hosting</a> allow you to send out mailing lists. On our shared servers there is a <a href="/support/email/mailing-lists/email-marketing">limit to the number of emails sent per hour</a> to help prevent spam. The initial limit is 250 emails per hour per cPanel account. If you need to send out more emails then are permitted, you can request the limit be raised. You can send us a Bulk Email Request in your <a href="https://secure1.inmotionhosting.com/index/login">Account Management Panel (or AMP)</a>.</p>

<h2>How to send an Email Limit Exception Request</h2>
<ol class="article_list">
<li><a href="/support/website/how-to/how-to-log-into-amp">Log into your Account Management Panel (AMP ) interface</a>.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/bulk-limit-exception/emailexemptionicon.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Click Bulk Limit Exception Request link" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/bulk-limit-exception/emailexemptionicon.png" title="Click here to view the larger image" width="200" /></a><p>Click the <strong>Request Email Limit Exemption</strong> icon.</p></li>
<div style="clear:both;"></div>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/bulk-limit-exception/info.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Click Bulk Limit Exception Request link" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/bulk-limit-exception/info.png" title="Click here to view the larger image" width="200" /></a>The next screen will ask for information related to your request. Please fill in all the information as thoroughly as possible.
<div style="clear:both;"></div>
<table class="article_table">
<tr><th>What domain will be sending out the list?</th><td>This is the name of the website that will be sending out the emails, such as <em>example.com</em>.</td></tr>
<tr><th>How many emails do you plan to send out?</th><td>This is normally the size of your email list. If you have 500 members, then the number here will be 500.</td></tr>
<tr><th>How often will these emails be sent?</th><td>List whether you plan on sending these emails out on a daily, weekly, monthly, or other basis.</td></tr>
<tr><th>What is the source of the emails?</th><td>Describe how you collected the email addresses. (from your site, did you purchase them, etc)</td></tr>
<tr><th>Where is the "Opt Out" link in each email?</th><td>Every bulk mail is required to have an "opt out" or "unsubscribe" link. Describe where yours is.</td></tr>
<tr><th>What software do you plan to use to send your mail?</th><td>List the program that will be handling the email list. For example you may be using phplist.</td></tr>
<tr><th>What methods will you use to 'rate limit' the mailing list as it is sent out?</th><td>Sending out a large number of emails at once can slow the server. You will want to send them out in smaller batches. This is known as 'rate limiting'. Describe how you will accomplish that here.</td></tr>
</table>

<div style="clear:both;"></div></li>
<li>Once you are done, click the <strong>Submit</strong> button. This will send the information in an email to our Support department. After submitting the request, a support technician will analyze your request and send you an email once a decision is made.<div style="clear:both;"></div></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/email/mailing-lists/email-limit-exception-request-amp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/email/mailing-lists/email-limit-exception-request-amp'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="4ae2e1eb44d947737196a9c05186624b" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/can-i-determine-my-email-limit-status?tsrc=rsbraq'>Can I determine my Email limit status</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/76dff1f5152611a48af3ca8bfa9afeed?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/76dff1f5152611a48af3ca8bfa9afeed'>Scott Jacob</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-03 6:03 pm</div>
				                <div><p>It seems the Additional Services -&gt; Other area is no longer on the redesigned AMP dashboard.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8743);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-04 11:27 am</div>
				                <div>Thank you for notifying us.  I have edited the article so that it now shows the proper steps.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8758);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13441'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01e71467467d6d25f4880f7ee142aa85?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01e71467467d6d25f4880f7ee142aa85'>Ron</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-29 12:57 pm</div>
				                <div><p>I'm running a VPS and in my AMP menu I don't have the "<strong style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">Request Email Limit Exemption</strong>" option. What is my hourly limit on emails and can it be changed?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13441);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-29 1:17 pm</div>
				                <div>Hello Ron,<br />
<br />
Thanks for the question!  This limit is not set in AMP for VPS/Dedicated server account.  You can find a tutorial on this by going to <a href="http://www.inmotionhosting.com/support/team/set-max-hourly-email-limit">Set max Hourly email limit</a>.  This shows you how to make the change in <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/log-into-whm">WHM</a>.<br />
<br />
Hope that helps to answer your question!<br />
<br />
Regards,<br />
Arnel C.<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13442);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16182'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/17564861ad468c6bd10ccd231c7f162e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/17564861ad468c6bd10ccd231c7f162e'>Ethan MOORE</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-13 2:35 pm</div>
				                <div><p>It&rsquo;s exhausting to find knowledgeable people on this topic, however you sound like you already know what you&rsquo;re speaking about! Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16182);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27881'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1d7c64b30a3606eb58ec630600d2b51c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1d7c64b30a3606eb58ec630600d2b51c'>Steve Comstock</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-26 3:35 pm</div>
				                <div><p>1. My control panel does not have an <strong>Request Email Limit Exemption icon.</strong></p>
<p>2. Although this article does not say so, it looks like the exemption you can</p>
<p>&nbsp;&nbsp;&nbsp; request has to do with the rate of emails going out; what I would like to be</p>
<p>&nbsp;&nbsp;&nbsp; able to do would be to simply allow longer email address lists (for me, a limit</p>
<p>&nbsp;&nbsp; of 200 would be practical). Would the exemption work for that too?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27881);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-26 7:52 pm</div>
				                <div>Hello Steve,<br />
<br />
The  "Request Email Limit Exemption" icon should be in the AMP, not the cPanel. If it is not in the AMP, you will want to contact Live Support to see why it is not there. It is a tool for you and should be there when you need it.<br />
<br />
You are correct in that the limit is for the rate of outbound emails. It is an hourly limit for your cPanel account. It is set to 250 by default, so all email addresses on your cPanel account combined cannot send out more than 250 emails per hour.<br />
<br />
By 'address list' I assume you mean the number of recipients per email. This is currently set at 50, so each email can have a maximum of 50 recipients. If you want to send an email to 100 people, you would need to send it to two batches of 50 people. Sadly, this setting is not an account-wide setting but a server wide setting. It cannot be changed without affecting the entire server, which is not something our Systems team will perform at this time.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27889);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
