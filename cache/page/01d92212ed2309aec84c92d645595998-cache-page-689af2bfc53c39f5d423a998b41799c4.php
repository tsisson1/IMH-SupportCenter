<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:87281:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-troubleshooting/smtp-and-esmtp-error-code-list" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-05-28T16:40:15-07:00" />
  <meta name="keywords" content="SMTP ESMTP codes email bounce diagnostics" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Learn what SMTP and ESMTP codes are in this article for email bounce diagnostics." />
  <title>SMTP and ESMTP error code list - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-troubleshooting/smtp-and-esmtp-error-code-list" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f42ed0c97028c8082728cf0a86425b2b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.152.60.4']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>SMTP and ESMTP error code list</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															SMTP and ESMTP error code list									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,559</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 28, 2013'><span style='color:#606060;'>Published:</span> May 28, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>It is important to figure out why your <a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-bounce-bounceback-error" target="_blank">email bounces</a>. If you receive an email bounce, you can look in the bounce message to find the proper error code that will give you the reason for the bounce. Below is a list of the Standard SMTP error codes and the Extended SMTP (ESMTP) error codes.</p>

<h2>SMTP Error Codes</h2>

<p>This list of codes is the standard SMTP error codes you will find in most email bounces.</p>

<h3>200 Codes</h3>
<ul style="list-style:none;">
<li>211 - System status / system help reply</li>
<li>214 - Help message</li>
<li>220 - Domain service ready</li>
<li>221 - Domain service closing transmission channel</li>
<li>250 - Requested mail action completed and OK</li>
<li>251 - Not Local User, forward email to forward path</li>
<li>252 - Cannot Verify user, will attempt delivery later</li>
<li>253 - Pending messages for node started</li>
</ul>

<h3>300 Codes</h3>
<ul style="list-style:none;">
<li>354 - Start mail input; end with . </li>
<li>355 - Octet-offset is the transaction offset</li>
</ul>

<h3>400 Codes</h3>
<ul style="list-style:none;">
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-error-421" target="_blank">421 - Domain service not available, closing transmission channel</a></li>
<li>432 - Domain service not available, closing transmission channel</li>
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-error-450" target="_blank">450 - Requested mail action not taken: mailbox unavailable. request refused</a></li>
<li>451 - Requested action aborted: local error in processing Request is unable to be processed, try again</li>
<li>452 - Requested action not taken: insufficient system storage</li>
<li>453 - No mail</li>
<li>454 - TLS not available due to temporary reason. Encryption required for requested authentication mechanism</li>
<li>458 - Unable to queue messages for node</li>
<li>459 - Node not allowed: reason</li>
</ul>

<h3>500 Codes</h3>
<ul style="list-style:none;">
<li>500 - Syntax error, command unrecognized</li>
<li>501 - Syntax error in parameters or arguments</li>
<li>502 - Command not implemented</li>
<li>503 - Bad sequence of commands</li>
<li>504 - Command parameter not implemented</li>
<li>510 - Check the recipient address</li>
<li>512 - Domain can not be found. Unknown host. </li>
<li>515 - Destination mailbox address invalid</li>
<li>517 - Problem with senders mail attribute, check properties</li>
<li>521 - Domain does not accept mail</li>
<li>522 - Recipient has exceeded mailbox limit</li>
<li>523 - Server limit exceeded. Message too large</li>
<li>530 - Access Denied. Authentication required</li>
<li>531 - Mail system Full</li>
<li>533 - Remote server has insufficient disk space to hold email</li>
<li>534 - Authentication mechanism is too weak. Message too big</li>
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/535-incorrect-authentication" target="_blank">535 - Multiple servers using same IP. Required Authentication</a></li>
<li>538 - Encryption required for requested authentication mechanism</li>
<li>540 - Email address has no DNS Server</li>
<li>541 - No response from host</li>
<li>542 - Bad Connection</li>
<li>543 - Routing server failure. No available route</li>
<li>546 - Email looping</li>
<li>547 - Delivery time-out</li>
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-error-550" target="_blank">550 - Requested action not taken: mailbox unavailable</a></li>
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-error-551">551 - User not local; please try forward path</a></li>
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-error-552" target="_blank">552 - Requested mail action aborted: exceeded storage allocation</a></li>
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-error-553" target="_blank">553 - Requested action not taken: mailbox name not allowed</a></li>
<li><a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/email-error-554" target="_blank">554 - Transaction failed</a></li>
</ul>




<h2>Extended SMTP (ESMTP) standards</h2>

<p>The Extended SMTP error codes work in 3 digit combinations. For example, 5.2.1 is a Permanent Error where the receiving email is not accepting messages. The first number is the email message status. The second 2 numbers pinpoint the exact information bout the error.</p>

<ul style="list-style:none;">
<li><strong>2</strong> <em>Successfully sent</em> the email;</li>
<li><strong>4</strong> <em>Temporary problem</em> when sending the email. The email server typically will try to send it again till it reaches retry timeout.</li>
<li><strong>5</strong> <em>Permanent or Fatal error</em>. This can be caused by  a non existent email address, DNS problem, or your email was blocked by the receiving server.</li>
</ul>

<p>Below is a list of the Extended SMTP error codes. </p>



<p class="alert"><strong>Note!</strong> <em>X</em> can be a <strong>4</strong> or a <strong>5</strong> depending on is its Temporary or Permanent.</p> 
...
<li>X.1.2 - Bad destination system address</li>
...
<li>X.2.4 - Mailing list expansion issue</li>
</ul>
<h3>x.3.x Codes</h3>
<ul style="list-style:none;">
...
<li>X.3.5 - System incorrectly configured</li>
</ul>
<h3>x.4.x Codes</h3>
<ul style="list-style:none;">
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/email-troubleshooting/smtp-and-esmtp-error-code-list&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/email-troubleshooting/smtp-and-esmtp-error-code-list'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NSZpZD0yNzQwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="7c6dece07655afa0031f9bc8dc49a8e6" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d94441f929ab4eda8725aa35535371b2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d94441f929ab4eda8725aa35535371b2'>Vijaykumar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-22 10:14 am</div>
				                <div><p>Thank you. The listing helps me explain better to users.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9108);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18490'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a3e38a814ff5a715b0a118285de4cb2d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a3e38a814ff5a715b0a118285de4cb2d'>swetha</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-15 2:33 am</div>
				                <div><p>404 not found, its clear explanation, can't access the webmail login page</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18490);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-15 12:09 pm</div>
				                <div>Hello Swetha,<br />
<br />
404 is not an SMTP error but  a server error when it cannot find a page. Are you getting this error when trying to log in? If so, what is the URL you are trying to log into?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18516);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24609'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/574a121c40965764218c5c7f2ff805b8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/574a121c40965764218c5c7f2ff805b8'>grillo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-03 12:49 pm</div>
				                <div><p>site 2 weeks I cann't send with smtp service of yahoo, error 200 "unknow error certificate bad; destination host name does not match in certificate, even if I use different PC</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24609);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-06 3:40 pm</div>
				                <div>Hello Grillo,<br />
<br />
If you are one of our customers you will want to contact Live Support for account specific help.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24662);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27553'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f85a9896e16695cdb4088e1dd61de042?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f85a9896e16695cdb4088e1dd61de042'>Rich</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-15 1:08 pm</div>
				                <div><p>Looking for some help with Server error: '452 too many recipients'. the list above says this is an system storage issue. I was able to send to the list before. Suggestion help.. thanks in advance</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27553);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-15 3:13 pm</div>
				                <div>Hello Rich,<br />
<br />
How many emails are you trying to send out at one time? Most servers have hard limits, ours are set to 50.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27564);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27640'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bd6d983113816373720ed73b3427e536?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bd6d983113816373720ed73b3427e536'>Mildred Mugauri</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-19 9:30 am</div>
				                <div><p>One of my clients experiencing the same issue, was trying to send out an email to 130 recipients. is there a way of resolving this, maybe increase the limit?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27640);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-19 5:38 pm</div>
				                <div>Hello Mildred,<br />
<br />
Our shared servers are hard set to only allow 50 recipients per email. This is not a setting that can be changed at the account level.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27674);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27753'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/04c7ebe68f05a2ee1d9dd5a593540c78?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/04c7ebe68f05a2ee1d9dd5a593540c78'>himanshu</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-21 3:47 pm</div>
				                <div><p>Hi My name is himanshu.</p>
<p>please suggest me , my lan users are not able to send the mail,it shows in outbox, error says check with your ISP</p>
<p>&nbsp;</p>
<p>But Lan users are able to send mails when i am changing the LAN public ip</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27753);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-22 3:22 am</div>
				                <div><p>Hi</p>
<p>Thanks for responce.</p>
<p>Somebody suggested me to do create PTR, will it help</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27759);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-22 10:35 am</div>
				                <div>Hello himanshu,<br />
<br />
Thank you for contacting us. Yes, creating <a href="http://www.inmotionhosting.com/support/email/fighting-spam/create-custom-spf">SPF records</a> with PTR can often help your email get delivered.<br />
<br />
But keep in mind there are many reasons email may not be delivered, so it must be handled on a case-by-case basis. <br />
<br />
Reveiwing your servers <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">mail logs</a> is the best method for troubleshooting most email issues.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27773);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
