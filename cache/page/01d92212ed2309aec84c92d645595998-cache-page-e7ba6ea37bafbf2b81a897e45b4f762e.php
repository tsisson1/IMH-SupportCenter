<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51233:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/why-can-i-not-see-my-site" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Vannfuentes, Sorry for the problems with the website. I checked the notes on the account, and they state that the site is apparently in propagatio..." />
  <title>why can i not see my site? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/why-can-i-not-see-my-site" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cf6d139fac6307247bd787fbcae998d4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>why can i not see my site?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/vannfuentes/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/vannfuentes'>vannfuentes</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-06 7:38 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>389</span>
			</div>
...
<br />
I have a site at http://zhospitalitygroup.com/<br />
(btw, the hosting guys said it's clean now)<br />
I cannot visit any of the pages now. What do you think is going on? I looked at the cPanel to find a 'maintenance mode' or 'put site offline' option but couldnt find any. Any help would be much appreciated.<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3273' id='upvote_answer_3273' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3273' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3273').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3273' id='downvote_answer_3273' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3273' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3273').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>32,263 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-06-06 7:54 pm EST
                		        </div>
					
		                </div>

				Hello Vannfuentes,<br />
<br />
Sorry for the problems with the website.  I checked the notes on the account, and they state that the site is apparently in <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes" target="new">propagation </a>(which can take up to 24 hours). <br />
<br />
Additionally, if your site was blocked by Google, you will need to <a href="http://www.inmotionhosting.com/support/website/google-tools/google-safe-browsing-diagnostic-page" target="new">submit it to the Google Webmasters for another scan</a> in order to get it removed from their list.  Otherwise, it will appear as a blocked site with Google.<br />
<br />
Those are probably the main reasons you're currently unable to see the site.  Please allow for propagation and make sure that you re-submit the site to Google for scanning in order prevent further issues being reported from viewers of your website.<br />
<br />
Regards,<br />
<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3273').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3273' id='form_comment_on_answer_3273' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Okay, now I see it. Thank you so much!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/vannfuentes/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/vannfuentes'>vannfuentes</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-06-06 11:27 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/why-can-i-not-see-my-site&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/why-can-i-not-see-my-site'></div>
<script type='text/javascript'>
  (function() {
