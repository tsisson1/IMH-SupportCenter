<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:74554:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/general-server-setup/how-to-open-a-port-in-your-firewall" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:48:15-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/how-to-open-a-port-in-your-firewall" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bb2e5cc73c6c181a3c43f45e8d9a3224 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '118.209.70.30']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to open a port in your firewall</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to open a port in your firewall									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,613</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 17, 2013'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
...
<p class='alert'>Please note! This tutorial assumes you have a <a href='http://www.inmotionhosting.com/vps-hosting'>VPS Server</a> or a <a href='http://www.inmotionhosting.com/dedicated-servers'>Dedicated Server</a>, that you have <a href="/support/website/general-server-setup/root-access-faq">root access</a>, and that you know how to <a href="/support/website/general-server-setup/how-to-login-ssh">connect to your server vis SSH</a>.</p>

<h2>Step 1: Check if the port is open already</h2>

<p>The first thing we want to do is <a href="/support/email/email-troubleshooting/communicating-email-server-telnet">test using telnet</a> to ensure port 9090 is not already open. Please note that you may need to <a href="/support/website/how-to/enable-telnet">enable telnet</a> in Windows first.</p>

<pre class='cli'><span style='color:#6ff;'>(The below was ran from cmd.exe in Windows 7)</span>
C:\Users\Brad><span style='color:red;'>telnet example.com 9090</span>
Connecting To example.com...Could not open connection to the host, on port 9090:
<span style='color:orange;'>Connect failed</span></pre>

<p>As you can see, <span style='color:orange; font-weight:bold;'>the connection failed</span>.</p>

<h2>Step 2: Open the port</h2>

To open a port, first open for edit your APF configuration file - /etc/apf/conf.apf:</p>

<pre class='cli'><span style='color:#6ff;'>(The below was ran within PuTTY after connecting vis SSH)</span>
root@vps### [~]# <span style='color:red;'>vim /etc/apf/conf.apf</span></pre>

<p>Then, find the following lines and add the port in question:</p>

<pre class='cli'># Common ingress (inbound) TCP ports
IG_TCP_CPORTS="20,21,25,53,80,110,113,143,443,465,993,995,2049,2077,2078,2082,2083,2086,2087,2089,2095,2096,3306,5222,<span style='color:red;'>9090</span>,12001"

# Common ingress (inbound) UDP ports
IG_UDP_CPORTS="53,161,32786,111,2049,<span style='color:red;'>9090</span>"</pre>

<p>After editing the file and adding the ports, restart APF:</p>

<pre class='cli'>root@vps### [~]# <span style='color:red;'>service apf restart</span></pre>

<h2>Step 3: Test again to see if the port is open</h2>

<p>Now that APF is restarted, we can once again use telnet to test if the port is open:</p>

<pre class='cli'><span style='color:#6ff;'>(The below was ran from cmd.exe in Windows 7)</span>
C:\Users\Brad><span style='color:red;'>telnet example.com 9090</span>
Connecting To example.com...
<span style='color:orange;'>220-vps###.inmotionhosting.com ESMTP Exim 4.80 #2 Fri, 17 May 2013 05:11:39 -0700
220-We do not authorize the use of this system to transport unsolicited,
220 and/or bulk e-mail.</span>
</pre>

As you can see, instead of the <em>Connect failed</em> message, we received <span style='color:orange;'>the greeting from the application running on port 9090</span>. Congratulations, you now know how to open a port on your server using ssh!

<p class='alert'><strong>Please note!</strong> If you do not have any services running on your server listening to the port in question, you won't get a response when you do a telnet test. In the above scenario, we <a href="/support/website/general-server-setup/how-to-run-exim-on-an-additional-port">setup exim to listen on port 9090</a>, which is why we received a response.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/general-server-setup/how-to-open-a-port-in-your-firewall&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/general-server-setup/how-to-open-a-port-in-your-firewall'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NCZpZD0yNzIyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="b4e861e87ae5d0fda741084976d06941" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/resources/apns-in-vps-servers-availability?tsrc=rsbraq'>APNS in VPS servers availability</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fb90d8cb538ea439bef1745ee3d8854d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fb90d8cb538ea439bef1745ee3d8854d'>Stw</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-22 1:35 pm</div>
				                <div><p>I can't connect putty it says: "Connection refused" and i don't have any port open on my VPS and i don't know how i do open them?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17741);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-24 9:26 am</div>
				                <div>Hello Stw,<br />
<br />
The instructions above will tell you how to open a port, however before you can connect to your VPS via Putty, you need to ensure you have <a href="http://www.inmotionhosting.com/support/website/ssh/add-ip-to-firewall">added your IP to the firewall</a>. This is the most common issue when first trying to connect to a VPS.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17770);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 2:50 pm</div>
				                <div>my Server work well at first, but then it started to say Network error: Connection refused on PuTTY and WinSCP ports are closed and I can not open them having any access on my server .. I have had this problem for more than 2 weeks.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17948);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 3:29 pm</div>
				                <div>Hello Stw,<br />
<br />
Thank you for contacting us today. If  you are hosted with us, contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> for assistance regaining access to  your server.<br />
<br />
Alternately, if you have cPanel/WHM available there are <a href="http://forums.cpanel.net/f5/how-open-some-ports-my-whm-cpanel-148669.html">plugins</a>  available that allow you to make changes from the interface.<br />
<br />
Otherwise, you may have to escalate to someone who has access, or can physically login to the server and make changes.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17952);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/parknpool_marc'>parknpool_marc</a></div>
						<div></div>
						<div></div>
						<div>35 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-16 12:05 pm</div>
				                <div>I do not find /etc/apf/conf.apf on my dedicated server.  I see the /etc directory, but no /etc/apf subdirectory.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26698);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-16 4:37 pm</div>
				                <div>Hello parknpool_marc,<br />
<br />
Thank you for contacting us. Ensure you are logged as <a href="http://www.inmotionhosting.com/support/website/ssh/root-access-faq">root</a> in order to access that level of the file system.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26707);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
