<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58900:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/creating-blog" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-14T16:11:26-07:00" />
  <meta name="keywords" content="add create make blogs movable type" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="One of the main functions of Movable Type is to manage blogs.  The software allows you to quickly create blogs.  The following article explains how to add Blogs in the Movable Type Dashboard." />
  <title>Creating a Blog in Movable Type - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/creating-blog" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:aad3015dc00952e571d0aaf7b960a6c7 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a Blog in Movable Type									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,020</span></div>
							...
							<div style='clear:both;'></div>
								...
								<div>Movable Type includes the option to specifically create blogs which are rich in features, but easy to maintain. &nbsp;The following article shows to quickly start a Movable Type blog using the Administrator Dashboard.<br /><br /></div>
<div>&nbsp;</div>
<h2>Making a Blog in Movable Type</h2>
<div>&nbsp;</div>
<div><ol class="article_list">
<li><a href="/support/edu/movable-type/geting-started-movable-type/moveable-type-admin" target="_blank">Login to the Movable Type Administrator Dashboard</a>. &nbsp;</li>
<li>There are two ways to create a new <strong>BLOG</strong>. &nbsp;When you get to the user dashboard, you will see that there is the option select <strong>NEW BLOG</strong>. &nbsp;You can also click on the website that you want to edit. &nbsp;In the menu that appears on left, click on <strong>BLOGS</strong> and then select NEW to create a new blog.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/create-blog-main.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/create-blog-main.png" alt="Create Blog Menu"  style="margin: 0px 0px 15px 15px; float: right;" height="131" width="200" /></a>When you create a new blog, you will first get a screen (labeled "Create Blog") with six main options. &nbsp;The following table lists these options:<br /><br />
<table class="article_table">
<tbody>
<tr><th>Blog Theme</th>
<td>By default, there are 3 themes that you can select</td>
</tr>
<tr><th>Blog Name</th>
<td>Name of your blog - this can be changed any time</td>
</tr>
<tr><th>Blog URL</th>
<td>URL used to get to the blog - based on the main published website URL</td>
</tr>
<tr><th>Blog Root</th>
<td>Location of the files for the blog</td>
</tr>
<tr><th>Time Zone</th>
<td>Time zone for the blog</td>
</tr>
<tr><th>Language</th>
<td>Language used for the blog - defaults to English</td>
</tr>
</tbody>
</table>
<br />Make sure to go through each of these settings .<br />
<div style="clear: both;">&nbsp;</div>
<div>&nbsp;</div>
</li>
<li>Once all of the settings have been determined for your new blog, click on <strong>CREATE BLOG</strong> at the bottom of the screen.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/general-settings.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/general-settings.png" alt="General Settings for new blog"  style="margin: 0px 0px 15px 15px; float: right;" height="157" width="200" /></a>When the blog is created, it will automatically jump to the <strong>SETTINGS</strong> section and show you the <strong>GENERAL&nbsp;</strong>settings.
<div style="clear: both;">&nbsp;</div>
</li>
<li>After you have completed making sure that the GENERAL settings are correct for you, click on<strong> SAVE CHANGES</strong> at the bottom of the screen (you'll have to scroll down to see the save button).</li>
<li>This completes the setup of the Blog, but at this point there is no content in your blog. &nbsp;Creat entries by going to the top left of the screen selecting the first option labeled <strong>ENTRIES</strong>.</li>
</ol>
<div>For further information on adding entries and managing, see <em>Adding Content to Your Movable Type Blog</em> and <em>Managing Blogs in Movable Type</em>. &nbsp;When the blogs have been completed, you will see their entry in the Administrator Dashboard appear like this:<br /><br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/blog-list.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/blog-list.png" alt="List of created blogs"  /></a></div>
<div><br />The front end for a published blog (with no entries) will appear like this:<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/published-blog.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/blogs/published-blog.png" alt="Published Blog with no entries"  /></a></div>
</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Creating a Blog in Movable Type</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/movable-type/create-blog-movable-type/create-new-user'>How to register a user in Movable Type</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/creating-blog&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/creating-blog'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNDUmaWQ9MjI5NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8eb59ce8080f0874ed11b36c9f143fa1" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Setting up a Blog</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
