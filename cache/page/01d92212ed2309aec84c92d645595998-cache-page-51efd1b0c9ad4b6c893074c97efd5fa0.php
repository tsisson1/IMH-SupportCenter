<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49749:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/not-resolved-how-to-create-a-logout-button-from-secure-folder" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Ho yobl, Thanks for posting your question. I'm more than happy to assist you today. When you password protect a directory there is no need to force a lo..." />
  <title>Not Resolved - How to create a Logout button from secure folder | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/not-resolved-how-to-create-a-logout-button-from-secure-folder" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ac7bcfb2980dedcc7a6ef183c0066f80 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Not Resolved - How to create a Logout button from secure folder</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/yobl'>yobl</a>
			<div>11 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-10-23 12:58 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>12,572</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>What script or whatever is required to force a logout from a secure folder from an index.htm within that folder.<br />
<br />
I used the c-panel option, and can't see any option for this.<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_195' id='upvote_answer_195' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='195' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_195').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_195' id='downvote_answer_195' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='195' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_195').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_195').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_195' id='form_comment_on_answer_195' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/not-resolved-how-to-create-a-logout-button-from-secure-folder&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/not-resolved-how-to-create-a-logout-button-from-secure-folder'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d363554bd5162975f47d1abc87d36e72" value="1" />	</div>
	</form>
<!-- <br />
