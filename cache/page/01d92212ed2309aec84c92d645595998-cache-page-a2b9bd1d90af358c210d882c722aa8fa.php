<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60777:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/bounceback-errors/domain-exceeded-max-emails-per-hour" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-21T12:36:42-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="Are you getting an error like &quot;Domain example.com has exceeded the max emails per hour (313/250 (125%)) allowed?  Learn what causes it and how to fix it." />
  <title>Domain example.com has exceeded the max emails per hour - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/bounceback-errors/domain-exceeded-max-emails-per-hour" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:49108ddd359a748929952e9cc072600c -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Domain example.com has exceeded the max emails per hour									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,876</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 13, 2013'><span style='color:#606060;'>Published:</span> Oct 21, 2013</div>
...
<p>If you are receiving an error similar to "<i>Domain example.com has exceeded the max emails per hour (313/250 (125%)) allowed.  Message discarded.</i>" in an email bounceback message, this means that you have a limit defined that only allows you to send a limited amount of emails per hour within your account.  By default, all shared hosting accounts will have a limit of 250 emails per hour.</p>
...
<h3>If the emails are legitimate emails necessary for your business:</h3>
<p>If these are emails that are sent out as part of a standard mailing list, you have a few options available to you.</p>  
<p>Most email clients that are made for mailing such as <a href="http://www.inmotionhosting.com/support/email/mailing-lists/install-php-list">PHPList</a> have an option to rare-limit the amount of hourly emails that are sent out.  For example, if you are sending out 500 emails in a list, you can set it to send out 200 for the first 2 hours, and then 100 for the third which will allow you to send out all of your emails, and still have some space each hour to send any normal communications.</p>
<p>Another option would be to request an <a href="http://www.inmotionhosting.com/support/email/mailing-lists/email-limit-exception-request-amp">hourly email exemption request</a>.  This will allow you to raise the hourly email to something that better suits your needs.  If you are on a <strong>VPS or dedicated server</strong>, we do not impose any specific limits so if there is one on your specific cPanel account, our support department can set it to unlimited for you if you would like to.</p>
<h3>But I didn't send that many emails?</h3>
<p>If you didn't send this many emails, there could be a further issue within your account such as a compromised email address.  If you are getting this message when you have not sent a large amount of emails, especially if you are getting bounceback messages that reference email addresses that you did not send to, you will want to speak with our support department as soon as possible to ensure that your account has not been compromised.</p>
<h2>How can I see how many emails I sent?</h2>
Unfortunately, this option is not available within a shared hosting environment, but on a <strong>VPS or dedicated server</strong>, you may click on Mail Delivery Reports within WHM to view any mail sent or received.  If on a shared hosting account such as a Launch, Power, or Pro plan, you may contact our support department for more information regarding email activity on your account.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/bounceback-errors/domain-exceeded-max-emails-per-hour&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/bounceback-errors/domain-exceeded-max-emails-per-hour'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjImaWQ9Mjg0MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="97c289d48e7e4e21ae78284325c0c874" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6393ecfb66da9cabcde4fab3b3c5bd66?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6393ecfb66da9cabcde4fab3b3c5bd66'>Michelle Wei</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-22 12:01 am</div>
				                <div><p>our email has been compromised for sometime and I thought it was fixed after 72 hrs but it was not. It's very frustrating that no email was sent or able to be sent because some unknown was using the email account to send a lot of spam that exceed the hourly limit, we pay for the account but we can't use it for our own business!1 Please help!!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10797);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-22 9:24 am</div>
				                <div>Hello Michelle,<br />
<br />
Sorry to hear about the trouble you are having. If your account was compromised and sending spam, I first recommend <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/changing-email-password-in-cpanel">changing your email password</a>  in cPanel. This should stop the outgoing spam, since it is usually caused by a weak password. You will then be able to continue sending email within an hour.<br />
<br />
If you are still getting the "<em>exceeded the max emails per hour</em>" after an hour, you may have additional problems, such as a hacked website form, or coding issue. In this case, I recommend contacting <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Tech support</a>, so they can review your email logs in real-time for issues.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10802);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
