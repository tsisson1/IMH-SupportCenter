<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59425:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/movable-type/adding-content-movable-type/edit-page-movable-type" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-14T16:15:30-07:00" />
  <meta name="keywords" content="Movable Type edit page add content [gs]" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="The first thing you will want to do in your Movable Type program is to add content to a page. This article will explain how to edit a page on Movable Type." />
  <title>How to edit a page in Movable Type - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/movable-type/adding-content-movable-type/edit-page-movable-type" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2c0faefb80462d9a43d0148a4d7b87b0 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/movable-type' itemprop='url'><span itemprop='title'>Movable Type<span></a><div class='dropdown_4columns'><h2>Movable Type Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/movable-type/geting-started-movable-type'>101: Getting Started with Movable Type</a></div><div><a href='/support/edu/movable-type/adding-content-movable-type'>102: Adding Content to Movable Type</a></div><div><a href='/support/edu/movable-type/change-theme-template-movable-type'>103: Changing the Appearance of Movable Type</a></div><div><a href='/support/edu/movable-type/widgets-movable-type'>104: Working with Widgets in Movable Type</a></div><div><a href='/support/edu/movable-type/create-blog-movable-type'>105: Creating a Blog in Movable Type</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/movable-type/site-security-in-movable-type'>201: Site Security in Movable Type</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/movable-type/adding-content-movable-type' itemprop='url'><span itemprop='title'>102: Adding Content to Movable Type<span></a><div class='dropdown_3columns'><h2> Adding Content to Movable Type</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/static-dynamic-publishing'>Movable Type: Dynamic and Static Publishing</a></div><div>2. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/create-new-page'>How to create a new page in Movable Type</a></div><div>3. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/edit-page-movable-type'>How to edit a page in Movable Type</a></div><div>4. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/inserting-an-image-in-movable-type'>How to insert an Image in Movable Type</a></div><div>5. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/adding-an-internal-link-in-movable-type'>Adding an internal link in Movable Type</a></div><div>6. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/contact-us-plugin'>Creating a Contact Page in Movable Type</a></div><div>7. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/adding-iframe'>Adding an iFrame to a Movable Type Webpage</a></div><div>8. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/managing-tags'>Managing Tags in Movable Type</a></div><div>9. <a style='display:inline;' href='/support/edu/movable-type/adding-content-movable-type/add-tags'>How to Add Tags to Assets in Movable Type</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to edit a page in Mova...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to edit a page in Movable Type									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>675</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 8, 2013'><span style='color:#606060;'>Published:</span> Mar 14, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>You can create pages in your Movable Type program relatively easily. As long as the <a target="_blank" href="/support/edu/movable-type/geting-started-movable-type/permissions-changing-to-666">permissions for your Movable Type program are fixed</a>, you can edit and create pages through the Movable Type Dashboard The following tutorial will explain how to edit a page in your Movable Type site.</p>
<h2>Steps to edit a page in Movable Type</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-1-select-pages.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-1-select-pages.gif" title="Click here to view the larger image" width="100" /></a>In the Admin Dashboard, select the link that says <strong>page</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-2-click-home.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-2-click-home.gif" title="Click here to view the larger image" width="100" /></a>Click the page you want to edit on the list of pages in the <strong>Manage Pages</strong> area. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-3-wysiwyg-editor.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-3-wysiwyg-editor.gif" title="Click here to view the larger image" width="100" /></a>You will see the WYSIWYG editor. Add text to the page. In this case we are making a "<em>Coming Soon</em>" page. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-4-update.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-4-update.gif" title="Click here to view the larger image" width="100" /></a>Click the <strong>Update</strong> button. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-5-click-home.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-5-click-home.gif" title="Click here to view the larger image" width="100" /></a>Visit your website. You will see the page on the left.
<p>Click the page to view it.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-6-final-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/102/edit-page/edit-page-6-final-view.gif" title="Click here to view the larger image" width="100" /></a>Now you will see the text you added to the page.. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/movable-type/adding-content-movable-type'>102: Adding Content to Movable Type</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to edit a page in Movable Type</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/movable-type/adding-content-movable-type/create-new-page'>How to create a new page in Movable Type</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/movable-type/adding-content-movable-type/inserting-an-image-in-movable-type'>How to insert an Image in Movable Type</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/movable-type/adding-content-movable-type/edit-page-movable-type&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/movable-type/adding-content-movable-type/edit-page-movable-type'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNDMmaWQ9MjI3MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="130bab7729b003df6a3c7f02b1fe6dee" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/movable-type/adding-content-movable-type?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding Content to Movable Type</h3></a>
		<table><tr><td colspan='2'><h4>Publishing Movable Type</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/static-dynamic-publishing?tsrc=rsbedu'>Movable Type: Dynamic and Static Publishing</a></td>
                </tr>
        <tr><td colspan='2'><h4>Creating and Editing pages</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/create-new-page?tsrc=rsbedu'>How to create a new page in Movable Type</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/edit-page-movable-type?tsrc=rsbedu'>How to edit a page in Movable Type</a></td>
                </tr>
        <tr><td colspan='2'><h4>Adding links, text, and images</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/inserting-an-image-in-movable-type?tsrc=rsbedu'>How to insert an Image in Movable Type</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/adding-an-internal-link-in-movable-type?tsrc=rsbedu'>Adding an internal link in Movable Type</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/contact-us-plugin?tsrc=rsbedu'>Creating a Contact Page in Movable Type</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/adding-iframe?tsrc=rsbedu'>Adding an iFrame to a Movable Type Webpage</a></td>
                </tr>
        <tr><td colspan='2'><h4>Working with Assets</h4></td></tr>  <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/managing-tags?tsrc=rsbedu'>Managing Tags in Movable Type</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/movable-type/adding-content-movable-type/add-tags?tsrc=rsbedu'>How to Add Tags to Assets in Movable Type</a></td>
                </tr>
          	</table>
