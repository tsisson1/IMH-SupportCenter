<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54146:" 
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:beab113617c367badd2d2e8245627a5f -->
	...
	<div class='page-header'>
	 ...
	 <h2>Search for your domain name in a blacklist</h2>
        <form method='get' style='margin-bottom:25px;'>
                ...
                <input type='text' style='width:200px;' name='ip' id='ip' value='66.96.0.128' />
		...
		<h1>Checking IP Address: 66.96.0.128</h1>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP2lwPTY2Ljk2LjEyOCZvcHRpb249Y29tX2NvbnRlbnQmY2F0aWQ9ODMmaWQ9ODMmdmlldz1jYXRlZ29yeSZJdGVtaWQ9MTAx" />
