...
$modDate = $this->item->modified;
$Moddatetime = new DateTime($modDate);
$LastModDate = $Moddatetime->format('Y-m-d\TH:i:sP');


$doc =& JFactory::getDocument();
$doc->setMetaData( 'last-modified', $LastModDate, true );
...
<?
	...
	*/
	...
	$articleId = JRequest::getInt('id');
		echo "
			<div onClick=\"jQuery('#admin_tools').slideToggle('slow');\" style='position:fixed;top:0px;left:0px;color:#000;cursor:pointer;'>[A] - $articleId</div>
