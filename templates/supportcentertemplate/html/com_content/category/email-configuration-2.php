...
if (0 === strpos($server, 'vps')){
	// nothing
}else{

if (0 === strpos($server, 'ecbiz')){
...
if (strpos($domain,'inmotionhosting.com') !== false) { echo"
...
<div style='clear:both; margin-bottom:-20px;'></div>";
if (strpos($domain,'inmotionhosting.com') !== false) { echo "<h3>Secure SSL</h3>
<strong>Username:</strong> $email
