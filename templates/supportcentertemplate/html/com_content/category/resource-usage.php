...
$this->document->setTitle("Resource Usage | InMotion Hosting");
...
$resource_file = json_decode(file_get_contents($_POST['resource-file']));
$RU = explode('|', $resource_file, -1);
...
<form class="well-small domains-pill row-fluid" action="" method="post" style="width:97%">
    <div id="domain-input-wrap" class="span8">
     <input type="text" name="resource-file" value="http://eris.gg/resources.txt" placeholder="http://example.com/resources.txt" style="margin-bottom: 0px;width:400px;">
    </div>
    <button type="submit" name="SubmitButton" class="btn btn-primary" style="width: 150px; margin-left: 45px; margin-top: 7px;">Grab Resources
    </button>
</form>
...
// Server info
/** echo '<div class="white_box" style="height: 100px">
            <h2 style="margin: 0px">Server Information</h2>
            <div>' . $ServerInfo . '</div>
      </div>    
';

// Sar Q
echo '<div class="white_box" style="height: 400px; float: left; width: 46%; margin: 10px 0">
            <h2 style="margin: 0px">Server Load Over Time</h2>
            <div style="overflow-y: scroll; height: 350px">' . $SarQ . '</div>
      </div>    
';

// Sar R
echo '<div class="white_box" style="height: 400px; float: right; width: 46%; margin: 10px 0">
            <h2 style="margin: 0px">Ram Usage Over Time</h2>
            <div style="overflow-y: scroll; height: 350px">' . $SarR . '</div>
      </div>    
';

// CMS Info

echo '<div class="white_box" style="height: 400px; margin: 10px 0">
            <h2 style="margin: 0px">CMS Information</h2>
            <div style="overflow-y: scroll; height: 350px">' . $CmsInfo . '</div>
      </div>    
'; */
