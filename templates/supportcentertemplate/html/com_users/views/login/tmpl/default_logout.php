...
<div class="logout <?php echo $this->pageclass_sfx?>">
	...
	<form action="/support/index.php?option=com_users&task=user.logout&return=aHR0cDovL3d3dy5pbm1vdGlvbmhvc3RpbmcuY29tL3N1cHBvcnQv" method="post" class="form-horizontal">
...
<?php //echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>
