...
<div id="hp_cs" class='white_box' style="margin-bottom:15px; padding-bottom:20px; background:url('/support/templates/supportcentertemplate/images/bgs/bg_top_right_gears.gif') no-repeat top right #fff;">
        <h2 style='color:#000; margin-bottom:20px;'>Problem Solved. <span style='color:#ccc;'>How to use the Support Center</span></h2>

	<div style='width:23%; float:left; margin-right:2%;'>
		<strong style='letter-spacing:2px;'>Search</strong><br />
		Type in a few keywords and search.
		<div><a href='/support/search' class='btn btn-primary' style='font-size:12px; text-transform:none; padding:0px 5px;'>Search</a></div>
	</div>

	<div style='width:23%; float:left; margin-right:2%;'>
		<strong style='letter-spacing:2px;'>Troubleshoot</strong><br />
		Not sure what to ask? We'll ask the questions.
		<div><a href='/support/troubleshooter' class='btn btn-primary' style='font-size:12px; text-transform:none; padding:0px 5px;'>Start</a></div>
	</div>

	<div style='width:23%; float:left; margin-right:2%;'>
		<strong style='letter-spacing:2px;'>Ask</strong><br />
		Ask a question, we'll post an answer.
		<div><a href='/support/community-support/ask-a-question' class='btn btn-primary' style='font-size:12px; text-transform:none; padding:0px 5px;'>Ask</a></div>
	</div>

	<div style='width:23%; float:left; margin-right:2%;'>
		<strong style='letter-spacing:2px;'>Browse</strong><br />
		Our popular tutorials are on this page.
		<div><a href='#faq' class='btn btn-primary' style='font-size:12px; text-transform:none; padding:0px 5px;'>Browse</a></div>
	</div>
