...
<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
		<legend class="label-mobile label-mobile-info"><?php echo JText::_('JEDITOR'); ?></legend>
	...
	<fieldset>
		<legend class="label-mobile label-mobile-info"><?php echo JText::_('COM_CONTENT_IMAGES_AND_URLS'); ?></legend>
			<div class="formelm">
	...
	<fieldset>
		<legend class="label-mobile label-mobile-info"><?php echo JText::_('COM_CONTENT_PUBLISHING'); ?></legend>
		<div class="formelm">
	...
	<fieldset>
		<legend class="label-mobile label-mobile-info"><?php echo JText::_('JFIELD_LANGUAGE_LABEL'); ?></legend>
	...
	<fieldset>
		<legend class="label-mobile label-mobile-info"><?php echo JText::_('COM_CONTENT_METADATA'); ?></legend>
		<div class="formelm-area">
