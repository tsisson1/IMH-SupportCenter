...
$staff['Christopher'] = 316017554;
$staff['Scott'] = 314219366;
$staff['Arnel'] = 314217384;
//$staff['jamesr'] = 314239910;
//$staff['jacobn'] = 314237336;
$staff['Johnpaul'] = 314237053;
$staff['Tim'] = 314278453;
$staff['TJ'] = 316006069;
...
foreach($staff as $user => $id)
{
	...
	$query = "	SELECT	`up`.`type_id`,
			...
			WHERE	`author_id` = $id AND
				...
				(`up`.`timestamp` BETWEEN '$start_date' AND '$end_date') AND
				TIMESTAMPDIFF(HOUR,`c`.`created`,`up`.`timestamp`) > (24*7)
				;
	";
