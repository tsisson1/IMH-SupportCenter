...
--
-- Host: localhost
-- Generation Time: Jan 06, 2013 at 02:44 PM
...
--
-- Database: `ccdevinm_j3`
--

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_assets`
--

CREATE TABLE IF NOT EXISTS `d6x2g_assets` (
...
--
-- Dumping data for table `d6x2g_assets`
--

INSERT INTO `d6x2g_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `d6x2g_associations`
--

CREATE TABLE IF NOT EXISTS `d6x2g_associations` (
...
--
-- Table structure for table `d6x2g_banners`
--

CREATE TABLE IF NOT EXISTS `d6x2g_banners` (
...
--
-- Table structure for table `d6x2g_banner_clients`
--

CREATE TABLE IF NOT EXISTS `d6x2g_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `d6x2g_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `d6x2g_banner_tracks` (
...
--
-- Table structure for table `d6x2g_categories`
--

CREATE TABLE IF NOT EXISTS `d6x2g_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `d6x2g_categories`
--

INSERT INTO `d6x2g_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `d6x2g_contact_details`
--

CREATE TABLE IF NOT EXISTS `d6x2g_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `d6x2g_content`
--

CREATE TABLE IF NOT EXISTS `d6x2g_content` (
...
--
-- Table structure for table `d6x2g_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `d6x2g_content_frontpage` (
...
--
-- Table structure for table `d6x2g_content_rating`
--

CREATE TABLE IF NOT EXISTS `d6x2g_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `d6x2g_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `d6x2g_core_log_searches` (
...
--
-- Table structure for table `d6x2g_extensions`
--

CREATE TABLE IF NOT EXISTS `d6x2g_extensions` (
...
--
-- Dumping data for table `d6x2g_extensions`
--

INSERT INTO `d6x2g_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(600, 'English (United Kingdom)', 'language', 'en-GB', '', 0, 1, 1, 1, '{"name":"English (United Kingdom)","type":"language","creationDate":"2008-03-15","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.2","description":"en-GB site language","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(601, 'English (United Kingdom)', 'language', 'en-GB', '', 1, 1, 1, 1, '{"name":"English (United Kingdom)","type":"language","creationDate":"2008-03-15","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.2","description":"en-GB administrator language","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(700, 'files_joomla', 'file', 'joomla', '', 0, 1, 1, 1, '{"name":"files_joomla","type":"file","creationDate":"November 2012","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.2","description":"FILES_JOOMLA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_finder_filters`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_filters` (
...
--
-- Table structure for table `d6x2g_finder_links`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links` (
...
--
-- Table structure for table `d6x2g_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms0` (
...
--
-- Table structure for table `d6x2g_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `d6x2g_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `d6x2g_finder_taxonomy`
--

INSERT INTO `d6x2g_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `d6x2g_finder_terms`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_terms` (
...
--
-- Table structure for table `d6x2g_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `d6x2g_finder_terms_common`
--

INSERT INTO `d6x2g_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `d6x2g_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `d6x2g_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `d6x2g_finder_types`
--

CREATE TABLE IF NOT EXISTS `d6x2g_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `d6x2g_languages`
--

CREATE TABLE IF NOT EXISTS `d6x2g_languages` (
...
--
-- Dumping data for table `d6x2g_languages`
--

INSERT INTO `d6x2g_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_menu`
--

CREATE TABLE IF NOT EXISTS `d6x2g_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `d6x2g_menu`
--

INSERT INTO `d6x2g_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `d6x2g_menu_types`
--

CREATE TABLE IF NOT EXISTS `d6x2g_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `d6x2g_menu_types`
--

INSERT INTO `d6x2g_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_messages`
--

CREATE TABLE IF NOT EXISTS `d6x2g_messages` (
...
--
-- Table structure for table `d6x2g_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `d6x2g_messages_cfg` (
...
--
-- Table structure for table `d6x2g_modules`
--

CREATE TABLE IF NOT EXISTS `d6x2g_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `d6x2g_modules`
--

INSERT INTO `d6x2g_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `d6x2g_modules_menu`
--

CREATE TABLE IF NOT EXISTS `d6x2g_modules_menu` (
...
--
-- Dumping data for table `d6x2g_modules_menu`
--

INSERT INTO `d6x2g_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `d6x2g_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `d6x2g_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `d6x2g_overrider`
--

CREATE TABLE IF NOT EXISTS `d6x2g_overrider` (
...
--
-- Table structure for table `d6x2g_redirect_links`
--

CREATE TABLE IF NOT EXISTS `d6x2g_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `d6x2g_schemas`
--

CREATE TABLE IF NOT EXISTS `d6x2g_schemas` (
...
--
-- Dumping data for table `d6x2g_schemas`
--

INSERT INTO `d6x2g_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.0.2');

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_session`
--

CREATE TABLE IF NOT EXISTS `d6x2g_session` (
...
--
-- Dumping data for table `d6x2g_session`
--

INSERT INTO `d6x2g_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('04d8418a7c7d63db5edff8d9d1c66db7', 1, 0, '1357512167', '__default|a:8:{s:15:"session.counter";i:5;s:19:"session.timer.start";i:1357512158;s:18:"session.timer.last";i:1357512165;s:17:"session.timer.now";i:1357512167;s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.97 Safari/537.11";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"548";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:25:"bradm@inmotionhosting.com";s:8:"password";s:65:"27be19473616b962dc31edc2b2f680e9:KYtM3No0XUC2NWNo1MIM0qO0pY23waWF";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-01-06 22:40:03";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"426ff237466532336900c6f1110ee39b";}', 548, 'admin'),
('1f0486580f8f2a96433e48f858aea02f', 0, 1, '1357512145', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1357512145;s:18:"session.timer.last";i:1357512145;s:17:"session.timer.now";i:1357512145;s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.97 Safari/537.11";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"e733f70f5e507e465a278c58df7bd41d";}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_template_styles`
--

CREATE TABLE IF NOT EXISTS `d6x2g_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `d6x2g_template_styles`
--

INSERT INTO `d6x2g_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `d6x2g_updates`
--

CREATE TABLE IF NOT EXISTS `d6x2g_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Available Updates' AUTO_INCREMENT=45 ;

--
-- Dumping data for table `d6x2g_updates`
--

INSERT INTO `d6x2g_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(3, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', ''),
(4, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', ''),
(5, 3, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/he-IL_details.xml', ''),
(6, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', ''),
(7, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', ''),
(8, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', ''),
(9, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.0.0.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', ''),
(10, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', ''),
(11, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', ''),
(12, 3, 0, 'Chinese-Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', ''),
(13, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', ''),
(14, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', ''),
(15, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', ''),
(16, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/en-AU_details.xml', ''),
(17, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', ''),
(18, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', ''),
(19, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(20, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', ''),
(21, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(22, 3, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ckb-IQ_details.xml', ''),
(23, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(24, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(25, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(26, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', ''),
(27, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(28, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(29, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
(30, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', ''),
(31, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', ''),
(32, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', ''),
(33, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.0.2.3', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', ''),
(34, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
(35, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', ''),
(36, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', ''),
(37, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', ''),
(38, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(39, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(40, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(41, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(42, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(43, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', ''),
(44, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '');

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_update_sites`
--

CREATE TABLE IF NOT EXISTS `d6x2g_update_sites` (
...
--
-- Dumping data for table `d6x2g_update_sites`
--

INSERT INTO `d6x2g_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1357512165),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1357512165),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1357512165);

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `d6x2g_update_sites_extensions` (
...
--
-- Dumping data for table `d6x2g_update_sites_extensions`
--

INSERT INTO `d6x2g_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `d6x2g_usergroups`
--

CREATE TABLE IF NOT EXISTS `d6x2g_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `d6x2g_usergroups`
--

INSERT INTO `d6x2g_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `d6x2g_users`
--

CREATE TABLE IF NOT EXISTS `d6x2g_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `d6x2g_users`
--

INSERT INTO `d6x2g_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(548, 'Super User', 'admin', 'bradm@inmotionhosting.com', '27be19473616b962dc31edc2b2f680e9:KYtM3No0XUC2NWNo1MIM0qO0pY23waWF', 0, 1, '2013-01-06 22:40:03', '2013-01-06 22:42:44', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_user_notes`
--

CREATE TABLE IF NOT EXISTS `d6x2g_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `d6x2g_user_profiles`
--

CREATE TABLE IF NOT EXISTS `d6x2g_user_profiles` (
...
--
-- Table structure for table `d6x2g_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `d6x2g_user_usergroup_map` (
...
--
-- Dumping data for table `d6x2g_user_usergroup_map`
--

INSERT INTO `d6x2g_user_usergroup_map` (`user_id`, `group_id`) VALUES
(548, 8);

-- --------------------------------------------------------

--
-- Table structure for table `d6x2g_viewlevels`
--

CREATE TABLE IF NOT EXISTS `d6x2g_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `d6x2g_viewlevels`
--

INSERT INTO `d6x2g_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `d6x2g_weblinks`
--

CREATE TABLE IF NOT EXISTS `d6x2g_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
